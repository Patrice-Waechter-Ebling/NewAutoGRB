...
Begin VB.Form FrmReceptionElec 
   ...
   Begin VB.ComboBox cmbType 
      Height          =   315
      ItemData        =   "FrmReceptionElec.frx":2CFA
      Left            =   3120
      List            =   "FrmReceptionElec.frx":2D04
      TabIndex        =   0
      Top             =   120
      Width           =   1455
   End
...
Oups:
 ...
 wOups "frmReceptionElec", "chkDateRequise_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "chkProjetAchat_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmbNoProjet_KeyUp", Err, Err.number, Err.Description
End Sub
...
Private Sub cmbNoProjet_Click()
 ...
 Else
 Call rstProjAchat.Open("SELECT * FROM GrbProjetElec WHERE IDProjet = '" & cmbNoProjet.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
 End If
...
wOups "frmReceptionElec", "cmbNoProjet_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmReceptionElec", "cmbType_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmdAfficher_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmdAnnuler_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub AnnulerReceptionProjet()
 ...
 Call rstProjet.Open("SELECT Modification, Par FROM GrbProjetElec WHERE IDProjet = '" & txtnoprojet.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)

 If rstProjet.Fields("Modification") = False Then
 Set rstPiece = New ADODB.Recordset

 Call rstPiece.Open("SELECT * FROM GrbProjet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' And NuméroLigne = " & lvwProjet.SelectedItem.ListSubItems(I_COL_MANUFACTURIER).Tag, g_connData, adOpenDynamic, adLockOptimistic)
...
wOups "frmReceptionElec", "AnnulerReceptionProjet", Err, Err.number, Err.Description
End Sub
...
wOups "frmReceptionElec", "AnnulerReceptionAchat", Err, Err.number, Err.Description
End Sub
...
Private Sub EnleverInventaireAchat()
 ...
 Call rstInventaire.Open("SELECT * FROM GrbInventaireElec WHERE NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
wOups "frmReceptionElec", "EnleverInventaireAchat", Err, Err.number, Err.Description
End Sub
...
wOups "frmReceptionElec", "AjouterInventaireProjet", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmdDateRequise_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmdFermerPieces_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmdImprimer_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub ImprimerReception()
 ...
 If m_eType = ACHAT Then
 Call frmChoixDateImpressionReception.Afficher(txtnoprojet.Text, ELECTRIQUE, ACHAT)
 Else
 Call frmChoixDateImpressionReception.Afficher(txtnoprojet.Text, ELECTRIQUE, PROJET)
 End If
...
Oups:
 ...
 wOups "frmReceptionElec", "ImprimerReception", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdImprimerPieces_Click()
 ...
 Call rstPiece.Open("SELECT GrbProjet_Pieces.*, GrbFournisseur.NomFournisseur FROM GrbProjet_Pieces INNER JOIN GrbFournisseur ON GrbProjet_Pieces.IDFRS = GrbFournisseur.IDFRS WHERE Type = 'E' AND Commandé = True AND DateRequise <= '" & txtDateRequise.Text & "' AND IDProjet = '" & txtProjetAchat.Text & "' AND DateRequise <> '' ORDER BY NomFournisseur", g_connData, adOpenDynamic, adLockOptimistic)
 Else
 If chkDateRequise.Value = vbChecked Then
 ...
 Else
 If chkProjetAchat.Value = vbChecked Then
  Call rstPiece.Open("SELECT GrbProjet_Pieces.*, GrbFournisseur.NomFournisseur FROM GrbProjet_Pieces INNER JOIN GrbFournisseur ON GrbProjet_Pieces.IDFRS = GrbFournisseur.IDFRS WHERE Type = 'E' AND Commandé = True AND IDProjet = '" & txtProjetAchat.Text & "' ORDER BY NomFournisseur", g_connData, adOpenDynamic, adLockOptimistic)
  Else
  Call rstPiece.Open("SELECT GrbProjet_Pieces.*, GrbFournisseur.NomFournisseur FROM GrbProjet_Pieces INNER JOIN GrbFournisseur ON GrbProjet_Pieces.IDFRS = GrbFournisseur.IDFRS WHERE Type = 'E' AND Commandé = True ORDER BY NomFournisseur", g_connData, adOpenDynamic, adLockOptimistic)
  End If
  End If
  End If
  Else
...
If m_eType = PROJET Then
 DR_BackOrder.Sections("Section4").Controls("lblTitre").Caption = "Projets électriques : Pièces non reçues"

 DR_BackOrder.Sections("Section4").Controls("lblTitreProjetAchat").Caption = "Projet : "
 Else
1  DR_BackOrder.Sections("Section4").Controls("lblTitre").Caption = "Achats électriques : Pièces non reçues"
...
wOups "frmReceptionElec", "cmdImprimerPieces_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmdNonRecu_Click", Err, Err.number, Err.Description
End Sub
...
wOups "frmReceptionElec", "RemplirListePiecesNonRecues", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "Form_KeyDown", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "Form_Unload", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "lvwProjet_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "lvwProjet_DblClick", Err, Err.number, Err.Description
End Sub
...
Private Sub ReceptionProjet()
 ...
 If lvwProjet.ListItems.count > 0 Then
  ...
  Call rstProjet.Open("SELECT Modification, Par, Profit FROM GrbProjetElec WHERE IDProjet = '" & txtnoprojet.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
1  rstModif.Fields("Heure") = Time
 ...
 If Trim(rstPiece.Fields("Temps")) <> vbNullString Then
 'On calcul le temps * quantité pour la colonne montage
 rstPiece.Fields("Temps_total") = CDbl(Replace(rstPiece.Fields("Temps"), ".", ",")) * CDbl(Replace(rstPiece.Fields("Qté"), "*", vbNullString))
 Else
 rstPiece.Fields("Temps_total") = vbNullString
 End If
...
4 rstCopiePiece.Fields("Temps") = rstPiece.Fields("Temps")

4 If Trim(rstCopiePiece.Fields("Temps")) <> vbNullString Then
 'On calcul le temps * quantité pour la colonne montage
4 rstCopiePiece.Fields("Temps_total") = CDbl(Replace(rstCopiePiece.Fields("Temps"), ".", ",")) * CDbl(Replace(rstCopiePiece.Fields("Qté"), "*", vbNullString))
4 Else
4 rstCopiePiece.Fields("Temps_total") = vbNullString
4 End If

 'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
4 rstCopiePiece.Fields("Prix_Total") = Conversion(CStr(Round(Replace(rstCopiePiece.Fields("Qté"), "*", vbNullString) * rstCopiePiece.Fields("Prix_net") * CSng(sProfit), 2)), MODE_PAS_FORMAT)
 
4 rstCopiePiece.Fields("Profit_Pourcent") = rstPiece.Fields("Profit_Pourcent")
 
 'Pour le profit, c'est le prix total - (prix net * quantité)
4 rstCopiePiece.Fields("Profit_argent") = Conversion(CStr(Round(rstCopiePiece.Fields("Prix_total") - (rstCopiePiece.Fields("Prix_net") * Replace(rstCopiePiece.Fields("Qté"), "*", vbNullString)), 2)), MODE_PAS_FORMAT)

4 rstCopiePiece.Fields("SousSection") = rstPiece.Fields("SousSection")
4 rstCopiePiece.Fields("OrdreSection") = rstPiece.Fields("OrdreSection")
...
50 rstCopiePiece.Fields("NoRetour") = vbNullString
 rstCopiePiece.Fields("CommandeAnnulée") = False
 rstCopiePiece.Fields("DateRéception") = vbNullString
 rstCopiePiece.Fields("Facturation") = rstPiece.Fields("Facturation")
 rstCopiePiece.Fields("ID") = ""
 rstCopiePiece.Fields("PieceExtra") = rstPiece.Fields("PieceExtra")
 ...
 rstCopiePiece.Fields("MatérielInutile") = False
...
5  Call rstPiece.Open("SELECT * FROM GrbProjet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' AND NuméroLigne >= " & lvwProjet.SelectedItem.ListSubItems(I_COL_MANUFACTURIER).Tag + 1, g_connData, adOpenDynamic, adLockOptimistic)

5  bSkip = False

5  Do While Not rstPiece.EOF
5  If ((rstPiece.Fields("NumItem") <> lvwProjet.SelectedItem.SubItems(I_COL_PIECE)) Or (rstPiece.Fields("Qté") <> CDbl(sTotal) - CDbl(sQuantite))) Or bSkip = True Then
5  rstPiece.Fields("NuméroLigne") = rstPiece.Fields("NuméroLigne") + 1

5  Call rstPiece.Update
5  Else
60 bSkip = True
  End If
 ...
 'Ajout aux modifs
  ...
  rstModif.Fields("noEmployé") = rstEmploye.Fields("noEmploye")
  rstModif.Fields("Date") = ConvertDate(Date)
6  rstModif.Fields("Heure") = Time
6  rstModif.Fields("TypeModif") = "RECEPTION"

6  Call rstEmploye.Close

6  Call rstModif.Update

6  Call rstModif.Close

6  If UCase(lvwProjet.SelectedItem.SubItems(I_COL_DISTRIBUTEUR)) = "SOLUTION GRB INC." Then
6  Call EnleverInventaireProjet(sQuantite)
6  End If

70 m_iIndexReception = lvwProjet.SelectedItem.Index

  Call RemplirListViewProjet(txtnoprojet.Text)

  Set rstCopiePiece = Nothing
  Else
  Call MsgBox("La quantité est trop grande!", vbOKOnly, "Erreur")
  End If
  End If
  ...
  Call MsgBox("La quantité doit être plus grande que 0!", vbOKOnly, "Erreur")
   End If
   Else
7  Call MsgBox("Quantité non numérique!", vbOKOnly, "Erreur")
7  End If
7  End If
7  End If
7  Else
7  Call MsgBox("Ce projet est en modification par " & rstProjet.Fields("Par") & "!", vbOKOnly, "Erreur")
80 End If
...
Oups:
  ...
  wOups "frmReceptionElec", "ReceptionProjet", Err, Err.number, Err.Description
End Sub
...
Private Sub ReceptionAchat()
 ...
 If lvwProjet.ListItems.count > 0 Then
  ...
  If rstAchat.Fields("Modification") = False Then
  If lvwProjet.SelectedItem.ForeColor = COLOR_ORANGE Then 'COLOR_ORANGE ou bleu
  sQuantite = InputBox("Quelle est la quantité reçue?")
 ...
 If (CInt(Right$(sIDAchat, 2)) >= 1 And CInt(Right$(sIDAchat, 2)) <= 12) Or rstPiece.Fields("IDFRS") = 71 Then
 ...
 Else
 If CDbl(sQuantite) < CDbl(lvwProjet.SelectedItem.Text) Then
1  Set rstCopiePiece = New ADODB.Recordset
 ...
 Do While Not rstPiece.EOF
 If ((rstPiece.Fields("PIECE") <> lvwProjet.SelectedItem.SubItems(I_COL_PIECE)) Or (rstPiece.Fields("Qté") <> CDbl(sTotal) - CDbl(sQuantite))) Or bSkip = True Then
...
5  wOups "frmReceptionElec", "ReceptionAchat", Err, Err.number, Err.Description
End Sub
...
Private Sub EnleverInventaireProjet(ByVal sQuantite As String)
 ...
 rstInventaire.Fields("Description") = lvwProjet.SelectedItem.SubItems(I_COL_DESCRIPTION)
  ...
  Call frmChoixLocalisation.Afficher(ELECTRIQUE, lvwProjet.SelectedItem.SubItems(I_COL_PIECE))
...
4 wOups "frmReceptionElec", "EnleverInventaireProjet", Err, Err.number, Err.Description
End Sub
...
4  wOups "frmReceptionElec", "AjouterInventaireAchat", Err, Err.number, Err.Description
End Sub
...
Private Sub AjouterHistorique(ByVal sQuantite As String)
 ...
 Call rstHist.Open("SELECT * FROM GrbInventaireElecModif", g_connData, adOpenDynamic, adLockOptimistic)
...
wOups "frmReceptionElec", "AjouterHistorique", Err, Err.number, Err.Description
End Sub
...
Private Sub SupprimerHistorique(Optional ByVal sQuantite As String = "")
 ...
 If sQuantite <> "" Then
 If lvwProjet.SelectedItem.ListSubItems(I_COL_DISTRIBUTEUR).Tag = 71 Then
 Call rstHist.Open("SELECT * FROM GrbInventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '-" & sQuantite & "'", g_connData, adOpenDynamic, adLockOptimistic)
 Else
 Call rstHist.Open("SELECT * FROM GrbInventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '" & sQuantite & "'", g_connData, adOpenDynamic, adLockOptimistic)
 End If
 Else
  If lvwProjet.SelectedItem.ListSubItems(I_COL_DISTRIBUTEUR).Tag = 71 Then
  Call rstHist.Open("SELECT * FROM GrbInventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '-" & lvwProjet.SelectedItem.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
  Else
  Call rstHist.Open("SELECT * FROM GrbInventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '" & lvwProjet.SelectedItem.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
  End If
  End If
...
wOups "frmReceptionElec", "SupprimerHistorique", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmdFermer_Click", Err, Err.number, Err.Description
End Sub
...
wOups "frmReceptionElec", "Form_Load", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirComboProjet()
 ...
 Call rstProjet.Open("SELECT IDProjet FROM GrbProjetElec ORDER BY IDProjet DESC", g_connData, adOpenDynamic, adLockOptimistic)
...
Oups:
  ...
  wOups "frmReceptionElec", "RemplirComboProjet", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirComboAchat()
 ...
 Call rstAchat.Open("SELECT IDAchat, IndexAchat FROM GrbAchat WHERE Type = 'E' ORDER BY IDAchat DESC, IndexAchat DESC", g_connData, adOpenDynamic, adLockOptimistic)
...
Oups:
  ...
  wOups "frmReceptionElec", "RemplirComboAchat", Err, Err.number, Err.Description
End Sub
...
Call rstSection.Open("SELECT NomSectionFR FROM GrbSoumProjSectionElec WHERE IDSection = " & rstProjet.Fields("IDSection"), g_connData, adOpenDynamic, adLockOptimistic)
...
80 wOups "frmReceptionElec", "RemplirListViewProjet", Err, Err.number, Err.Description
End Sub
...
4  wOups "frmReceptionElec", "RemplirListViewProjet", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "lvwProjet_ItemClick", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmReceptionElec", "VerifierBoutonAnnuler", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "Afficher", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "AfficherProjet", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "AfficherAchat", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "lvwProjet_KeyDown", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "mvwReception_DateClick", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "mvwReception_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "mvwDateRequise_DateClick", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "mvwDateRequise_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "Form_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmReceptionElec", "cmdDate_Click", Err, Err.number, Err.Description
End Sub
