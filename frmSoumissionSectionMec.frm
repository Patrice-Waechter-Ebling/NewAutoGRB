...
Begin VB.Form frmSoumissionSectionMec 
   ...
   ClientWidth     =   6090
   LinkTopic       =   "Form1"
   Picture         =   "frmSoumissionSectionMec.frx":0000
   ScaleHeight     =   4080
   ScaleWidth      =   6090
...
30        Call rstSection.Open("SELECT NomSectionFR, NomSectionEN, Ordre FROM GRB_SoumProjSectionMec WHERE IDSection = " & lvwSection.ListItems(iCompteur).Tag, g_connData, adOpenDynamic, adLockOptimistic)
...
65      woups "frmSoumissionSectionMec", "Sauvegarde", Err, Erl
End Sub
...
25      Call rstSection.Open("SELECT * FROM GRB_SoumProjSectionMec ORDER BY Ordre", g_connData, adOpenDynamic, adLockOptimistic)
...
105     woups "frmSoumissionSectionMec", "RemplirListViewSection", Err, Erl
End Sub
...
40     woups "frmSoumissionSectionMec", "CmdAdd_Click", Err, Erl
End Sub
...
20      woups "frmSoumissionSectionMec", "cmdAnnuler_Click", Err, Erl
End Sub
...
50      If m_bAjout = True Then
          'ouvre la table
55        Call rstSection.Open("SELECT * FROM GRB_SoumProjSectionMec WHERE NomSectionFR = '" & Replace(txtFrancais.Text, "'", "''") & "' OR NomSectionEN = '" & Replace(txtAnglais.Text, "'", "''") & "'", g_connData, adOpenDynamic, adLockOptimistic)
  
          'si n'existe pas
60        If rstSection.EOF Then
65          Set rstMaxOrdre = New ADODB.Recordset

70          Call rstMaxOrdre.Open("SELECT Max(Ordre) as MaxOrdre FROM GRB_SoumProjSectionMec", g_connData, adOpenDynamic, adLockOptimistic)
...
135       Set rstSection = Nothing
140     Else
145       Call rstSection.Open("SELECT * FROM GRB_SoumProjSectionMec WHERE IDSection = " & lvwSection.SelectedItem.Tag, g_connData, adOpenDynamic, adLockOptimistic)
        
150       rstSection.Fields("NomSectionFR") = txtFrancais.Text
155       rstSection.Fields("NomSectionEN") = txtAnglais.Text
...
200     woups "frmSoumissionSectionMec", "CmdOK_Click", Err, Erl
End Sub
...
135     woups "frmSoumissionSectionMec", "cmdDown_Click", Err, Erl
End Sub
...
135     woups "frmSoumissionSectionMec", "cmdUp_Click", Err, Erl
End Sub
...
25      woups "frmSoumissionSectionMec", "CmdFerme_Click", Err, Erl
End Sub
...
30      woups "frmSoumissionSectionMec", "cmdModifier_Click", Err, Erl
End Sub
...
35          Call rstSoumission.Open("SELECT IDSection FROM GRB_Soumission_pieces WHERE IDSection = " & lvwSection.SelectedItem.Tag & " AND Type = 'M'", g_connData, adOpenDynamic, adLockOptimistic)
      
40          If rstSoumission.EOF Then
              'Efface l'enregistrement
45            Call g_connData.Execute("DELETE * FROM GRB_SoumProjSectionMec WHERE IDsection = " & lvwSection.SelectedItem.Tag)
...
125     woups "frmSoumissionSectionMec", "CmdSupp_Click", Err, Erl
End Sub
...
20      woups "frmSoumissionSectionMec", "Form_Load", Err, Erl
End Sub
...
75      woups "frmSoumissionSectionMec", "lvwSection_Click", Err, Erl
End Sub
...
30      woups "frmSoumissionSectionMec", "lvwSection_DblClick", Err, Erl
End Sub
