...
Begin VB.Form FrmReceptionElec 
   BackColor       =   &H00000000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Réception électrique"
   ClientHeight    =   7755
   ClientLeft      =   210
   ClientTop       =   630
   ClientWidth     =   11895
   Icon            =   "FrmReceptionElec.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   Picture         =   "FrmReceptionElec.frx":2CFA
   ScaleHeight     =   7755
   ScaleWidth      =   11895
   ...
   Begin VB.ComboBox cmbType 
      Height          =   315
      ItemData        =   "FrmReceptionElec.frx":206AC
      Left            =   3120
      List            =   "FrmReceptionElec.frx":206B6
      TabIndex        =   0
      Top             =   120
      Width           =   1455
   End
   ...
   End
End
Attribute VB_Name = "FrmReceptionElec"
...
Private m_collTable       As Collection
...
50      woups "frmReceptionElec", "chkDateRequise_Click", Err, Erl
End Sub
...
40      woups "frmReceptionElec", "chkProjetAchat_Click", Err, Erl
End Sub
...
50      woups "frmReceptionElec", "cmbNoProjet_KeyUp", Err, Erl
End Sub
...
40      Else
45        Call rstProjAchat.Open("SELECT * FROM GRB_ProjetElec WHERE IDProjet = '" & cmbNoProjet.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
50      End If
...
165     woups "frmReceptionElec", "cmbNoProjet_Click", Err, Erl
End Sub
...
85      woups "frmReceptionElec", "cmbType_Click", Err, Erl
End Sub
...
170     woups "frmReceptionElec", "cmdAfficher_Click", Err, Erl
End Sub
...
40      woups "frmReceptionElec", "cmdAnnuler_Click", Err, Erl
End Sub
...
40        Call rstProjet.Open("SELECT Modification, Par FROM GRB_ProjetElec WHERE IDProjet = '" & txtnoprojet.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)

45        If rstProjet.Fields("Modification") = False Then
50          Set rstPiece = New ADODB.Recordset

55          Call rstPiece.Open("SELECT * FROM GRB_Projet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' And NuméroLigne = " & lvwProjet.SelectedItem.ListSubItems(I_COL_MANUFACTURIER).Tag, g_connData, adOpenDynamic, adLockOptimistic)
...
200         m_iIndexReception = lvwProjet.SelectedItem.Index

205         Call RemplirListViewProjet(txtnoprojet.Text)
210       Else
215         Call MsgBox("Ce projet est en modification par " & rstProjet.Fields("Par") & "!", vbOKOnly, "Erreur")
220       End If

225       Call rstProjet.Close
230       Set rstProjet = Nothing
235     End If
...
245     woups "frmReceptionElec", "AnnulerReceptionProjet", Err, Erl
End Sub
...
130       Else
135         Call MsgBox("Cet achat est en modification par " & rstAchat.Fields("Par") & "!", vbOKOnly, "Erreur")
140       End If
...
165     woups "frmReceptionElec", "AnnulerReceptionAchat", Err, Erl
End Sub
...
30        Call rstInventaire.Open("SELECT * FROM GRB_InventaireElec WHERE NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
150     woups "frmReceptionElec", "EnleverInventaireAchat", Err, Erl
End Sub
...
110     woups "frmReceptionElec", "AjouterInventaireProjet", Err, Erl
End Sub
...
55      woups "frmReceptionElec", "cmdDateRequise_Click", Err, Erl
End Sub
...
20      woups "frmReceptionElec", "cmdFermerPieces_Click", Err, Erl
End Sub
...
20      woups "frmReceptionElec", "cmdImprimer_Click", Err, Erl
End Sub
...
15        Call frmChoixDateImpressionReception.Afficher(txtnoprojet.Text, ELECTRIQUE, ACHAT)
20      Else
25        Call frmChoixDateImpressionReception.Afficher(txtnoprojet.Text, ELECTRIQUE, PROJET)
30      End If
...
40      woups "frmReceptionElec", "ImprimerReception", Err, Erl
End Sub
...
65            Else
70              Call rstPiece.Open("SELECT GRB_Projet_Pieces.*, GRB_Fournisseur.NomFournisseur FROM GRB_Projet_Pieces INNER JOIN GRB_Fournisseur ON GRB_Projet_Pieces.IDFRS = GRB_Fournisseur.IDFRS WHERE Type = 'E' AND Commandé = True ORDER BY NomFournisseur", g_connData, adOpenDynamic, adLockOptimistic)
75            End If
80          End If
85        End If
90      Else
...
180       DR_BackOrder.Sections("Section4").Controls("lblTitre").Caption = "Projets électriques : Pièces non reçues"

185       DR_BackOrder.Sections("Section4").Controls("lblTitreProjetAchat").Caption = "Projet : "
190     Else
195       DR_BackOrder.Sections("Section4").Controls("lblTitre").Caption = "Achats électriques : Pièces non reçues"
...
230       DR_BackOrder.Sections("Section1").Controls("txtNoItem").DataField = "PIECE"
235       DR_BackOrder.Sections("Section1").Controls("txtNoProjAchat").DataField = "NoAchat"
240     End If
...
265     woups "frmReceptionElec", "cmdImprimerPieces_Click", Err, Erl
End Sub
...
50      woups "frmReceptionElec", "cmdNonRecu_Click", Err, Erl
End Sub
...
75            Else
80              Call rstPiece.Open("SELECT GRB_Projet_Pieces.*, GRB_Fournisseur.NomFournisseur FROM GRB_Projet_Pieces INNER JOIN GRB_Fournisseur ON GRB_Projet_Pieces.IDFRS = GRB_Fournisseur.IDFRS WHERE Type = 'E' AND Commandé = True ORDER BY NomFournisseur", g_connData, adOpenDynamic, adLockOptimistic)
85            End If
90          End If
95        End If
100     Else
...
325     woups "frmReceptionElec", "RemplirListePiecesNonRecues", Err, Erl
End Sub
...
40      woups "frmReceptionElec", "Form_KeyDown", Err, Erl
End Sub
...
25      woups "frmReceptionElec", "Form_Unload", Err, Erl
End Sub
...
20      woups "frmReceptionElec", "lvwProjet_Click", Err, Erl
End Sub
...
40      woups "frmReceptionElec", "lvwProjet_DblClick", Err, Erl
End Sub
...
65        Call rstProjet.Open("SELECT Modification, Par, Profit FROM GRB_ProjetElec WHERE IDProjet = '" & txtnoprojet.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
80            sQuantite = InputBox("Quelle est la quantité reçue?")
...
120                 Set rstModif = New ADODB.Recordset

125                 If CDbl(sQuantite) = CDbl(lvwProjet.SelectedItem.Text) Then
130                   Call rstPiece.Open("SELECT * FROM GRB_Projet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' AND NuméroLigne = " & lvwProjet.SelectedItem.ListSubItems(I_COL_MANUFACTURIER).Tag, g_connData, adOpenDynamic, adLockOptimistic)
...
260                     Set rstCopiePiece = New ADODB.Recordset

265                     Call rstPiece.Open("SELECT * FROM GRB_Projet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' AND NuméroLigne = " & lvwProjet.SelectedItem.ListSubItems(I_COL_MANUFACTURIER).Tag, g_connData, adOpenDynamic, adLockOptimistic)

270                     sTotal = rstPiece.Fields("Qté")

275                     rstPiece.Fields("Qté") = sQuantite
                    
                        'Si le temps n'est pas vide
285                     If Trim(rstPiece.Fields("Temps")) <> vbNullString Then
                          'On calcul le temps * quantité pour la colonne montage
290                       rstPiece.Fields("Temps_total") = CDbl(Replace(rstPiece.Fields("Temps"), ".", ",")) * CDbl(Replace(rstPiece.Fields("Qté"), "*", vbNullString))
295                     Else
300                       rstPiece.Fields("Temps_total") = vbNullString
305                     End If
     
                        'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
310                     rstPiece.Fields("Prix_Total") = Conversion(CStr(Round(Replace(rstPiece.Fields("Qté"), "*", vbNullString) * rstPiece.Fields("Prix_net") * CSng(sProfit), 2)), MODE_PAS_FORMAT)
       
                        'Pour le profit, c'est le prix total - (prix net * quantité)
315                     rstPiece.Fields("Profit_argent") = Conversion(CStr(Round(rstPiece.Fields("Prix_total") - (rstPiece.Fields("Prix_net") * Replace(rstPiece.Fields("Qté"), "*", vbNullString)), 2)), MODE_PAS_FORMAT)

320                     rstPiece.Fields("Recu") = True
325                     rstPiece.Fields("Commandé") = False
330                     rstPiece.Fields("DateRéception") = txtDateReception.Text

335                     Call rstPiece.Update

340                     Call rstCopiePiece.Open("SELECT * FROM GRB_Projet_Pieces", g_connData, adOpenDynamic, adLockOptimistic)

345                     Call rstCopiePiece.AddNew

350                     rstCopiePiece.Fields("IDProjet") = rstPiece.Fields("IDProjet")
355                     rstCopiePiece.Fields("IDSection") = rstPiece.Fields("IDSection")
360                     rstCopiePiece.Fields("NumItem") = rstPiece.Fields("NumItem")
365                     rstCopiePiece.Fields("Qté") = CDbl(sTotal) - CDbl(sQuantite)
370                     rstCopiePiece.Fields("Desc_FR") = rstPiece.Fields("Desc_FR")
375                     rstCopiePiece.Fields("Desc_EN") = rstPiece.Fields("Desc_EN")
380                     rstCopiePiece.Fields("Manufact") = rstPiece.Fields("Manufact")
385                     rstCopiePiece.Fields("Prix_List") = rstPiece.Fields("Prix_List")
390                     rstCopiePiece.Fields("Escompte") = rstPiece.Fields("Escompte")
395                     rstCopiePiece.Fields("Prix_net") = rstPiece.Fields("Prix_net")
400                     rstCopiePiece.Fields("IDFRS") = rstPiece.Fields("IDFRS")
405                     rstCopiePiece.Fields("Temps") = rstPiece.Fields("Temps")

410                     If Trim(rstCopiePiece.Fields("Temps")) <> vbNullString Then
                          'On calcul le temps * quantité pour la colonne montage
415                       rstCopiePiece.Fields("Temps_total") = CDbl(Replace(rstCopiePiece.Fields("Temps"), ".", ",")) * CDbl(Replace(rstCopiePiece.Fields("Qté"), "*", vbNullString))
420                     Else
425                       rstCopiePiece.Fields("Temps_total") = vbNullString
430                     End If

                        'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
435                     rstCopiePiece.Fields("Prix_Total") = Conversion(CStr(Round(Replace(rstCopiePiece.Fields("Qté"), "*", vbNullString) * rstCopiePiece.Fields("Prix_net") * CSng(sProfit), 2)), MODE_PAS_FORMAT)
     
440                     rstCopiePiece.Fields("Profit_Pourcent") = rstPiece.Fields("Profit_Pourcent")
     
                        'Pour le profit, c'est le prix total - (prix net * quantité)
445                     rstCopiePiece.Fields("Profit_argent") = Conversion(CStr(Round(rstCopiePiece.Fields("Prix_total") - (rstCopiePiece.Fields("Prix_net") * Replace(rstCopiePiece.Fields("Qté"), "*", vbNullString)), 2)), MODE_PAS_FORMAT)

450                     rstCopiePiece.Fields("SousSection") = rstPiece.Fields("SousSection")
455                     rstCopiePiece.Fields("OrdreSection") = rstPiece.Fields("OrdreSection")
460                     rstCopiePiece.Fields("NuméroLigne") = rstPiece.Fields("NuméroLigne") + 1
465                     rstCopiePiece.Fields("PrixOrigine") = rstPiece.Fields("PrixOrigine")
470                     rstCopiePiece.Fields("Type") = rstPiece.Fields("Type")
475                     rstCopiePiece.Fields("Visible") = rstPiece.Fields("Visible")
480                     rstCopiePiece.Fields("Commandé") = True
485                     rstCopiePiece.Fields("Quoté") = rstPiece.Fields("Quoté")
490                     rstCopiePiece.Fields("Recu") = False
495                     rstCopiePiece.Fields("Retour") = False
500                     rstCopiePiece.Fields("NoRetour") = vbNullString
505                     rstCopiePiece.Fields("CommandeAnnulée") = False
510                     rstCopiePiece.Fields("DateRéception") = vbNullString
520                     rstCopiePiece.Fields("Facturation") = rstPiece.Fields("Facturation")
525                     rstCopiePiece.Fields("ID") = ""
530                     rstCopiePiece.Fields("PieceExtra") = rstPiece.Fields("PieceExtra")
535                     rstCopiePiece.Fields("DateCommande") = rstPiece.Fields("DateCommande")
540                     rstCopiePiece.Fields("DateRequise") = rstPiece.Fields("DateRequise")
545                     rstCopiePiece.Fields("MatérielInutile") = False

550                     Call rstCopiePiece.Update

555                     Call rstCopiePiece.Close

560                     Call rstPiece.Close

565                     Call rstPiece.Open("SELECT * FROM GRB_Projet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' AND NuméroLigne >= " & lvwProjet.SelectedItem.ListSubItems(I_COL_MANUFACTURIER).Tag + 1, g_connData, adOpenDynamic, adLockOptimistic)

570                     bSkip = False

575                     Do While Not rstPiece.EOF
580                       If ((rstPiece.Fields("NumItem") <> lvwProjet.SelectedItem.SubItems(I_COL_PIECE)) Or (rstPiece.Fields("Qté") <> CDbl(sTotal) - CDbl(sQuantite))) Or bSkip = True Then
585                         rstPiece.Fields("NuméroLigne") = rstPiece.Fields("NuméroLigne") + 1
...
610                       Call rstPiece.MoveNext
615                     Loop

620                     Call rstPiece.Close

                        'Ajout aux modifs
625                     Call rstModif.Open("SELECT * FROM GRB_Projet_Modif", g_connData, adOpenDynamic, adLockOptimistic)

630                     Call rstModif.AddNew

635                     Call rstEmploye.Open("SELECT noEmploye FROM GRB_Employés WHERE loginname = '" & g_sUserID & "'", g_connData, adOpenDynamic, adLockOptimistic)
 
640                     rstModif.Fields("Type") = "E"
645                     rstModif.Fields("IDProjet") = txtnoprojet.Text
650                     rstModif.Fields("noEmployé") = rstEmploye.Fields("noEmploye")
655                     rstModif.Fields("Date") = ConvertDate(Date)
660                     rstModif.Fields("Heure") = Time
665                     rstModif.Fields("TypeModif") = "RECEPTION"

670                     Call rstEmploye.Close

675                     Call rstModif.Update

680                     Call rstModif.Close

685                     If UCase(lvwProjet.SelectedItem.SubItems(I_COL_DISTRIBUTEUR)) = "SOLUTION GRB INC." Then
690                       Call EnleverInventaireProjet(sQuantite)
695                     End If

700                     m_iIndexReception = lvwProjet.SelectedItem.Index

705                     Call RemplirListViewProjet(txtnoprojet.Text)

710                     Set rstCopiePiece = Nothing
715                   Else
720                     Call MsgBox("La quantité est trop grande!", vbOKOnly, "Erreur")
725                   End If
730                 End If

735                 Set rstPiece = Nothing
740                 Set rstEmploye = Nothing
745                 Set rstModif = Nothing
750               Else
755                 Call MsgBox("La quantité doit être plus grande que 0!", vbOKOnly, "Erreur")
760               End If
765             Else
770               Call MsgBox("Quantité non numérique!", vbOKOnly, "Erreur")
775             End If
780           End If
785         End If
790       Else
795         Call MsgBox("Ce projet est en modification par " & rstProjet.Fields("Par") & "!", vbOKOnly, "Erreur")
800       End If

805       Call rstProjet.Close
810       Set rstProjet = Nothing
815     End If
...
825     woups "frmReceptionElec", "ReceptionProjet", Err, Erl
End Sub
...
85          If lvwProjet.SelectedItem.ForeColor = COLOR_ORANGE Then 'COLOR_ORANGE ou bleu
...
155                   If (CInt(Right$(sIDAchat, 2)) >= 1 And CInt(Right$(sIDAchat, 2)) <= 12) Or rstPiece.Fields("IDFRS") = 717 Then
...
195                     Set rstCopiePiece = New ADODB.Recordset

200                     Call rstPiece.Open("SELECT * FROM GRB_Achat_Pieces WHERE IDAchat = '" & sIDAchat & "' AND IndexAchat = " & iIndexAchat & " AND NuméroLigne = " & lvwProjet.SelectedItem.ListSubItems(I_COL_MANUFACTURIER).Tag, g_connData, adOpenDynamic, adLockOptimistic)

205                     sTotal = rstPiece.Fields("Qté")

210                     rstPiece.Fields("Qté") = sQuantite
    
                        'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
220                     rstPiece.Fields("Prix_Total") = Conversion(CStr(Round(Replace(rstPiece.Fields("Qté"), "*", vbNullString) * rstPiece.Fields("Prix_net"), 2)), MODE_PAS_FORMAT)

225                     rstPiece.Fields("Recu") = True
230                     rstPiece.Fields("Commandé") = False
235                     rstPiece.Fields("DateRéception") = txtDateReception.Text

240                     Call rstPiece.Update
...
375                     iIDFRS = rstPiece.Fields("IDFRS")

380                     Call rstPiece.Close

385                     Call rstPiece.Open("SELECT * FROM GRB_Achat_Pieces WHERE IDAchat = '" & sIDAchat & "' AND IndexAchat = " & iIndexAchat & " AND NuméroLigne >= " & lvwProjet.SelectedItem.ListSubItems(I_COL_MANUFACTURIER).Tag + 1, g_connData, adOpenDynamic, adLockOptimistic)

390                     bSkip = False

395                     Do While Not rstPiece.EOF
400                       If ((rstPiece.Fields("PIECE") <> lvwProjet.SelectedItem.SubItems(I_COL_PIECE)) Or (rstPiece.Fields("Qté") <> CDbl(sTotal) - CDbl(sQuantite))) Or bSkip = True Then
...
430                       Call rstPiece.MoveNext
435                     Loop

440                     Call rstPiece.Close

445                     If (CInt(Right$(sIDAchat, 2)) >= 0 And CInt(Right$(sIDAchat, 2)) <= 12) Or iIDFRS = 717 Then
450                       Call AjouterInventaireAchat(sQuantite)
455                     End If

460                     m_iIndexReception = lvwProjet.SelectedItem.Index

465                     Call RemplirListViewAchat(txtnoprojet.Text)

470                     Set rstCopiePiece = Nothing
475                   Else
480                     Call MsgBox("La quantité est trop grande!", vbOKOnly, "Erreur")
485                   End If

490                   Set rstPiece = Nothing
495                 End If
500               Else
...
535         End If
540       Else
545         Call MsgBox("Cet achat est en modification par " & rstAchat.Fields("Par") & "!", vbOKOnly, "Erreur")
550       End If
...
575     woups "frmReceptionElec", "ReceptionAchat", Err, Erl
End Sub
...
35        Call rstInventaire.Open("SELECT * FROM GRB_InventaireElec WHERE NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
90          Call frmChoixLocalisation.Afficher(ELECTRIQUE, lvwProjet.SelectedItem.SubItems(I_COL_PIECE))
...
235         Else
240           rstInventaire.Fields("Prix Liste") = "0"
245         End If
...
410     woups "frmReceptionElec", "EnleverInventaireProjet", Err, Erl
End Sub
...
50        Call rstInventaire.Open("SELECT * FROM GRB_InventaireElec WHERE NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
105         Call frmChoixLocalisation.Afficher(ELECTRIQUE, lvwProjet.SelectedItem.SubItems(I_COL_PIECE))
...
475     woups "frmReceptionElec", "AjouterInventaireAchat", Err, Erl
End Sub
...
20      Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif", g_connData, adOpenDynamic, adLockOptimistic)
...
115     woups "frmReceptionElec", "AjouterHistorique", Err, Erl
End Sub
...
35            Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '-" & sQuantite & "'", g_connData, adOpenDynamic, adLockOptimistic)
40          Else
45            Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '" & sQuantite & "'", g_connData, adOpenDynamic, adLockOptimistic)
50          End If
55        Else
60          If lvwProjet.SelectedItem.ListSubItems(I_COL_DISTRIBUTEUR).Tag = 717 Then
65            Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '-" & lvwProjet.SelectedItem.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
70          Else
75            Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '" & lvwProjet.SelectedItem.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
80          End If
85        End If
90      Else
95        If sQuantite <> "" Then
100         Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '" & "-" & sQuantite & "'", g_connData, adOpenDynamic, adLockOptimistic)
105       Else
110         Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif WHERE [Date] = '" & lvwProjet.SelectedItem.SubItems(I_COL_DATE_RECEPTION) & "' AND IDProjet = '" & txtnoprojet.Text & "' AND NoItem = '" & Replace(lvwProjet.SelectedItem.SubItems(I_COL_PIECE), "'", "''") & "' AND Quantité = '" & "-" & lvwProjet.SelectedItem.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
115       End If
120     End If
...
155     woups "frmReceptionElec", "SupprimerHistorique", Err, Erl
End Sub
...
20      woups "frmReceptionElec", "cmdFermer_Click", Err, Erl
End Sub
...
140     woups "frmReceptionElec", "Form_Load", Err, Erl
End Sub
...
25      Call rstProjet.Open("SELECT IDProjet FROM GRB_ProjetElec ORDER BY IDProjet DESC", g_connData, adOpenDynamic, adLockOptimistic)
...
80      woups "frmReceptionElec", "RemplirComboProjet", Err, Erl
End Sub
...
25      Call rstAchat.Open("SELECT IDAchat, IndexAchat FROM GRB_Achat WHERE Type = 'E' ORDER BY IDAchat DESC, IndexAchat DESC", g_connData, adOpenDynamic, adLockOptimistic)
...
80      woups "frmReceptionElec", "RemplirComboAchat", Err, Erl
End Sub
...
105         Call rstSection.Open("SELECT NomSectionFR FROM GRB_SoumProjSectionElec WHERE IDSection = " & rstProjet.Fields("IDSection"), g_connData, adOpenDynamic, adLockOptimistic)
...
215           Call rstSection.Open("SELECT NomSectionFR FROM GRB_SoumProjSectionElec WHERE IDSection = " & rstProjet.Fields("IDSection"), g_connData, adOpenDynamic, adLockOptimistic)
...
805     woups "frmReceptionElec", "RemplirListViewProjet", Err, Erl
End Sub
...
495     woups "frmReceptionElec", "RemplirListViewProjet", Err, Erl
End Sub
...
20      woups "frmReceptionElec", "lvwProjet_ItemClick", Err, Erl
End Sub
...
60      woups "frmReceptionElec", "VerifierBoutonAnnuler", Err, Erl
End Sub
...
25     woups "frmReceptionElec", "Afficher", Err, Erl
End Sub
...
30      woups "frmReceptionElec", "AfficherProjet", Err, Erl
End Sub
...
30      woups "frmReceptionElec", "AfficherAchat", Err, Erl
End Sub
...
50      woups "frmReceptionElec", "lvwProjet_KeyDown", Err, Erl
End Sub
...
25      woups "frmReceptionElec", "mvwReception_DateClick", Err, Erl
End Sub
...
20      woups "frmReceptionElec", "mvwReception_LostFocus", Err, Erl
End Sub
...
25      woups "frmReceptionElec", "mvwDateRequise_DateClick", Err, Erl
End Sub
...
20      woups "frmReceptionElec", "mvwDateRequise_LostFocus", Err, Erl
End Sub
...
25      woups "frmReceptionElec", "Form_Click", Err, Erl
End Sub
...
55      woups "frmReceptionElec", "cmdDate_Click", Err, Erl
End Sub
