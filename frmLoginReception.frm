VERSION 5.00
Begin VB.Form frmLoginReception 
   BackColor       =   &H00000000&
   ...
   MinButton       =   0   'False
   Moveable        =   0   'False
   Picture         =   "frmLoginReception.frx":0000
   ScaleHeight     =   2670
   ScaleWidth      =   4665
   ...
   End
End
Attribute VB_Name = "frmLoginReception"
...
65          frmChoixProjSoum.m_iNoGroupe = rstEmploye.Fields("Groupe")
        
70          frmChoixProjSoum.m_sUserID = txtlogin.Text
