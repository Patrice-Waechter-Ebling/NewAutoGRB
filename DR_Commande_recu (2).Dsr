VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} DR_Commande_recu 
   Caption         =   "Reception des Commandes"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15240
   ...
   EndProperty
End
Attribute VB_Name = "DR_Commande_recu"
...
Oups:
 ...
 wOups "DR_Commande_recu", "DataReport_Activate", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "DR_Commande_recu", "DataReport_Initialize", Err, Err.number, Err.Description
End Sub
