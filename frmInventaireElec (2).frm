...
If sWhere <> "" Then
 Call rstHist.Open("SELECT * FROM GrbInventaireElecModif WHERE " & sWhere & " ORDER BY NoEnreg DESC", g_connData, adOpenDynamic, adLockOptimistic)
Else
 Call rstHist.Open("SELECT * FROM GrbInventaireElecModif ORDER BY NoEnreg DESC", g_connData, adOpenDynamic, adLockOptimistic)
End If
...
1  End If
 ...
 'No Item
 itmHist.SubItems(I_HIST_PIECE) = rstHist.Fields("NoItem")
...
wOups "frmInventaireElec", "RemplirListViewHistorique", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmInventaireElec", "chkChoix_Click", Err, Err.number, Err.Description
End Sub
...
wOups "frmInventaireElec", "cmdAfficherHistorique_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmInventaireElec", "cmdImprimer_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmInventaireElec", "cmdFermer_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmInventaireElec", "Form_Load", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmInventaireElec", "lvwHistorique_ColumnClick", Err, Err.number, Err.Description
End Sub
...
Private Sub lvwHistorique_KeyDown(KeyCode As Integer, Shift As Integer)
 ...
 Call g_connData.Execute("DELETE * FROM GrbInventaireElecModif WHERE NoEnreg = " & lvwHistorique.SelectedItem.Tag)
...
Oups:
  ...
  wOups "frmInventaireElec", "lvwHistorique_KeyDown", Err, Err.number, Err.Description
End Sub
...
Private Sub ModifierInventaire(ByVal sPiece As String, ByVal sQuantite As String)
 ...
 Call rstInv.Open("SELECT * FROM GrbInventaireElec WHERE NoItem = '" & Replace(sPiece, "'", "''") & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
Oups:
  ...
  wOups "frmInventaireElec", "ModifierInventaire", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmInventaireElec", "mskDateDebut_GotFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmInventaireElec", "mskDateDebut_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmInventaireElec", "mskDateFin_GotFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmInventaireElec", "mskDateFin_LostFocus", Err, Err.number, Err.Description
End Sub
...
Private Sub ImprimerAjustementInventaire()
 ...
 Call rstInv.Open("SELECT NoItem, QuantitéStock, Description, Manufacturier, Localisation FROM GrbInventaireElec ORDER BY Localisation, NoItem", g_connData, adOpenDynamic, adLockOptimistic)
 
 Set DR_ListeInventaire.DataSource = rstInv
 
 DR_ListeInventaire.Sections("Section3").Controls("lblDate").Caption = ConvertDate(Date)
 DR_ListeInventaire.Sections("Section4").Controls("lblTitre").Caption = "Inventaire Électrique"
...
Private Sub ImprimerValeurComptable()
 ...
 Call rstInv.Open("SELECT NoItem, Description, Manufacturier, [Prix Liste], Escompte, [Prix Net], Localisation, QuantitéStock, [Prix Net] * QuantitéStock As Total FROM GrbInventaireElec WHERE QuantitéStock <> '0' ORDER BY NoItem", g_connData, adOpenDynamic, adLockOptimistic)
 
 Set DR_Inventaire.DataSource = rstInv
 
 Call rstTotal.Open("SELECT SUM([Prix net] * QuantitéStock) As Total FROM GrbInventaireElec", g_connData, adOpenDynamic, adLockOptimistic)
 ...
 DR_Inventaire.Sections("Section4").Controls("lblTitre").Caption = "Inventaire Électrique"
