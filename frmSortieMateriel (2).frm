...
Private Sub cmdEnregistrer_Click()
 ...
 rstSortie.Fields("Qté") = txtQte.Text
 ...
 Call rstSortie.Update

1  Call rstSortie.Close
 Set rstSortie = Nothing

 rstInv.Fields("QuantitéStock") = CDbl(rstInv.Fields("QuantitéStock")) - CDbl(txtQte.Text)
...
4 Call MsgBox("La sortie de matériel a été enregistrée!", vbOKOnly, "Erreur")
...
4  End If
4  Else
4  Call MsgBox("Projet inexistant!", vbOKOnly, "Erreur")
50 End If
Else
...
Oups:
 ...
 wOups "frmSortieMateriel", "cmdEnregistrer_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSortieMateriel", "cmdFermer_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmSortieMateriel", "ViderChamps", Err, Err.number, Err.Description
End Sub
...
wOups "frmSortieMateriel", "RemplirListViewRecherche", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSortieMateriel", "cmdRechercher_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSortieMateriel", "Form_Load", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmSortieMateriel", "RemplirComboEmployes", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSortieMateriel", "lvwRecherche_DblClick", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSortieMateriel", "mskNoProjet_Change", Err, Err.number, Err.Description
End Sub
...
10 Else
1 Call MsgBox("Impossible de faire une sortie de matériel sur ce numéro!", vbOKOnly, "Erreur")
...
wOups "frmSortieMateriel", "AfficherClient", Err, Err.number, Err.Description
End Function
...
Oups:
  ...
  wOups "frmSortieMateriel", "chkMecanique_Click", Err, Err.number, Err.Description
End Sub
...
Public Sub Afficher(ByVal eCatalogue As enumCatalogue)
 ...
 Call Unload(frmChoixSortieMateriel)
...
Oups:
 ...
 wOups "frmSortieMateriel", "Afficher", Err, Err.number, Err.Description
End Sub
...
rstPiece.Fields("Qté") = txtQte.Text
...
rstPiece.Fields("Prix_Total") = Conversion(rstInv.Fields("Prix net") * txtQte.Text * CDbl(sProfit), MODE_PAS_FORMAT)
rstPiece.Fields("Profit_argent") = Conversion(rstPiece.Fields("Prix_Total") - (rstInv.Fields("Prix net") * txtQte.Text), MODE_PAS_FORMAT)
...
Oups:
 ...
 wOups "frmSortieMateriel", "AjouterDansProjet", Err, Err.number, Err.Description
End Sub
...
wOups "frmSortieMateriel", "CalculerTempsMecRecordset", Err, Err.number, Err.Description
End Sub
...
4  rstProjet.Fields("total_commission") = dblCommission
4  rstProjet.Fields("Total_manuel") = dblTotalManuel
4  rstProjet.Fields("Total_temps") = dblTotalTemps
4  rstProjet.Fields("total_imprevue") = dblTotalPieceImprevue - dblPrixPieces
4  rstProjet.Fields("total_piece") = dblPrixPieces
...
Oups:
 ...
 wOups "frmSortieMateriel", "CalculerTotalRecordset", Err, Err.number, Err.Description
End Sub
...
10 Dim dblHebergement As Double
...
1  Set rstConfig = New ADODB.Recordset
...
2  dblTotalAssemblage = CDbl(rstProjet.Fields("TempsAssemblage")) * CDbl(rstProjet.Fields("TauxAssemblageSystèmes"))
dblTotalPeinture = CDbl(rstProjet.Fields("TempsPeinture")) * CDbl(rstProjet.Fields("TauxPeintureFinition"))
2  dblTotalTest = CDbl(rstProjet.Fields("TempsTest")) * CDbl(rstProjet.Fields("TauxTestsFinaux"))
dblTotalDessin = CDbl(rstProjet.Fields("TempsDessin")) * CDbl(rstProjet.Fields("TauxConceptionDessins"))
2  dblTotalFormation = CDbl(rstProjet.Fields("TempsFormation")) * CDbl(rstProjet.Fields("TauxFormation"))
dblTotalInstallation = CDbl(rstProjet.Fields("TempsInstallation")) * CDbl(rstProjet.Fields("TauxInstallation"))
2  dblTotalGestion = CDbl(rstProjet.Fields("TempsGestion")) * CDbl(rstProjet.Fields("TauxGestion"))
...
30 If Not IsNull(rstProjet.Fields("NbrePersonne")) Then
3 If Trim(rstProjet.Fields("NbrePersonne")) <> "" Then
...
50 dblTotalImprevue = (dblPrixPieces + dblProfit) * CDbl(sImprevue)
 
50 dblPrixTotal = dblPrixPieces + dblProfit + dblTotalTemps + dblTotalImprevue + dblTotalManuel + dblTotalResteTemps
 
 'Le calcul de la commission est sur les manuels (Nbre de page * prix par pages * nbre de copies) + (prix des pièces * pourcentage d'imprévus) + total des temps
 dblCommission = dblPrixTotal * CDbl(sCommission)
...
5  wOups "frmSortieMateriel", "CalculerTotalRecordset", Err, Err.number, Err.Description
End Sub
