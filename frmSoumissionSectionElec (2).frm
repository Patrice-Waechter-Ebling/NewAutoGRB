...
Private Sub Sauvegarde()
 ...
 Call rstSection.Open("SELECT NomSectionFR, NomSectionEN, Ordre FROM GrbSoumProjSectionElec WHERE IDSection = " & lvwSection.ListItems(iCompteur).Tag, g_connData, adOpenDynamic, adLockOptimistic)
...
Oups:
  ...
  wOups "frmSoumissionSectionElec", "Sauvegarde", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirListViewSection()
 ...
 itmSection.Tag = rstSection.Fields("IDSection")
...
wOups "frmSoumissionSectionElec", "RemplirListViewSection", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSoumissionSectionElec", "CmdAdd_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSoumissionSectionElec", "cmdAnnuler_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdOK_Click()
 ...
 'ouvre la table
 Call rstSection.Open("SELECT * FROM GrbSoumProjSectionElec WHERE NomSectionFR = '" & Replace(txtFrancais.Text, "'", "''") & "' OR NomSectionEN = '" & Replace(txtAnglais.Text, "'", "''") & "'", g_connData, adOpenDynamic, adLockOptimistic)
 
 'si n'existe pas
  If rstSection.EOF Then
  Set rstMaxOrdre = New ADODB.Recordset

  Call rstMaxOrdre.Open("SELECT Max(Ordre) as MaxOrdre FROM GrbSoumProjSectionElec", g_connData, adOpenDynamic, adLockOptimistic)
...
Call rstSection.Update
 ...
 Call rstSection.Close
Else
 Call rstSection.Open("SELECT * FROM GrbSoumProjSectionElec WHERE IDSection = " & lvwSection.SelectedItem.Tag, g_connData, adOpenDynamic, adLockOptimistic)
...
1  wOups "frmSoumissionSectionElec", "CmdOK_Click", Err, Err.number, Err.Description
End Sub
...
wOups "frmSoumissionSectionElec", "cmdDown_Click", Err, Err.number, Err.Description
End Sub
...
wOups "frmSoumissionSectionElec", "cmdUp_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSoumissionSectionElec", "CmdFerme_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSoumissionSectionElec", "cmdModifier_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub CmdSupp_Click()
 ...
 Call SupprimerSection

 Exit Sub

Oups:

 wOups "frmSoumissionSectionElec", "CmdSupp_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub SupprimerSection()
 ...
 Call rstSoumission.Open("SELECT IDSection FROM GrbSoumission_pieces WHERE IDSection = " & lvwSection.SelectedItem.Tag & " AND Type = 'E'", g_connData, adOpenDynamic, adLockOptimistic)
 
 If rstSoumission.EOF Then
 'efface l'enregistrement
 Call g_connData.Execute("DELETE * FROM GrbSoumProjSectionElec WHERE IDsection = " & lvwSection.SelectedItem.Tag)
...
wOups "frmSoumissionSectionElec", "SupprimerSection", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSoumissionSectionElec", "Form_Load", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmSoumissionSectionElec", "lvwSection_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSoumissionSectionElec", "lvwSection_DblClick", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmSoumissionSectionElec", "lvwSection_KeyDown", Err, Err.number, Err.Description
End Sub
