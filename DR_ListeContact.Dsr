VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} DR_ListeContact 
   Caption         =   "Liste contacts"
   ClientHeight    =   6975
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8595
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   8388608
         Object.Caption         =   "Liste des Contacts"
      EndProperty
      ItemType1       =   3
   ...
   EndProperty
End
Attribute VB_Name = "DR_ListeContact"
...
20      woups "DR_ListeContact", "DataReport_Activate", Err, Erl
End Sub
...
20      woups "DR_ListeContact", "DataReport_Initialize", Err, Erl
End Sub
