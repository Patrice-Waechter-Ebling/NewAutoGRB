...
Private Sub cmdAppliquer_Click()
 ...
 'Enregistrement des paramètres dans la table GrbConfig
...
Private Function VerifierChamps() As Boolean
 ...
 If objControl.Name <> "txtCheminSEE4000" Then
  ...
  Call MsgBox("Champs non numérique!", vbOKOnly, "Erreur")
...
If txtProfitElec.Text < 1 Then
 Call MsgBox("Le pourcentage de profit électrique doit être plus grand que 1 !", vbOKOnly, "Erreur")
...
If txtProfitMec.Text < 1 Then
 Call MsgBox("Le pourcentage de profit mécanique doit être plus grand que 1 !", vbOKOnly, "Erreur")
...
1  If txtCommission.Text > 1 Then
 Call MsgBox("Le pourcentage de commission doit être plus petit que 1 !", vbOKOnly, "Erreur")
...
If txtImprevus.Text > 1 Then
 Call MsgBox("Le pourcentage d'imprévus doit être plus petit que 1 !", vbOKOnly, "Erreur")
...
Private Sub EnregistrerConfiguration()
 ...
 rstPara.Fields("Imprévus") = txtImprevus.Text
...
Private Sub RemplirValue()
 ...
 'On remplir les champs à l'aide de la table GrbConfig
 Dim rstPara As ADODB.Recordset
 ...
 If Not IsNull(rstPara.Fields("Commission")) Then
  ...
  If Not IsNull(rstPara.Fields("Imprévus")) Then
  txtImprevus.Text = rstPara.Fields("Imprévus")
  End If
