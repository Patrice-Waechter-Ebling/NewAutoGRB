...
Oups:
 ...
 wOups "frmProjSoumMec", "PeutFermer", Err, Err.number, Err.Description
End Function
...
Private Sub InitialiserVariables(ByVal sNoProjSoum As String)
 ...
 End If
  ...
  Else
  m_sProfit = rstConfig.Fields("ProfitMec")
...
wOups "frmProjSoumMec", "InitialiserVariables", Err, Err.number, Err.Description
End Sub
...
Private Sub ActiverBoutonsGroupe()
 ...
 If g_bAffichageProjetsMec = True And g_bAffichageSoumissionsMec = True Then
 'On affiche cmbChoix
 ...
 If g_bAffichageProjetsMec = True Then
...
m_bModifProj = g_bModificationProjetsMec
m_bModifSoum = g_bModificationSoumissionsMec
...
1  cmdCreerProjet.Enabled = bModif
...
1  cmdRetour.Enabled = g_bModificationRetourMarchandise
...
wOups "frmProjSoumMec", "ActiverBoutonsGroupe", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "AfficherProjSoum", Err, Err.number, Err.Description
End Sub
...
Private Sub AfficherControles(ByVal eMode As enumMode)
 ...
 Dim bCmbProjSoum As Boolean
  ...
  Dim bHistorique As Boolean
10 Dim bCopier As Boolean
...
Dim bSortiMagasin As Boolean
1  Dim bRetour As Boolean
...
1  Select Case eMode
 ...
 If g_bModificationRetourMarchandise = True Then
4 bRetour = True
4 End If
...
50 Cmdajouter.Visible = bAjouter
50 cmdModifier.Visible = bModifier
...
5  cmdMaterielInutile.Visible = bInutile
5  cmdMauvaisPrix.Visible = bMauvaisPrix
5  cmdSortieMagasin.Visible = bSortiMagasin
60 cmdRetour.Visible = bRetour
60 cmdForfait.Visible = bForfait
  ...
  txtClient.Visible = Not bCmbClient
...
6  txtChoix.Visible = Not bCmbChoix
6  End If

6  cmbOuvertFerme.Visible = bCmbOuvertFerme

6  cmbProjSoum.Visible = bCmbProjSoum
6  txtNoProjSoum.Visible = Not bCmbProjSoum

70 lblSections.Visible = bSection
70 cmbSections.Visible = bSection
  ...
  lblPrixTotal.Visible = m_bDroitPrix
  lblCommission.Visible = m_bDroitPrix
   lblProfit.Visible = m_bDroitPrix
   lblImprevus.Visible = m_bDroitPrix
7  lblTotalPieces.Visible = m_bDroitPrix
7  lblTotalTemps.Visible = m_bDroitPrix

7  txtPrixTotal.Visible = m_bDroitPrix
7  txtCommission.Visible = m_bDroitPrix
7  txtProfit.Visible = m_bDroitPrix
7  txtImprevus.Visible = m_bDroitPrix
80 txtTotalPieces.Visible = m_bDroitPrix
80 txtTotalTemps.Visible = m_bDroitPrix
...
Oups:
  ...
  wOups "frmProjSoumMec", "AfficherControles", Err, Err.number, Err.Description
End Sub
...
30 wOups "frmProjSoumMec", "cmbChoix_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmbclient_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmbPieces_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub cmbProjSoum_Click()
 ...
 sNumero = txtNoProjSoum.Text
  ...
  If m_eType = TYPE_PROJET Then
 Call rstProjSoum.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
1 Else
 Call rstProjSoum.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
 End If
...
1  If rstOuvert.Fields("Ouvert") = True Then
...
3  Call CalculerPrixReception

 If m_eType = TYPE_PROJET Then
Call rstProjSoum.Open("SELECT PrixRéception FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
4 woups"frmProjSoumMec", "cmbProjSoum_Click", Err, Erl, txtNoProjSoum.Text)
End Sub
...
1  m_sTauxUniteMobile = "0"
 ...
 m_sTempsCoupe = rstProjSoum.Fields("TempsCoupe")
 Else
 m_sTempsCoupe = "0"
End If

 If Not IsNull(rstProjSoum.Fields("TempsMachinage")) Then
 m_sTempsMachinage = rstProjSoum.Fields("TempsMachinage")
 Else
 m_sTempsMachinage = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsSoudure")) Then
 m_sTempsSoudure = rstProjSoum.Fields("TempsSoudure")
 Else
 m_sTempsSoudure = "0"
 End If
 ...
 m_sTempsPeinture = rstProjSoum.Fields("TempsPeinture")
 Else
 m_sTempsPeinture = "0"
4 End If
...
End If
 ...
 m_bTempsProjLock = rstProjSoum.Fields("TempsProjBarré")
 
 If Not IsNull(rstProjSoum.Fields("TempsDessinProj")) Then
 m_sTempsDessinProj = rstProjSoum.Fields("TempsDessinProj")
5  Else
5  m_sTempsDessinProj = "0"
5  End If

5  If Not IsNull(rstProjSoum.Fields("TempsCoupeProj")) Then
5  m_sTempsCoupeProj = rstProjSoum.Fields("TempsCoupeProj")
5  Else
5  m_sTempsCoupeProj = "0"
5  End If

60 If Not IsNull(rstProjSoum.Fields("TempsMachinageProj")) Then
  m_sTempsMachinageProj = rstProjSoum.Fields("TempsMachinageProj")
  Else
  m_sTempsMachinageProj = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsSoudureProj")) Then
  m_sTempsSoudureProj = rstProjSoum.Fields("TempsSoudureProj")
  Else
  m_sTempsSoudureProj = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsAssemblageProj")) Then
  m_sTempsAssemblageProj = rstProjSoum.Fields("TempsAssemblageProj")
6  Else
6  m_sTempsAssemblageProj = "0"
6  End If

6  If Not IsNull(rstProjSoum.Fields("TempsPeintureProj")) Then
6  m_sTempsPeintureProj = rstProjSoum.Fields("TempsPeintureProj")
6  Else
6  m_sTempsPeintureProj = "0"
6  End If

70 If Not IsNull(rstProjSoum.Fields("TempsTestProj")) Then
  m_sTempsTestProj = rstProjSoum.Fields("TempsTestProj")
  Else
  m_sTempsTestProj = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsInstallationProj")) Then
  m_sTempsInstallationProj = rstProjSoum.Fields("TempsInstallationProj")
  Else
  m_sTempsInstallationProj = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsFormationProj")) Then
  m_sTempsFormationProj = rstProjSoum.Fields("TempsFormationProj")
   Else
   m_sTempsFormationProj = "0"
7  End If

7  If Not IsNull(rstProjSoum.Fields("TempsGestionProj")) Then
7  m_sTempsGestionProj = rstProjSoum.Fields("TempsGestionProj")
7  Else
7  m_sTempsGestionProj = "0"
7  End If

80 If Not IsNull(rstProjSoum.Fields("TempsShippingProj")) Then
  m_sTempsShippingProj = rstProjSoum.Fields("TempsShippingProj")
  Else
  m_sTempsShippingProj = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsDessinConc")) Then
  m_sTempsDessinConc = rstProjSoum.Fields("TempsDessinConc")
  Else
  m_sTempsDessinConc = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsCoupeConc")) Then
  m_sTempsCoupeConc = rstProjSoum.Fields("TempsCoupeConc")
   Else
   m_sTempsCoupeConc = "0"
   End If

   If Not IsNull(rstProjSoum.Fields("TempsMachinageConc")) Then
8  m_sTempsMachinageConc = rstProjSoum.Fields("TempsMachinageConc")
8  Else
8  m_sTempsMachinageConc = "0"
8  End If

90 If Not IsNull(rstProjSoum.Fields("TempsSoudureConc")) Then
  m_sTempsSoudureConc = rstProjSoum.Fields("TempsSoudureConc")
  Else
  m_sTempsSoudureConc = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsAssemblageConc")) Then
  m_sTempsAssemblageConc = rstProjSoum.Fields("TempsAssemblageConc")
  Else
  m_sTempsAssemblageConc = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsPeintureConc")) Then
  m_sTempsPeintureConc = rstProjSoum.Fields("TempsPeintureConc")
 Else
   m_sTempsPeintureConc = "0"
 End If

   If Not IsNull(rstProjSoum.Fields("TempsTestConc")) Then
 m_sTempsTestConc = rstProjSoum.Fields("TempsTestConc")
   Else
 m_sTempsTestConc = "0"
9  End If

 If Not IsNull(rstProjSoum.Fields("TempsInstallationConc")) Then
 m_sTempsInstallationConc = rstProjSoum.Fields("TempsInstallationConc")
1 Else
 m_sTempsInstallationConc = "0"
 End If

1 If Not IsNull(rstProjSoum.Fields("TempsFormationConc")) Then
 m_sTempsFormationConc = rstProjSoum.Fields("TempsFormationConc")
1 Else
 m_sTempsFormationConc = "0"
1 End If

 If Not IsNull(rstProjSoum.Fields("TempsGestionConc")) Then
 m_sTempsGestionConc = rstProjSoum.Fields("TempsGestionConc")
10  Else
10  m_sTempsGestionConc = "0"
10  End If

10  If Not IsNull(rstProjSoum.Fields("TempsShippingConc")) Then
10  m_sTempsShippingConc = rstProjSoum.Fields("TempsShippingConc")
10  Else
10  m_sTempsShippingConc = "0"
10  End If
110 End If

11 If m_eType = TYPE_PROJET Then
1 m_sNbrePersonne = "0"
1 m_sTempsHebergement = "0"
1 m_sTempsRepas = "0"
1 m_sTempsTransport = "0"
1 m_sTempsUniteMobile = "0"
1 Else
1 If Not IsNull(rstProjSoum.Fields("NbrePersonne")) Then
1 m_sNbrePersonne = rstProjSoum.Fields("NbrePersonne")
1 Else
1 m_sNbrePersonne = "0"
1 End If
 
1 If Not IsNull(rstProjSoum.Fields("TempsHebergement")) Then
...
11  m_sTempsRepas = rstProjSoum.Fields("TempsRepas")
 Else
 m_sTempsRepas = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TempsTransport")) Then
1 m_sTempsTransport = rstProjSoum.Fields("TempsTransport")
1 Else
1 m_sTempsTransport = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TempsUniteMobile")) Then
1 m_sTempsUniteMobile = rstProjSoum.Fields("TempsUniteMobile")
1 Else
1 m_sTempsUniteMobile = "0"
1 End If
1 End If

12  m_sPrixEmballage = rstProjSoum.Fields("PrixEmballage")

1 If Not IsNull(rstProjSoum.Fields("TauxDessin")) Then
1 m_sTauxDessin = rstProjSoum.Fields("TauxDessin")
1 Else
1 m_sTauxDessin = "0"
1 End If

130 If Not IsNull(rstProjSoum.Fields("TauxCoupe")) Then
13 m_sTauxCoupe = rstProjSoum.Fields("TauxCoupe")
1 Else
1 m_sTauxCoupe = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TauxMachinage")) Then
1 m_sTauxMachinage = rstProjSoum.Fields("TauxMachinage")
1 Else
1 m_sTauxMachinage = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TauxSoudure")) Then
1 m_sTauxSoudure = rstProjSoum.Fields("TauxSoudure")
13  Else
1 m_sTauxSoudure = "0"
13  End If

1 If Not IsNull(rstProjSoum.Fields("TauxAssemblage")) Then
1 m_sTauxAssemblage = rstProjSoum.Fields("TauxAssemblage")
1 Else
1 m_sTauxAssemblage = "0"
1 End If

140 If Not IsNull(rstProjSoum.Fields("TauxPeinture")) Then
14 m_sTauxPeinture = rstProjSoum.Fields("TauxPeinture")
14 Else
14 m_sTauxPeinture = "0"
14 End If

14 If Not IsNull(rstProjSoum.Fields("TauxTest")) Then
14 m_sTauxTest = rstProjSoum.Fields("TauxTest")
14 Else
14 m_sTauxTest = "0"
14 End If

14 If Not IsNull(rstProjSoum.Fields("TauxInstallation")) Then
14 m_sTauxInstallation = rstProjSoum.Fields("TauxInstallation")
14  Else
14  m_sTauxInstallation = "0"
14  End If

14  If Not IsNull(rstProjSoum.Fields("TauxFormation")) Then
14  m_sTauxFormation = rstProjSoum.Fields("TauxFormation")
14  Else
14  m_sTauxFormation = "0"
14  End If

150 If Not IsNull(rstProjSoum.Fields("TauxGestion")) Then
15 m_sTauxGestion = rstProjSoum.Fields("TauxGestion")
 Else
 m_sTauxGestion = "0"
 End If
 ...
 If m_eType = TYPE_PROJET Then
 m_sTauxHebergement1 = "0"
15  m_sTauxHebergement2 = "0"
15  m_sTauxRepas = "0"
15  m_sTauxTransport = "0"
15  m_sTauxUniteMobile = "0"
15  Else
15  If Not IsNull(rstProjSoum.Fields("TauxHebergement1")) Then
15  m_sTauxHebergement1 = rstProjSoum.Fields("TauxHebergement1")
15  Else
160 m_sTauxHebergement1 = "0"
1  End If

 If Not IsNull(rstProjSoum.Fields("TauxHebergement2")) Then
 m_sTauxHebergement2 = rstProjSoum.Fields("TauxHebergement2")
 Else
 m_sTauxHebergement2 = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TauxRepas")) Then
 m_sTauxRepas = rstProjSoum.Fields("TauxRepas")
 Else
 m_sTauxRepas = "0"
 End If

16  If Not IsNull(rstProjSoum.Fields("TauxTransport")) Then
16  m_sTauxTransport = rstProjSoum.Fields("TauxTransport")
16  Else
16  m_sTauxTransport = "0"
16  End If

16  If Not IsNull(rstProjSoum.Fields("TauxUniteMobile")) Then
16  m_sTauxUniteMobile = rstProjSoum.Fields("TauxUniteMobile")
16  Else
170 m_sTauxUniteMobile = "0"
 End If
 End If
...
1  wOups "frmProjSoumMec", "InitialiserTempsTaux", Err, Err.number, Err.Description
End Sub
...
Do While Not rstPunch.EOF
 ...
 Case "Coupe": m_sTempsCoupe = Round(rstPunch.Fields("Total"), 2)
 Case "Machinage": m_sTempsMachinage = Round(rstPunch.Fields("Total"), 2)
 Case "Soudure": m_sTempsSoudure = Round(rstPunch.Fields("Total"), 2)
 Case "Assemblage": m_sTempsAssemblage = Round(rstPunch.Fields("Total"), 2)
 Case "Peinture": m_sTempsPeinture = Round(rstPunch.Fields("Total"), 2)
 Case "Test": m_sTempsTest = Round(rstPunch.Fields("Total"), 2)
...
1  Case "Gestion": m_sTempsGestion = Round(rstPunch.Fields("Total"), 2)
...
wOups "frmChoixDateImpressionFacturation", "RemplirTempsReelsElec", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmbProjSoum_KeyUp", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdAjouterSection_Click()
 ...
 Call OuvrirForm(frmSoumissionSectionMec, True)
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdAjouterSection_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdAnglaisFrancais_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub UpdateDescription()
 ...
 Dim rstProjSoum As ADODB.Recordset
 Dim rstPieceMec As ADODB.Recordset

 Set rstProjSoum = New ADODB.Recordset
 Set rstPieceMec = New ADODB.Recordset
 ...
 Do While Not rstProjSoum.EOF
  Call rstPieceMec.Open("SELECT * FROM GrbCatalogueMec WHERE PIECE = '" & rstProjSoum.Fields("NumItem") & "'", g_connData, adOpenDynamic, adLockOptimistic)

  rstProjSoum.Fields("Desc_FR") = rstPieceMec.Fields("DESC_FR")
  rstProjSoum.Fields("Desc_EN") = rstPieceMec.Fields("DESC_EN")

  Call rstProjSoum.Update

  Call rstPieceMec.Close

  Call rstProjSoum.MoveNext
  Loop

  Set rstPieceMec = Nothing
...
wOups "frmProjSoumMec", "UpdateDescription", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdAnnuler_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdAnnulerCommentaire_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdAnnulerDateRequise_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdAnnulerDateRequise_MouseUp", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdExport_Click", Err, Err.number, Err.Description
End Sub
...
Else
 ...
 Call rstPiece.Open("SELECT * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & sNoSoumission & "' And Type = 'M'", g_connData, adOpenDynamic, adLockOptimistic)
End If
...
1  If Not rstImpListePiece.EOF Then
 ...
 rstImpListePiece.Fields("Qté") = CDbl(Replace(rstImpListePiece.Fields("Qté"), ".", ",")) + CDbl(rstPiece.Fields("Qté"))
 ...
 Call rstTemp.Open("SELECT " & sSection & " FROM GrbSoumProjSectionMec WHERE IDSection = " & rstPiece.Fields("IDSection"), g_connData, adOpenDynamic, adLockOptimistic)
 
 Call rstImpListePiece.AddNew
 
 rstImpListePiece("NoLigne") = iCompteurPiece
 rstImpListePiece("IDSoumission") = sNoSoumission
 
 If Not IsNull(rstTemp.Fields(sSection)) Then
 rstImpListePiece.Fields("Section") = rstTemp.Fields(sSection)
 Else
...
4  rstImpListePiece.Fields("SousSection") = sSousSection
4  rstImpListePiece.Fields("NomSousSection") = rstPiece.Fields("SousSection")
4  rstImpListePiece.Fields("IDSection") = rstPiece.Fields("IDSection")
 
4  Call rstImpListePiece.Update
 
50 iCompteurPiece = iCompteurPiece + 1
End If
 
 If bAjouterPiece = True Then
...
5  rstImpListePiece.Fields("manufact") = rstPiece.Fields("manufact")

5  rstImpListePiece.Fields("NomSousSection") = rstPiece.Fields("SousSection")
5  rstImpListePiece.Fields("IDSection") = rstPiece.Fields("IDSection")
 
5  Call rstImpListePiece.Update
 
5  iCompteurPiece = iCompteurPiece + 1
5  End If

5  Call rstImpListePiece.Close
60 End If
 ...
 ''''''''''''''''''''''''''''''''''''''''''''''''''
  ...
  Call rstImpListePiece.Open("SELECT * FROM Grbimpression_Listepiece WHERE IDSoumission = '" & sNoSoumission & "' ORDER BY NoLigne", g_connData, adOpenDynamic, adLockOptimistic)
 
  Set xlsApp = New Excel.Application

  Set xlsWorkBook = xlsApp.Workbooks.Add

  xlsApp.range("A1") = "Liste de matériel ( " & txtNoProjSoum.Text & " ) "
...
6  Call xlsApp.range("A1:D1").Merge
 
6  xlsApp.range("A4") = "Qté"
6  xlsApp.range("A4").Font.Bold = True
6  xlsApp.range("A4").HorizontalAlignment = xlCenter

6  xlsApp.range("B4") = "No. Item"
6  xlsApp.range("B4").Font.Bold = True
6  xlsApp.range("B4").HorizontalAlignment = xlCenter

6  xlsApp.range("C4") = "Description"
70 xlsApp.range("C4").Font.Bold = True
70 xlsApp.range("C4").HorizontalAlignment = xlCenter

  xlsApp.range("D4") = "Manufacturier"
  xlsApp.range("D4").Font.Bold = True
  xlsApp.range("D4").HorizontalAlignment = xlCenter

  xlsApp.range("A4:D4").Borders(xlEdgeBottom).LineStyle = xlContinuous
  xlsApp.range("A4:D4").Borders(xlEdgeBottom).Weight = xlMedium
  xlsApp.range("A4:D4").Borders(xlEdgeBottom).ColorIndex = xlAutomatic

  xlsApp.range("A4:D4").Borders(xlInsideVertical).LineStyle = xlContinuous
  xlsApp.range("A4:D4").Borders(xlInsideVertical).Weight = xlMedium
  xlsApp.range("A4:D4").Borders(xlInsideVertical).ColorIndex = xlAutomatic
...
7  If IsNull(rstImpListePiece.Fields("Section")) Then
7  xlsApp.range("B" & iCompteur) = rstImpListePiece.Fields("NumItem")
7  Else
7  xlsApp.range("B" & iCompteur) = rstImpListePiece.Fields("Section")
7  xlsApp.range("B" & iCompteur).Font.Bold = True
7  End If

80 If IsNull(rstImpListePiece.Fields("SousSection")) Then
  xlsApp.range("C" & iCompteur) = rstImpListePiece.Fields("Description")
  Else
  xlsApp.range("C" & iCompteur) = rstImpListePiece.Fields("SousSection")
  xlsApp.range("C" & iCompteur).Font.Bold = True
  End If

  xlsApp.range("D" & iCompteur) = rstImpListePiece.Fields("Manufact")

  xlsApp.range("A" & iCompteur & ":D" & iCompteur).Borders(xlEdgeBottom).LineStyle = xlContinuous
  xlsApp.range("A" & iCompteur & ":D" & iCompteur).Borders(xlEdgeBottom).Weight = xlThin
  xlsApp.range("A" & iCompteur & ":D" & iCompteur).Borders(xlEdgeBottom).ColorIndex = xlAutomatic

  xlsApp.range("A" & iCompteur & ":D" & iCompteur).Borders(xlInsideVertical).LineStyle = xlContinuous
  xlsApp.range("A" & iCompteur & ":D" & iCompteur).Borders(xlInsideVertical).Weight = xlThin
   xlsApp.range("A" & iCompteur & ":D" & iCompteur).Borders(xlInsideVertical).ColorIndex = xlAutomatic
...
8  iCompteur = iCompteur - 1

8  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeBottom).LineStyle = xlContinuous
8  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeBottom).Weight = xlMedium
8  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeBottom).ColorIndex = xlAutomatic

90 xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeTop).LineStyle = xlContinuous
90 xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeTop).Weight = xlMedium
  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeTop).ColorIndex = xlAutomatic

  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeLeft).LineStyle = xlContinuous
  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeLeft).Weight = xlMedium
  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeLeft).ColorIndex = xlAutomatic

  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeRight).LineStyle = xlContinuous
  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeRight).Weight = xlMedium
  xlsApp.range("A4:D" & iCompteur).Borders(xlEdgeRight).ColorIndex = xlAutomatic

  Call xlsApp.Columns("A:A").EntireColumn.AutoFit
  Call xlsApp.Columns("B:B").EntireColumn.AutoFit
  Call xlsApp.Columns("C:C").EntireColumn.AutoFit
 Call xlsApp.Columns("D:D").EntireColumn.AutoFit
 ...
 sSaveAsFileName = xlsApp.GetSaveAsFilename(txtNoProjSoum.Text & ".xls", "Fichiers Excel (*.xlx), *.xls")
   ...
   If sSaveAsFileName <> "Faux" Then
 Call xlsWorkBook.SaveAs(sSaveAsFileName)
9  End If

 xlsWorkBook.Saved = True
 
100 Call xlsWorkBook.Close

10 Set xlsWorkBook = Nothing

10 Call xlsApp.Quit

Set xlsApp = Nothing

10 Set rstTemp = Nothing

Exit Sub

Oups:

10 wOups "frmProjSoumMec", "ExporterListePieces", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdOKCommentaire_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdOKDateRequise_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdOKDateRequise_MouseUp", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdAnnulerFRS_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdAnnulerPrix_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdBavards_Click", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "cmdBonCommande_Click", Err, Err.number, Err.Description
End Sub
...
Public Sub Commande()
 ...
 Dim sDateRequise As String
  ...
  Call rstProjet.Open("SELECT ProchaineCommande FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
Do While Not rstBCPiece.EOF
 ...
 sWhere = sWhere & " AND ((NumItem = '" & Replace(rstBCPiece.Fields("NoItem"), "'", "''") & "' AND NuméroLigne = " & rstBCPiece.Fields("NuméroLigne") & ")"
 Else
 Do While InStr(1, sNoLigne, ",") > 0
 If bPremier = True Then
 sWhere = sWhere & " AND ((NumItem = '" & Replace(rstBCPiece.Fields("NoItem"), "'", "''") & "' AND NuméroLigne = " & Left$(sNoLigne, InStr(1, sNoLigne, ",") - 1) & ")"

 bPremier = False
 Else
 sWhere = sWhere & " OR (NumItem = '" & Replace(rstBCPiece.Fields("NoItem"), "'", "''") & "' AND NuméroLigne = " & Left$(sNoLigne, InStr(1, sNoLigne, ",") - 1) & ")"
 End If
 ...
 sWhere = sWhere & " OR (NumItem = '" & Replace(rstBCPiece.Fields("NoItem"), "'", "''") & "' AND NuméroLigne = " & sNoLigne & ")"
 End If
 End If
 Else
 If InStr(1, sNoLigne, ",") = 0 Then
 sWhere = sWhere & " OR (NumItem = '" & Replace(rstBCPiece.Fields("NoItem"), "'", "''") & "' AND NuméroLigne = " & rstBCPiece.Fields("NuméroLigne") & ")"
 Else
 Do While InStr(1, sNoLigne, ",") > 0
 sWhere = sWhere & " OR (NumItem = '" & Replace(rstBCPiece.Fields("NoItem"), "'", "''") & "' AND NuméroLigne = " & Left$(sNoLigne, InStr(1, sNoLigne, ",") - 1) & ")"
...
4 Set rstPiece = New ADODB.Recordset
 
4 Call rstPiece.Open("SELECT * FROM GrbProjet_Pieces WHERE " & sWhere, g_connData, adOpenDynamic, adLockOptimistic)
...
4 rstPiece.Fields("NomCommande") = g_sEmploye

4 rstPiece.Fields("NoSéquentiel") = Right$(sNoBC, 3)
...
4  Call RemplirListViewProjSoum(txtNoProjSoum.Text)

4  Exit Sub

Oups:

4  wOups "frmProjSoumMec", "Commande", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdCatalogue_Click()
 ...
 Call FrmCatalogueMec.AfficherForm(cmbPieces.Text, "", "")
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdCatalogue_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdMauvaisPrix_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub MauvaisPrix()
 ...
 For iCompteur = 0 To cmbfrs.ListCount - 1
  ...
  fraPrix.Tag = lvwSoumission.SelectedItem.Index
...
wOups "frmProjSoumMec", "MauvaisPrix", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdMaterielInutile_Click", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "MaterielInutile", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdCopier_Click()
 ...
 If ValiderFormatMecanique(sNoProjSoum) = False Then
 bNoValide = False
 End If
 End If
...
6  wOups "frmProjSoumMec", "cmdCopier_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub UpdateOrdre()
 ...
 'Si ce n'est pas une section
  ...
  Call rstOrdre.Open("SELECT Ordre FROM GrbSoumProjSectionMec WHERE IDSection = " & lvwSoumission.ListItems(iCompteur).Tag, g_connData, adOpenDynamic, adLockOptimistic)
...
Call rstCount.Open("SELECT COUNT(IDSection) as NbreSection FROM GrbSoumProjSectionMec", g_connData, adOpenDynamic, adLockOptimistic)
...
1  Do While iCompteur2 <= lvwSoumission.ListItems.count
 ...
 Call rstSection.Open("SELECT " & sSection & " FROM GrbSoumProjSectionMec WHERE IDSection = " & lvwSoumission.ListItems(iCompteur2 + 1).Tag, g_connData, adOpenDynamic, adLockOptimistic)
...
4 itmProjSoum.ListSubItems(I_COL_SOUM_PRIX_NET).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_PRIX_LIST).Bold
...
4  itmProjSoum.SubItems(I_COL_SOUM_PROFIT) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_PROFIT)

4  itmProjSoum.ListSubItems(I_COL_SOUM_PROFIT).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_PROFIT).ForeColor

4  itmProjSoum.ListSubItems(I_COL_SOUM_PROFIT).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_PROFIT).Bold

4  itmProjSoum.ListSubItems(I_COL_SOUM_PROFIT).Tag = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_PROFIT).Tag
 
4  itmProjSoum.SubItems(I_COL_SOUM_DISTRIB) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_DISTRIB)
4  itmProjSoum.ListSubItems(I_COL_SOUM_DISTRIB).Tag = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_DISTRIB).Tag

50 itmProjSoum.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_DISTRIB).ForeColor
 ...
 If Trim$(lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_COMMENTAIRE)) <> "" Then

 itmProjSoum.SubItems(I_COL_SOUM_COMMENTAIRE) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_COMMENTAIRE)
 itmProjSoum.ListSubItems(I_COL_SOUM_COMMENTAIRE).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_COMMENTAIRE).ForeColor

 itmProjSoum.ListSubItems(I_COL_SOUM_COMMENTAIRE).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_COMMENTAIRE).Bold
 Else
 itmProjSoum.SubItems(I_COL_SOUM_COMMENTAIRE) = ""
 End If
 
 If m_eType = TYPE_PROJET Then
 If itmProjSoum.SubItems(I_COL_SOUM_PIECE) <> "" And itmProjSoum.SubItems(I_COL_SOUM_PIECE) <> "Texte" And itmProjSoum.SubItems(I_COL_SOUM_PIECE) <> "Text" Then
 itmProjSoum.SubItems(I_COL_SOUM_FACTURATION) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_FACTURATION)

5  If lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_FACTURATION) = "" Then
5  lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_FACTURATION) = " "
5  End If

5  itmProjSoum.SubItems(I_COL_SOUM_FACTURATION) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_FACTURATION)

5  itmProjSoum.ListSubItems(I_COL_SOUM_FACTURATION).Tag = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_FACTURATION).Tag

5  itmProjSoum.SubItems(I_COL_SOUM_DATE_COMMANDE) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_DATE_COMMANDE)

5  If itmProjSoum.SubItems(I_COL_SOUM_DATE_COMMANDE) <> "" Then
5  itmProjSoum.ListSubItems(I_COL_SOUM_DATE_COMMANDE).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_DATE_COMMANDE).ForeColor
60 itmProjSoum.ListSubItems(I_COL_SOUM_DATE_COMMANDE).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_DATE_COMMANDE).Bold
  itmProjSoum.ListSubItems(I_COL_SOUM_DATE_COMMANDE).Tag = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_DATE_COMMANDE).Tag
  End If

  itmProjSoum.SubItems(I_COL_SOUM_DATE_REQUISE) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_DATE_REQUISE)

  If itmProjSoum.SubItems(I_COL_SOUM_DATE_REQUISE) <> "" Then
  itmProjSoum.ListSubItems(I_COL_SOUM_DATE_REQUISE).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_DATE_REQUISE).ForeColor
  itmProjSoum.ListSubItems(I_COL_SOUM_DATE_REQUISE).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_DATE_REQUISE).Bold
  End If

  itmProjSoum.SubItems(I_COL_SOUM_NOM_COMMANDE) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_NOM_COMMANDE)

  itmProjSoum.ListSubItems(I_COL_SOUM_NOM_COMMANDE).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_NOM_COMMANDE).ForeColor

  itmProjSoum.ListSubItems(I_COL_SOUM_NOM_COMMANDE).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_NOM_COMMANDE).Bold

  itmProjSoum.SubItems(I_COL_SOUM_NO_SEQUENTIEL) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_NO_SEQUENTIEL)

6  itmProjSoum.ListSubItems(I_COL_SOUM_NO_SEQUENTIEL).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_NO_SEQUENTIEL).ForeColor

6  itmProjSoum.ListSubItems(I_COL_SOUM_NO_SEQUENTIEL).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_NO_SEQUENTIEL).Bold

6  itmProjSoum.SubItems(I_COL_SOUM_PROVENANCE) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUM_PROVENANCE)

6  itmProjSoum.ListSubItems(I_COL_SOUM_PROVENANCE).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_PROVENANCE).ForeColor

6  itmProjSoum.ListSubItems(I_COL_SOUM_PROVENANCE).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUM_PROVENANCE).Bold
6  End If
6  Else
6  If itmProjSoum.SubItems(I_COL_SOUM_PIECE) <> "" And itmProjSoum.SubItems(I_COL_SOUM_PIECE) <> "Texte" And itmProjSoum.SubItems(I_COL_SOUM_PIECE) <> "Text" Then
70 itmProjSoum.SubItems(I_COL_SOUMISSION_PROV) = lvwSoumission.ListItems(iIndexCopie).SubItems(I_COL_SOUMISSION_PROV)
 
  If itmProjSoum.SubItems(I_COL_SOUMISSION_PROV) = vbNullString Then
  itmProjSoum.SubItems(I_COL_SOUMISSION_PROV) = " "
  End If
 
  itmProjSoum.ListSubItems(I_COL_SOUMISSION_PROV).ForeColor = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUMISSION_PROV).ForeColor

  itmProjSoum.ListSubItems(I_COL_SOUMISSION_PROV).Bold = lvwSoumission.ListItems(iIndexCopie).ListSubItems(I_COL_SOUMISSION_PROV).Bold
  End If
  End If
...
7  wOups "frmProjSoumMec", "UpdateOrdre", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "BackupPieces", Err, Err.number, Err.Description
End Function
...
Private Sub UpdatePieces()
 ...
 'Si ce n'est pas une sous-section
  ...
  If itmPiece.SubItems(I_COL_SOUM_DISTRIB) <> vbNullString Then
...
1  End If
 ...
 itmPiece.SubItems(I_COL_SOUM_TOTAL) = Conversion(CStr(Round(Replace(itmPiece.Text, "*", "") * itmPiece.SubItems(I_COL_SOUM_PRIX_NET) * CSng(m_sProfit), 2)), MODE_ARGENT)
 
 'Pour le profit, c'est le prix total - (prix net * quantité)
 itmPiece.SubItems(I_COL_SOUM_PROFIT) = Conversion(CStr(Round(itmPiece.SubItems(I_COL_SOUM_TOTAL) - (itmPiece.SubItems(I_COL_SOUM_PRIX_NET) * Replace(itmPiece.Text, "*", "")), 2)), MODE_ARGENT)
 ...
 End If
 Else
 Call MsgBox("Il n'y a pas de prix du fournisseur " & itmPiece.SubItems(I_COL_SOUM_DISTRIB) & " pour la pièce " & itmPiece.SubItems(I_COL_SOUM_PIECE) & " ou la pièce n'existe plus!", vbOKOnly, "Erreur")
 End If
...
wOups "frmProjSoumMec", "UpdatePieces", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdCreerProjet_Click()
 ...
 Call MsgBox("Impossible de créer un projet à partir de cette soumission!", vbOKOnly, "Erreur")
  ...
  If rstProjSoum.Fields("Ouvert") = False Then
  Call MsgBox("Cette soumission est fermée!", vbOKOnly)
  Else
 Call MsgBox("Cette soumission est verrouillée!", vbOKOnly)
End If
 ...
 If sNoProjet <> vbNullString Then
 Screen.MousePointer = vbHourglass
 ...
 If bNoValide = True Then
 If ValiderFormatMecanique(sNoProjet) = False Then
 bNoValide = False
 End If
1  End If
...
50 Exit Sub
 ...
 Call frmChoixTransfertJob.Afficher(txtNoProjSoum.Text, "M")
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdCreerProjet_Click", Err, Err.number, Err.Description
End Sub
...
Private Function VerifierSiDejaProjet() As Boolean
 ...
 Call rstProjet.Open("SELECT * FROM GrbProjetMec WHERE IDSoumission = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
Oups:
  ...
  wOups "frmProjSoumMec", "VerifierSiDejaProjet", Err, Err.number, Err.Description
End Function
...
Private Sub TransfererSoumDansProjet(ByVal sNoProjet As String, ByVal sLiaison As String)
 ...
 'Ouverture de la soumission
  Call rstSoum.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
  Call rstSoumPiece.Open("SELECT * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & txtNoProjSoum.Text & "' AND Type = 'M' ORDER BY NuméroLigne", g_connData, adOpenDynamic, adLockOptimistic)
 
  Set rstProjet = New ADODB.Recordset
  Set rstProjetPiece = New ADODB.Recordset
 
 'Ouverture du projet
  Call rstProjet.Open("SELECT * FROM GrbProjetMec", g_connData, adOpenDynamic, adLockOptimistic)
...
10 If rstProjSoum.EOF Then
1 Call rstProjSoum.AddNew
...
1  rstProjSoum.Fields("Ouvert") = False
...
rstProjet.Fields("IDProjet") = sNoProjet
 rstProjet.Fields("IDSoumission") = rstSoum.Fields("IDSoumission")
1  rstProjet.Fields("IDClient") = rstSoum.Fields("IDClient")
 rstProjet.Fields("IDContact") = rstSoum.Fields("IDContact")
 rstProjet.Fields("Description") = rstSoum.Fields("Description")
rstProjet.Fields("manuel") = rstSoum.Fields("manuel")
...
2  Set rstEmploye = Nothing
 
rstProjet.Fields("imprevue") = rstSoum.Fields("imprevue")
2  rstProjet.Fields("commission") = rstSoum.Fields("commission")
rstProjet.Fields("Profit") = rstSoum.Fields("Profit")
2  rstProjet.Fields("total_manuel") = rstSoum.Fields("total_manuel")
rstProjet.Fields("total_commission") = rstSoum.Fields("total_Commission")
2  rstProjet.Fields("total_profit") = rstSoum.Fields("Total_Profit")
rstProjet.Fields("PrixTotal") = rstSoum.Fields("PrixTotal")
30 rstProjet.Fields("total_piece") = rstSoum.Fields("Total_piece")
rstProjet.Fields("total_imprevue") = rstSoum.Fields("total_imprevue")
rstProjet.Fields("total_temps") = rstSoum.Fields("total_temps")

rstProjet.Fields("TempsDessinProj") = rstSoum.Fields("TempsDessin")
rstProjet.Fields("TempsCoupeProj") = rstSoum.Fields("TempsCoupe")
rstProjet.Fields("TempsMachinageProj") = rstSoum.Fields("TempsMachinage")
rstProjet.Fields("TempsSoudureProj") = rstSoum.Fields("TempsSoudure")
rstProjet.Fields("TempsAssemblageProj") = rstSoum.Fields("TempsAssemblage")
rstProjet.Fields("TempsPeintureProj") = rstSoum.Fields("TempsPeinture")
rstProjet.Fields("TempsTestProj") = rstSoum.Fields("TempsTest")
rstProjet.Fields("TempsInstallationProj") = 0
rstProjet.Fields("TempsFormationProj") = rstSoum.Fields("TempsFormation")
3  rstProjet.Fields("TempsGestionProj") = rstSoum.Fields("TempsGestion")
rstProjet.Fields("TempsShippingProj") = rstSoum.Fields("TempsShipping")

3  rstProjet.Fields("TempsDessinConc") = vbNullString
rstProjet.Fields("TempsCoupeConc") = vbNullString
3  rstProjet.Fields("TempsMachinageConc") = vbNullString
rstProjet.Fields("TempsSoudureConc") = vbNullString
3  rstProjet.Fields("TempsAssemblageConc") = vbNullString
 rstProjet.Fields("TempsPeintureConc") = vbNullString
40 rstProjet.Fields("TempsTestConc") = vbNullString
rstProjet.Fields("TempsInstallationConc") = vbNullString
4 rstProjet.Fields("TempsFormationConc") = vbNullString
4 rstProjet.Fields("TempsGestionConc") = vbNullString
4 rstProjet.Fields("TempsShippingConc") = vbNullString

4 rstProjet.Fields("PrixEmballage") = rstSoum.Fields("PrixEmballage")

4 Set rstConfig = New ADODB.Recordset

4 If Not IsNull(rstSoum.Fields("TauxDessin")) Then
4 rstProjet.Fields("TauxDessin") = rstSoum.Fields("TauxDessin")
4 Else
4 Call rstConfig.Open("SELECT TauxDessinMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

4 rstProjet.Fields("TauxDessin") = rstConfig.Fields("TauxDessinMec")

4  Call rstConfig.Close
4  End If

4  If Not IsNull(rstSoum.Fields("TauxCoupe")) Then
4  rstProjet.Fields("TauxCoupe") = rstSoum.Fields("TauxCoupe")
4  Else
4  Call rstConfig.Open("SELECT TauxCoupe FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

4  rstProjet.Fields("TauxCoupe") = rstConfig.Fields("TauxCoupe")

4  Call rstConfig.Close
50 End If

50 If Not IsNull(rstSoum.Fields("TauxMachinage")) Then
 rstProjet.Fields("TauxMachinage") = rstSoum.Fields("TauxMachinage")
 Else
 Call rstConfig.Open("SELECT TauxMachinage FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

 rstProjet.Fields("TauxMachinage") = rstConfig.Fields("TauxMachinage")

 Call rstConfig.Close
 End If

 If Not IsNull(rstSoum.Fields("TauxSoudure")) Then
 rstProjet.Fields("TauxSoudure") = rstSoum.Fields("TauxSoudure")
 Else
 Call rstConfig.Open("SELECT TauxSoudure FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

5  rstProjet.Fields("TauxSoudure") = rstConfig.Fields("TauxSoudure")

5  Call rstConfig.Close
5  End If

5  If Not IsNull(rstSoum.Fields("TauxAssemblage")) Then
5  rstProjet.Fields("TauxAssemblage") = rstSoum.Fields("TauxAssemblage")
5  Else
5  Call rstConfig.Open("SELECT TauxAssemblageMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

5  rstProjet.Fields("TauxAssemblage") = rstConfig.Fields("TauxAssemblageMec")

60 Call rstConfig.Close
60 End If

  If Not IsNull(rstSoum.Fields("TauxPeinture")) Then
  rstProjet.Fields("TauxPeinture") = rstSoum.Fields("TauxPeinture")
  Else
  Call rstConfig.Open("SELECT TauxPeinture FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

  rstProjet.Fields("TauxPeinture") = rstConfig.Fields("TauxPeinture")
  ...
  Else
6  Call rstConfig.Open("SELECT TauxTestMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

6  rstProjet.Fields("TauxTest") = rstConfig.Fields("TauxTestMec")
...
6  Else
6  Call rstConfig.Open("SELECT TauxInstallationMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

70 rstProjet.Fields("TauxInstallation") = rstConfig.Fields("TauxInstallationMec")
  ...
  Else
  Call rstConfig.Open("SELECT TauxFormationMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

  rstProjet.Fields("TauxFormation") = rstConfig.Fields("TauxFormationMec")
  ...
  rstProjet.Fields("TauxGestion") = rstSoum.Fields("TauxGestion")
   Else
   Call rstConfig.Open("SELECT TauxGestionProjetsMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

7  rstProjet.Fields("TauxGestion") = rstConfig.Fields("TauxGestionProjetsMec")

7  Call rstConfig.Close
7  End If

7  If Not IsNull(rstSoum.Fields("TauxShipping")) Then
7  rstProjet.Fields("TauxShipping") = rstSoum.Fields("TauxShipping")
7  Else
80 Call rstConfig.Open("SELECT TauxShippingMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

  rstProjet.Fields("TauxShipping") = rstConfig.Fields("TauxShippingMec")
  ...
  rstProjet.Fields("MontantForfait") = rstSoum.Fields("MontantForfait")
...
8  rstProjetPiece.Fields("Desc_FR") = rstSoumPiece.Fields("Desc_FR")
8  rstProjetPiece.Fields("Desc_EN") = rstSoumPiece.Fields("Desc_EN")
8  rstProjetPiece.Fields("Manufact") = rstSoumPiece.Fields("Manufact")
8  rstProjetPiece.Fields("Prix_List") = rstSoumPiece.Fields("Prix_list")
90 rstProjetPiece.Fields("Escompte") = rstSoumPiece.Fields("Escompte")
  rstProjetPiece.Fields("Prix_net") = rstSoumPiece.Fields("Prix_net")
  rstProjetPiece.Fields("OrdreSection") = rstSoumPiece.Fields("OrdreSection")
  rstProjetPiece.Fields("NuméroLigne") = rstSoumPiece.Fields("NuméroLigne")
  rstProjetPiece.Fields("IDFRS") = rstSoumPiece.Fields("IDFRS")
  rstProjetPiece.Fields("Prix_total") = rstSoumPiece.Fields("Prix_Total")
  rstProjetPiece.Fields("Profit_argent") = rstSoumPiece.Fields("Profit_argent")
  rstProjetPiece.Fields("SousSection") = rstSoumPiece.Fields("SousSection")
  rstProjetPiece.Fields("PrixOrigine") = rstSoumPiece.Fields("PrixOrigine")
  rstProjetPiece.Fields("Visible") = rstSoumPiece.Fields("Visible")
  rstProjetPiece.Fields("Commentaire") = rstSoumPiece.Fields("Commentaire")
  rstProjetPiece.Fields("Quoté") = rstSoumPiece.Fields("Quoté")

 rstProjetPiece.Fields("Type") = rstSoumPiece.Fields("Type")
 
   Call rstProjetPiece.Update
 End If
 
   Call rstSoumPiece.MoveNext
 Loop

   m_eType = TYPE_PROJET

 If CDbl(rstSoum.Fields("TempsInstallation")) > 0 Then
9  Call CreerProjetInstallation(Left$(sNoProjet, 7) & "51")
 End If

100 Call rstSoum.Close
10 Set rstSoum = Nothing
 
10 Call rstProjet.Close
Set rstProjet = Nothing
 
10 Call rstSoumPiece.Close
Set rstSoumPiece = Nothing
 
10 Call rstProjetPiece.Close
Set rstProjetPiece = Nothing

10 Call CalculerTotalRecordset(sNoProjet)

Exit Sub

Oups:

10 wOups "frmProjSoumMec", "TransfererSoumDansProjet", Err, Err.number, Err.Description
End Sub
...
1  Set rstEmploye = Nothing
 ...
 rstProjet.Fields("TempsDessinProj") = 0
 rstProjet.Fields("TempsCoupeProj") = 0
rstProjet.Fields("TempsMachinageProj") = 0
 rstProjet.Fields("TempsSoudureProj") = 0
rstProjet.Fields("TempsAssemblageProj") = 0
 rstProjet.Fields("TempsPeintureProj") = 0
rstProjet.Fields("TempsTestProj") = 0
 rstProjet.Fields("TempsInstallationProj") = rstSoum.Fields("TempsInstallation")
rstProjet.Fields("TempsFormationProj") = 0
 rstProjet.Fields("TempsGestionProj") = 0
rstProjet.Fields("TempsShippingProj") = 0

3 rstProjet.Fields("TempsDessinConc") = vbNullString
 rstProjet.Fields("TempsCoupeConc") = vbNullString
 rstProjet.Fields("TempsMachinageConc") = vbNullString
 rstProjet.Fields("TempsSoudureConc") = vbNullString
 rstProjet.Fields("TempsAssemblageConc") = vbNullString
 rstProjet.Fields("TempsPeintureConc") = vbNullString
 rstProjet.Fields("TempsTestConc") = vbNullString
 rstProjet.Fields("TempsInstallationConc") = vbNullString
 rstProjet.Fields("TempsFormationConc") = vbNullString
 rstProjet.Fields("TempsGestionConc") = vbNullString
 rstProjet.Fields("TempsShippingConc") = vbNullString

rstProjet.Fields("PrixEmballage") = 0
...
Else
 Call rstConfig.Open("SELECT TauxDessinMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

 rstProjet.Fields("TauxDessin") = rstConfig.Fields("TauxDessinMec")
...
4 If Not IsNull(rstSoum.Fields("TauxMachinage")) Then
4 rstProjet.Fields("TauxMachinage") = rstSoum.Fields("TauxMachinage")
4 Else
4 Call rstConfig.Open("SELECT TauxMachinage FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

4  rstProjet.Fields("TauxMachinage") = rstConfig.Fields("TauxMachinage")
 
4  Call rstConfig.Close
4  End If

4  If Not IsNull(rstSoum.Fields("TauxSoudure")) Then
4  rstProjet.Fields("TauxSoudure") = rstSoum.Fields("TauxSoudure")
4  Else
4  Call rstConfig.Open("SELECT TauxSoudure FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)
 
4  rstProjet.Fields("TauxSoudure") = rstConfig.Fields("TauxSoudure")
...
5 End If
 ...
 Else
 Call rstConfig.Open("SELECT TauxAssemblageMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

 rstProjet.Fields("TauxAssemblage") = rstConfig.Fields("TauxAssemblageMec")
 ...
 rstProjet.Fields("TauxPeinture") = rstSoum.Fields("TauxPeinture")
 Else
5  Call rstConfig.Open("SELECT TauxPeinture FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

5  rstProjet.Fields("TauxPeinture") = rstConfig.Fields("TauxPeinture")
...
5  Else
5  Call rstConfig.Open("SELECT TauxTestMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

60 rstProjet.Fields("TauxTest") = rstConfig.Fields("TauxTestMec")
  ...
  Else
  Call rstConfig.Open("SELECT TauxInstallationMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

  rstProjet.Fields("TauxInstallation") = rstConfig.Fields("TauxInstallationMec")
  ...
  rstProjet.Fields("TauxFormation") = rstSoum.Fields("TauxFormation")
6  Else
6  Call rstConfig.Open("SELECT TauxFormationMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

6  rstProjet.Fields("TauxFormation") = rstConfig.Fields("TauxFormationMec")

6  Call rstConfig.Close
6  End If

6  If Not IsNull(rstSoum.Fields("TauxGestion")) Then
6  rstProjet.Fields("TauxGestion") = rstSoum.Fields("TauxGestion")
6  Else
70 Call rstConfig.Open("SELECT TauxGestionProjetsMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)

  rstProjet.Fields("TauxGestion") = rstConfig.Fields("TauxGestionProjetsMec")
  ...
  Else
  Call rstConfig.Open("SELECT TauxShippingMec FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)
...
7  Call rstSoum.Close
7  Set rstSoum = Nothing
 
7  Call rstProjet.Close
7  Set rstProjet = Nothing
 
7  Call CalculerTotalRecordset(sNoProjet)

80 Exit Sub

Oups:

80 wOups "frmProjSoumMec", "CreerProjetInstallation", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdDateFacturation_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdDemande_Click()
 ...
 If rstProjSoum.Fields("Ouvert") = True And rstProjSoum.Fields("Verrouillé") = False Then
 If VerifierSiOuvert(sUser) = False Then
  Call frmChoixDemande.AfficherProjetSoumission(txtNoProjSoum.Text, MECANIQUE, MODE_PIECE, m_eType)
  Else
  If m_eType = TYPE_PROJET Then
  Call MsgBox("Ce projet est en modification par " & sUser & "!", vbOKOnly, "Erreur")
  Else
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdDemande_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdHistorique_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdLegende_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdOKFRS_Click", Err, Err.number, Err.Description
End Sub
...
1  End If
 ...
 Set itmAvant = lvwSoumission.SelectedItem
 Set itmSoum = lvwSoumission.ListItems.Add(CInt(fraPrix.Tag) + 1)
...
3 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = itmAvant.SubItems(I_COL_SOUM_PRIX_LIST)
 ...
 Set itmSoum = lvwSoumission.ListItems.Add(CInt(fraPrix.Tag) + 2)
...
4  itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag = Conversion(txtPrixList.Text, MODE_ARGENT, 4)

4  itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).ForeColor = lColor
 
 'Escompte
4  If mskEscompte.Text <> vbNullString Then
4  itmSoum.SubItems(I_COL_SOUM_ESCOMPTE) = Conversion(mskEscompte.Text, MODE_POURCENT)
4  Else
4  itmSoum.SubItems(I_COL_SOUM_ESCOMPTE) = Conversion("0", MODE_POURCENT)
4  End If

50 itmSoum.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor = lColor
...
If optUSA.Value = True Then
 ...
 Else
 itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(txtPrixNet.Text, MODE_ARGENT, 4)
 End If
 End If
...
5  itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(CStr(Round(CDbl(txtPrixSpecial.Text) / CDbl(sTauxUSA), 4)), MODE_ARGENT, 4)
5  Else
5  If optSpain.Value = True Then
5  itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(CStr(Round(CDbl(txtPrixSpecial.Text) / CDbl(sTauxSPA), 4)), MODE_ARGENT, 4)
5  Else
5  itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(txtPrixSpecial.Text, MODE_ARGENT, 4)
60 End If
  End If

  itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag = Conversion(txtPrixSpecial.Text, MODE_ARGENT, 4)
...
6  itmSoum.ListSubItems(I_COL_SOUM_PRIX_NET).Tag = itmAvant.ListSubItems(I_COL_SOUM_PRIX_NET).Tag

6  itmSoum.ListSubItems(I_COL_SOUM_PRIX_NET).ForeColor = lColor
6  End If

 'On met le fournisseur dans la colonne et l'id dans le tag
6  itmSoum.SubItems(I_COL_SOUM_DISTRIB) = cmbfrs.LIST(cmbfrs.ListIndex)
6  itmSoum.ListSubItems(I_COL_SOUM_DISTRIB).Tag = cmbfrs.ItemData(cmbfrs.ListIndex)

70 itmSoum.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = lColor
 
 'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
  itmSoum.SubItems(I_COL_SOUM_TOTAL) = Conversion(CStr(Round(Replace(itmSoum.Text, "*", vbNullString) * itmSoum.SubItems(I_COL_SOUM_PRIX_NET) * CSng(m_sProfit), 2)), MODE_ARGENT)

  itmSoum.ListSubItems(I_COL_SOUM_TOTAL).ForeColor = lColor

  If optUSA.Value = True Then
  itmSoum.ListSubItems(I_COL_SOUM_TOTAL).Tag = "USA"
  Else
  If optSpain.Value = True Then
...
7  itmSoum.SubItems(I_COL_SOUM_COMMENTAIRE) = itmAvant.SubItems(I_COL_SOUM_COMMENTAIRE)
7  itmSoum.ListSubItems(I_COL_SOUM_COMMENTAIRE).ForeColor = lColor

7  If m_eType = TYPE_PROJET Then
7  itmSoum.SubItems(I_COL_SOUM_DATE_COMMANDE) = itmAvant.SubItems(I_COL_SOUM_DATE_COMMANDE)
7  itmSoum.ListSubItems(I_COL_SOUM_DATE_COMMANDE).ForeColor = lColor

7  itmSoum.SubItems(I_COL_SOUM_DATE_REQUISE) = itmAvant.SubItems(I_COL_SOUM_DATE_REQUISE)
80 itmSoum.ListSubItems(I_COL_SOUM_DATE_REQUISE).ForeColor = lColor

  itmSoum.SubItems(I_COL_SOUM_NOM_COMMANDE) = itmAvant.SubItems(I_COL_SOUM_NOM_COMMANDE)
  itmSoum.ListSubItems(I_COL_SOUM_NOM_COMMANDE).ForeColor = lColor

  itmSoum.SubItems(I_COL_SOUM_NO_SEQUENTIEL) = itmAvant.SubItems(I_COL_SOUM_NO_SEQUENTIEL)
  itmSoum.ListSubItems(I_COL_SOUM_NO_SEQUENTIEL).ForeColor = lColor
  ...
  itmSoum.ListSubItems(I_COL_SOUM_FACTURATION).Tag = itmAvant.ListSubItems(I_COL_SOUM_FACTURATION).Tag
  End If
  ...
  If itmAvant.SubItems(I_COL_SOUM_COMMENTAIRE) <> "" Then
   ...
   itmAvant.ListSubItems(I_COL_SOUM_COMMENTAIRE).ForeColor = COLOR_NOIR
   End If

   If m_eType = TYPE_PROJET Then
8  If itmAvant.SubItems(I_COL_SOUM_DATE_COMMANDE) <> "" Then
8  itmAvant.ListSubItems(I_COL_SOUM_DATE_COMMANDE).ForeColor = COLOR_NOIR
8  End If

8  If itmAvant.SubItems(I_COL_SOUM_DATE_REQUISE) <> "" Then
90 itmAvant.ListSubItems(I_COL_SOUM_DATE_REQUISE).ForeColor = COLOR_NOIR
  End If

  If itmAvant.SubItems(I_COL_SOUM_NOM_COMMANDE) <> "" Then
  itmAvant.ListSubItems(I_COL_SOUM_NOM_COMMANDE).ForeColor = COLOR_NOIR
  End If

  If itmAvant.SubItems(I_COL_SOUM_NO_SEQUENTIEL) <> "" Then
  itmAvant.ListSubItems(I_COL_SOUM_NO_SEQUENTIEL).ForeColor = COLOR_NOIR
  End If

  itmAvant.ListSubItems(I_COL_SOUM_FACTURATION).ForeColor = COLOR_NOIR

  If itmAvant.SubItems(I_COL_SOUM_PROVENANCE) <> "" Then
  itmAvant.ListSubItems(I_COL_SOUM_PROVENANCE).ForeColor = COLOR_NOIR
  End If
 End If

   itmSoum.ListSubItems(I_COL_SOUM_DESCR).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_DESCR).ForeColor
 itmSoum.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor
   itmSoum.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor
 itmSoum.ListSubItems(I_COL_SOUM_MANUFACT).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_MANUFACT).ForeColor
   itmSoum.ListSubItems(I_COL_SOUM_PIECE).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_PIECE).ForeColor
 itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_PRIX_LIST).ForeColor
9  itmSoum.ListSubItems(I_COL_SOUM_PRIX_NET).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_PRIX_NET).ForeColor
 itmSoum.ListSubItems(I_COL_SOUM_PROFIT).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_PROFIT).ForeColor
10 itmSoum.ListSubItems(I_COL_SOUM_TOTAL).ForeColor = itmAvant.ListSubItems(I_COL_SOUM_TOTAL).ForeColor

1 itmAvant.ListSubItems(I_COL_SOUM_DESCR).ForeColor = COLOR_NOIR
1 itmAvant.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = COLOR_NOIR
 itmAvant.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor = COLOR_NOIR
1 itmAvant.ListSubItems(I_COL_SOUM_MANUFACT).ForeColor = COLOR_NOIR
 itmAvant.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_NOIR
1 itmAvant.ListSubItems(I_COL_SOUM_PRIX_LIST).ForeColor = COLOR_NOIR
 itmAvant.ListSubItems(I_COL_SOUM_PRIX_NET).ForeColor = COLOR_NOIR
1 itmAvant.ListSubItems(I_COL_SOUM_PROFIT).ForeColor = COLOR_NOIR
 itmAvant.ListSubItems(I_COL_SOUM_TOTAL).ForeColor = COLOR_NOIR
...
10  m_bMauvaisPrix = False

10  cmbfrs.Locked = False

10  Call lvwSoumission.Refresh
109Else
10  sPiece = lvwSoumission.ListItems(CInt(fraPrix.Tag)).SubItems(I_COL_SOUM_PIECE)

110 For iCompteur = 1 To lvwSoumission.ListItems.count
11 If lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_PIECE) = sPiece And lvwSoumission.ListItems(iCompteur).ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_MAGENTA Then
...
1 If optUSA.Value = True Then
 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(CStr(Round(CDbl(txtPrixList.Text) / CDbl(sTauxUSA), 4)), MODE_ARGENT, 4)
11  Else
 If optSpain.Value = True Then
 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(CStr(Round(CDbl(txtPrixList.Text) / CDbl(sTauxSPA), 4)), MODE_ARGENT, 4)
1 Else
1 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(txtPrixList.Text, MODE_ARGENT, 4)
1 End If
1 End If
 
1 itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag = Conversion(txtPrixList.Text, MODE_DECIMAL, 4)
...
1 End If
 ...
 'Prix net
1 If optUSA.Value = True Then
1 itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(CStr(Round(CDbl(txtPrixNet.Text) / CDbl(sTauxUSA), 4)), MODE_ARGENT, 4)
1 Else
1 If optSpain.Value = True Then
1 itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(CStr(Round(CDbl(txtPrixNet.Text) / CDbl(sTauxSPA), 4)), MODE_ARGENT, 4)
1 Else
1 itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(txtPrixNet.Text, MODE_ARGENT, 4)
1 End If
1 End If
1 Else
 'Prix listé
1 If optUSA.Value = True Then
1 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(CStr(Round(CDbl(txtPrixSpecial.Text) / CDbl(sTauxUSA), 4)), MODE_ARGENT, 4)
1 Else
1 If optSpain.Value = True Then
1 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(CStr(Round(CDbl(txtPrixSpecial.Text) / CDbl(sTauxSPA), 4)), MODE_ARGENT, 4)
1 Else
1 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(txtPrixSpecial.Text, MODE_ARGENT, 4)
1 End If
1 End If
 
1 itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag = Conversion(txtPrixSpecial.Text, MODE_DECIMAL, 4)
 
1 itmSoum.SubItems(I_COL_SOUM_ESCOMPTE) = Conversion("0", MODE_POURCENT)
 
 'Prix net
1 If optUSA.Value = True Then
1 itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(CStr(Round(CDbl(txtPrixSpecial.Text), 4)), MODE_ARGENT, 4)
1 Else
1 If optSpain.Value = True Then
1 itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(CStr(Round(CDbl(txtPrixSpecial.Text), 4)), MODE_ARGENT, 4)
1 Else
1 itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(txtPrixSpecial.Text, MODE_ARGENT, 4)
1 End If
14 End If
14 End If
 
 'On met le fournisseur dans la colonne et l'id dans le tag
14 itmSoum.SubItems(I_COL_SOUM_DISTRIB) = cmbfrs.LIST(cmbfrs.ListIndex)
 
14 itmSoum.ListSubItems(I_COL_SOUM_DISTRIB).Tag = cmbfrs.ItemData(cmbfrs.ListIndex)
 
 'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
14 itmSoum.SubItems(I_COL_SOUM_TOTAL) = Conversion(CStr(Round(itmSoum.Text * Conversion(itmSoum.SubItems(I_COL_SOUM_PRIX_NET), MODE_PAS_FORMAT) * CSng(m_sProfit), 2)), MODE_ARGENT)

14 If optUSA.Value = True Then
14 itmSoum.ListSubItems(I_COL_SOUM_TOTAL).Tag = "USA"
14 Else
14 If optSpain.Value = True Then
14 itmSoum.ListSubItems(I_COL_SOUM_TOTAL).Tag = "SPA"
14 Else
14  itmSoum.ListSubItems(I_COL_SOUM_TOTAL).Tag = "CAN"
14  End If
14  End If
 
 'Pour le profit, c'est le prix total - (prix net * quantité)
14  itmSoum.SubItems(I_COL_SOUM_PROFIT) = Conversion(CStr(Round(itmSoum.SubItems(I_COL_SOUM_TOTAL) - (itmSoum.SubItems(I_COL_SOUM_PRIX_NET) * itmSoum.Text), 2)), MODE_ARGENT)
14  End If
14  Next
149End If

14  Call ModifierPrixCatalogue

150 fraPrix.Visible = False

150 Call CalculerPrix

Exit Sub

Oups:

1 wOups "frmProjSoumMec", "cmdOKPrix_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdPhotos_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdReception_Click()
 ...
 Exit For
  ...
  Call FrmReceptionMec.AfficherProjet(g_sUserID, txtNoProjSoum.Text)
...
10 wOups "frmProjSoumMec", "cmdReception_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdRechercherClient_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdRetour_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdBrowse_Click()
 ...
 Call frmChoixDossier.Afficher(Me)
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdBrowse_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdRafraichir_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdRapportFACT_Click()
 ...
 Call rstProjSoum.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "' ORDER BY IDProjet", g_connData, adOpenDynamic, adLockOptimistic)
...
wOups "frmProjSoumMec", "cmdRapportFACT_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdSortieMagasin_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub ChangerQuantite()
 ...
 sQuantite = Replace(InputBox("Quelle est la nouvelle quantité?"), ".", ",")
...
Oups:
  ...
  wOups "frmProjSoumMec", "ChangerQuantite", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "SortieMagasin", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdSupprimerFRS_Click()
 ...
 End If
  ...
  If MsgBox("Voulez-vous vraiment supprimer le fournisseur " & lvwfournisseur.SelectedItem.Text & " pour la pièce " & lvwPieces.SelectedItem.SubItems(I_COL_PIECES_NO_ITEM) & "?", vbYesNo, "Suppression") = vbYes Then
...
wOups "frmProjSoumMec", "cmdSupprimerFRS_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdTemps_Click()
 ...
 If m_eType = TYPE_PROJET Then
 Call frmProjSoumMecTemps.Afficher(txtNoProjSoum.Text, txtNoSoumission.Text, m_eType, m_eMode, False)
 Else
 Call frmProjSoumMecTemps.Afficher("", txtNoProjSoum.Text, m_eType, m_eMode, False)
 End If
 Else
  If m_eType = TYPE_PROJET Then
  Call frmProjSoumMecTemps.Afficher(txtNoProjSoum.Text, txtNoSoumission.Text, m_eType, m_eMode, True)
  Else
  Call frmProjSoumMecTemps.Afficher("", txtNoProjSoum.Text, m_eType, m_eMode, True)
  End If
  End If
  Else
  If m_eType = TYPE_PROJET Then
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdTemps_Click", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "cmdTexte_Click", Err, Err.number, Err.Description
End Sub
...
30 wOups "frmProjSoumMec", "AjouterTexte", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdTri_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "Form_QueryUnload", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "Form_Resize", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "PositionnerBoutons", Err, Err.number, Err.Description
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
 ...
 Set FrmProjSoumMec = Nothing

 Exit Sub

Oups:

 wOups "frmProjSoumMec", "Form_Unload", Err, Err.number, Err.Description
End Sub
...
Private Sub lvwfournisseur_KeyDown(KeyCode As Integer, Shift As Integer)
 ...
 If g_bModificationCatalogueMec = True Then
 'Si c'est pas Choisir ultérieurement
 If lvwfournisseur.SelectedItem.Text <> "CHOISIR ULTÉRIEUREMENT" Then
 If m_bPieceInutile = True Then
 sPiece = lvwSoumission.SelectedItem.SubItems(I_COL_SOUM_PIECE)
...
wOups "frmProjSoumMec", "lvwFournisseur_KeyDown", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "lvwHistorique_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "lvwPieces_ColumnClick", Err, Err.number, Err.Description
End Sub
...
1  If BackupPieces(txtNoProjSoum.Text) = False Then
 If m_eType = TYPE_PROJET Then
...
2  wOups "frmProjSoumMec", "cmdEnregistrer_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub EnregistrerFACT(ByVal sNoProjet As String)
 ...
 Dim sAutre As String
  ...
  Call g_connData.Execute("DELETE * FROM GrbProjet_Modif WHERE IDProjet = '" & sNoProjet & "' AND Type = 'M' AND TypeModif = 'FACTURATION'")
...
sNoFacture = lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_FACTURATION)
 ...
 Call CalculerPrixFacturation(sNoFacture, sCommission, sPrixTotal, sProfit, sTotalPiece, sImprevue, sTotalTemps, sAutre)
 ...
 rstModif.Fields("IDProjet") = txtNoProjSoum.Text

 Set rstEmploye = New ADODB.Recordset

1  Call rstEmploye.Open("SELECT * FROM GrbEmployés WHERE loginname = '" & g_sUserID & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
2  wOups "frmProjSoumMec", "EnregistrerFACT", Err, Err.number, Err.Description
End Sub
...
If m_eType = TYPE_PROJET Then
sTable = "GrbProjetMec"
 sTableModif = "GrbProjet_Modif"
 sTablePiece = "GrbProjet_Pieces"
 sChamps = "IDProjet"
 Else
 sTable = "GrbSoumissionMec"
 sTableModif = "GrbSoumission_Modif"
1  sTablePiece = "GrbSoumission_Pieces"
 sChamps = "IDSoumission"
 End If
...
3 rstProjSoum.Fields("Creer") = ConvertDate(Date)
 ...
 rstOuvert.Fields("Description") = txtDescription.Text
...
4  Set rstModif = Nothing
 
4  Call rstOuvert.Open("SELECT * FROM GrbProjSoum WHERE IDProjSoum = '" & sNoProjSoum & "'", g_connData, adOpenDynamic, adLockOptimistic)

4  If rstOuvert.Fields("NoClient") <> cmbclient.ItemData(cmbclient.ListIndex) Then
50 rstOuvert.Fields("NoClient") = cmbclient.ItemData(cmbclient.ListIndex)
...
5  rstOuvert.Fields("Description") = txtDescription.Text
 
5  Call rstOuvert.Update

5  Call rstOuvert.Close
5  Set rstOuvert = Nothing
 
 'Si c'est une modification, il faut effacer les pieces et remplir les nouvelles
5  Call g_connData.Execute("DELETE * FROM " & sTablePiece & " WHERE " & sChamps & " = '" & sNoProjSoum & "' AND Type = 'M'")

60 If m_eType = TYPE_PROJET Then
  If Right$(sNoProjSoum, 2) >= 60 And Right$(sNoProjSoum, 2) <=   Then
  Call g_connData.Execute("DELETE * FROM GrbProjet_Pieces WHERE IDProjet = '" & Left$(sNoProjSoum, Len(sNoProjSoum) - 3) & "-" & rstProjSoum.Fields("LiaisonChargeable") & "' AND Type = 'M' AND (PieceExtraChargeable = True OR PieceExtraNonChargeable = True) AND Provenance = '" & Right$(txtNoProjSoum.Text, 2) & "'")
  End If
  End If
  End If
 ...
 'Enregistrement de la soumission
  ...
  rstProjSoum.Fields("Description") = txtDescription.Text
  rstProjSoum.Fields("Imprevue") = m_sImprevue
  rstProjSoum.Fields("Commission") = m_sCommission
6  rstProjSoum.Fields("Profit") = m_sProfit
 
6  If IsNumeric(txtNbreManuel.Text) Then
6  rstProjSoum.Fields("Manuel") = txtNbreManuel.Text
6  Else
6  rstProjSoum.Fields("Manuel") = "0"
6  End If
 
6  If IsNumeric(txtPrixManuel.Text) Then
6  rstProjSoum.Fields("Total_Manuel") = txtPrixManuel.Text
70 Else
  rstProjSoum.Fields("Total_Manuel") = "0"
  End If
  ...
  rstProjSoum.Fields("TempsCoupe") = m_sTempsCoupe
  rstProjSoum.Fields("TempsMachinage") = m_sTempsMachinage
   rstProjSoum.Fields("TempsSoudure") = m_sTempsSoudure
   rstProjSoum.Fields("TempsAssemblage") = m_sTempsAssemblage
7  rstProjSoum.Fields("TempsPeinture") = m_sTempsPeinture
7  rstProjSoum.Fields("TempsTest") = m_sTempsTest
...
80 Else
  rstProjSoum.Fields("TempsProjBarré") = m_bTempsProjLock
 
  rstProjSoum.Fields("TempsDessinProj") = m_sTempsDessinProj
  rstProjSoum.Fields("TempsCoupeProj") = m_sTempsCoupeProj
  rstProjSoum.Fields("TempsMachinageProj") = m_sTempsMachinageProj
  rstProjSoum.Fields("TempsSoudureProj") = m_sTempsSoudureProj
  rstProjSoum.Fields("TempsAssemblageProj") = m_sTempsAssemblageProj
  rstProjSoum.Fields("TempsPeintureProj") = m_sTempsPeintureProj
  rstProjSoum.Fields("TempsTestProj") = m_sTempsTestProj
  rstProjSoum.Fields("TempsInstallationProj") = m_sTempsInstallationProj
  rstProjSoum.Fields("TempsFormationProj") = m_sTempsFormationProj
  rstProjSoum.Fields("TempsGestionProj") = m_sTempsGestionProj
   rstProjSoum.Fields("TempsShippingProj") = m_sTempsShippingProj

   rstProjSoum.Fields("TempsDessinConc") = m_sTempsDessinConc
   rstProjSoum.Fields("TempsCoupeConc") = m_sTempsCoupeConc
   rstProjSoum.Fields("TempsMachinageConc") = m_sTempsMachinageConc
8  rstProjSoum.Fields("TempsSoudureConc") = m_sTempsSoudureConc
8  rstProjSoum.Fields("TempsAssemblageConc") = m_sTempsAssemblageConc
8  rstProjSoum.Fields("TempsPeintureConc") = m_sTempsPeintureConc
8  rstProjSoum.Fields("TempsTestConc") = m_sTempsTestConc
90 rstProjSoum.Fields("TempsInstallationConc") = m_sTempsInstallationConc
  rstProjSoum.Fields("TempsFormationConc") = m_sTempsFormationConc
  rstProjSoum.Fields("TempsGestionConc") = m_sTempsGestionConc
  rstProjSoum.Fields("TempsShippingConc") = m_sTempsShippingConc
  End If
 
  rstProjSoum.Fields("NbrePersonne") = m_sNbrePersonne
  rstProjSoum.Fields("TempsHebergement") = m_sTempsHebergement
 ...
 rstProjSoum.Fields("TauxDessin") = m_sTauxDessin
   rstProjSoum.Fields("TauxCoupe") = m_sTauxCoupe
 rstProjSoum.Fields("TauxMachinage") = m_sTauxMachinage
9  rstProjSoum.Fields("TauxSoudure") = m_sTauxSoudure
 rstProjSoum.Fields("TauxAssemblage") = m_sTauxAssemblage
100 rstProjSoum.Fields("TauxPeinture") = m_sTauxPeinture
10 rstProjSoum.Fields("TauxTest") = m_sTauxTest
10 rstProjSoum.Fields("TauxInstallation") = m_sTauxInstallation
rstProjSoum.Fields("TauxFormation") = m_sTauxFormation
10 rstProjSoum.Fields("TauxGestion") = m_sTauxGestion
rstProjSoum.Fields("TauxShipping") = m_sTauxShipping

10 rstProjSoum.Fields("CheminPhotos") = txtCheminPhotos.Text
rstProjSoum.Fields("MontantForfait") = txtForfait.Text
10 rstProjSoum.Fields("InitialeForfait") = lblForfaitInitiale.Caption

If Not IsNull(rstProjSoum.Fields("NbrePersonne")) Then
1dblNbrePers = CDbl(rstProjSoum.Fields("NbrePersonne"))
106Else
10  dblNbrePers = 0
107End If

10  If Not IsNull(rstProjSoum.Fields("TempsHebergement")) Then
10  dblJoursHebergement = CDbl(rstProjSoum.Fields("TempsHebergement"))
10  Else
10  dblJoursHebergement = 0
10  End If

110 If Not IsNull(rstProjSoum.Fields("TempsRepas")) Then
11dblJoursRepas = CDbl(rstProjSoum.Fields("TempsRepas"))
11 Else
1 dblJoursRepas = 0
11 End If

11 If Not IsNull(rstProjSoum.Fields("TauxHebergement1")) Then
1 dblHebergement1 = CDbl(rstProjSoum.Fields("TauxHebergement1"))
11 Else
1 dblHebergement1 = 0
11 End If

11 If Not IsNull(rstProjSoum.Fields("TauxHebergement2")) Then
1 dblHebergement2 = CDbl(rstProjSoum.Fields("TauxHebergement2"))
116Else
1 dblHebergement2 = 0
1 End If

11  If Not IsNull(rstProjSoum.Fields("TauxRepas")) Then
 dblRepas = CDbl(rstProjSoum.Fields("TauxRepas"))
11  Else
 dblRepas = 0
11  End If

1 rstProjSoum.Fields("TotalRepas") = dblNbrePers * dblJoursRepas * dblRepas

1dblTotalHebergement = 0

12 Do While dblNbrePers > 0
...
12 rstProjSoum.Fields("TotalHebergement") = dblTotalHebergement

12  If bAjoutCommande = True Then
1 rstProjSoum.Fields("ProchaineCommande") = 1
127End If

12  If m_eType = TYPE_PROJET Then
12  rstProjSoum.Fields("PrixRéception") = txtPrixReception.Text
12  End If
 
 'Total des temps
12  rstProjSoum.Fields("Total_Temps") = txtTotalTemps.Text
 
12  Set rstPiece = New ADODB.Recordset
 
130 If m_eType = TYPE_PROJET Then
13 Call rstPiece.Open("SELECT * FROM GrbProjet_Pieces", g_connData, adOpenDynamic, adLockOptimistic)
13 Else
1 Call rstPiece.Open("SELECT * FROM GrbSoumission_Pieces", g_connData, adOpenDynamic, adLockOptimistic)
13 End If
 
13 If m_eType = TYPE_PROJET Then
...
13 For iCompteur = 1 To lvwSoumission.ListItems.count
...
1 rstPiece.Fields("Type") = "M"
 
14 If itmPiece.Checked = True Then
14 rstPiece.Fields("Visible") = True
14 Else
14 rstPiece.Fields("Visible") = False
14 End If

14 If m_eType = TYPE_PROJET Then
14 rstPiece.Fields("Facturation") = itmPiece.SubItems(I_COL_SOUM_FACTURATION)

14 If itmPiece.SubItems(I_COL_SOUM_FACTURATION) = "" Then
14 itmPiece.SubItems(I_COL_SOUM_FACTURATION) = " "
14 End If
...
14  rstPiece.Fields("NumItem") = itmPiece.SubItems(I_COL_SOUM_PIECE)
14  rstPiece.Fields("Qté") = Replace(itmPiece.Text, "*", "")

14  If itmPiece.SubItems(I_COL_SOUM_PIECE) = "Texte" Or itmPiece.SubItems(I_COL_SOUM_PIECE) = "Text" Then
150 rstPiece.Fields("DESC_EN") = ""
1 rstPiece.Fields("DESC_FR") = itmPiece.SubItems(I_COL_SOUM_DESCR)
 Else
 If m_eLangage = ANGLAIS Then
 rstPiece.Fields("DESC_EN") = itmPiece.SubItems(I_COL_SOUM_DESCR)
 rstPiece.Fields("DESC_FR") = itmPiece.ListSubItems(I_COL_SOUM_DESCR).Tag
 Else
 rstPiece.Fields("DESC_FR") = itmPiece.SubItems(I_COL_SOUM_DESCR)
 rstPiece.Fields("DESC_EN") = itmPiece.ListSubItems(I_COL_SOUM_DESCR).Tag
 End If
 End If

 rstPiece.Fields("Manufact") = itmPiece.SubItems(I_COL_SOUM_MANUFACT)
15  rstPiece.Fields("Prix_list") = Conversion(itmPiece.SubItems(I_COL_SOUM_PRIX_LIST), MODE_PAS_FORMAT, 4)

15  If Trim$(itmPiece.SubItems(I_COL_SOUM_ESCOMPTE)) <> "" Then
15  rstPiece.Fields("Escompte") = Conversion(Replace(itmPiece.SubItems(I_COL_SOUM_ESCOMPTE), "%", "") / 100, MODE_PAS_FORMAT)
15  Else
15  rstPiece.Fields("Escompte") = ""
15  End If

15  rstPiece.Fields("Prix_net") = Conversion(itmPiece.SubItems(I_COL_SOUM_PRIX_NET), MODE_PAS_FORMAT, 4)

15  If m_eType = TYPE_PROJET Then
160 rstPiece.Fields("DateRéception") = itmPiece.ListSubItems(I_COL_SOUM_PRIX_NET).Tag
 End If

 rstPiece.Fields("OrdreSection") = itmPiece.ListSubItems(I_COL_SOUM_MANUFACT).Tag
 rstPiece.Fields("NuméroLigne") = iCompteur

 If itmPiece.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_ORANGE Then
 rstPiece.Fields("Commandé") = True
 Else
 rstPiece.Fields("Commandé") = False
 End If

 If itmPiece.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_GRIS Then
 rstPiece.Fields("Recu") = True
 Else
16  rstPiece.Fields("Recu") = False
16  End If

16  If itmPiece.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_ROUGE Then
16  rstPiece.Fields("Retour") = True
16  Else
16  rstPiece.Fields("Retour") = False
16  End If

16  If itmPiece.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_VERT_FORET And itmPiece.ListSubItems(I_COL_SOUM_PIECE).Bold = True Then
170 rstPiece.Fields("CommandeAnnulée") = True
 Else
 rstPiece.Fields("CommandeAnnulée") = False
 End If

 If itmPiece.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_BRUN Then
 rstPiece.Fields("MatérielInutile") = True
 Else
 rstPiece.Fields("MatérielInutile") = False
 End If

 If Trim$(itmPiece.SubItems(I_COL_SOUM_DISTRIB)) <> vbNullString Then
 rstPiece.Fields("IDFRS") = CInt(itmPiece.ListSubItems(I_COL_SOUM_DISTRIB).Tag)
 Else
1   rstPiece.Fields("IDFRS") = 0
1   End If

17  rstPiece.Fields("Prix_Total") = Conversion(itmPiece.SubItems(I_COL_SOUM_TOTAL), MODE_PAS_FORMAT)
17  rstPiece.Fields("Profit_argent") = Conversion(itmPiece.SubItems(I_COL_SOUM_PROFIT), MODE_PAS_FORMAT)

17  If Len(itmPiece.ListSubItems(I_COL_SOUM_PIECE).Tag) <= 50 Then
17  rstPiece.Fields("SousSection") = itmPiece.ListSubItems(I_COL_SOUM_PIECE).Tag
17  Else
17  rstPiece.Fields("SousSection") = Left$(itmPiece.ListSubItems(I_COL_SOUM_PIECE).Tag, 50)
180 End If

 If itmPiece.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag <> vbNullString Then
 rstPiece.Fields("PrixOrigine") = itmPiece.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag
 Else
...
1   Else
18  If itmPiece.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_BLEU Then
18  rstPiece.Fields("PieceExtraChargeable") = True
18  rstPiece.Fields("PieceExtraNonChargeable") = False
18  Else
190 If Left$(itmPiece.ListSubItems(I_COL_SOUM_PROFIT).Tag, 6) = "RETOUR" Or Left$(itmPiece.ListSubItems(I_COL_SOUM_PROFIT).Tag, 10) = "ANNULATION" Then
...
1   rstPiece.Fields("Provenance") = Right$(itmPiece.SubItems(I_COL_SOUM_PROVENANCE), 2)
 Else
...
19  rstPiece.Fields("DateCommande") = itmPiece.SubItems(I_COL_SOUM_DATE_COMMANDE)
200 rstPiece.Fields("DateRequise") = itmPiece.SubItems(I_COL_SOUM_DATE_REQUISE)

 If itmPiece.SubItems(I_COL_SOUM_DATE_REQUISE) = "" Then
 itmPiece.SubItems(I_COL_SOUM_DATE_REQUISE) = " "
 End If

 rstPiece.Fields("DateRetour") = itmPiece.ListSubItems(I_COL_SOUM_DATE_REQUISE).Tag

 rstPiece.Fields("NomCommande") = itmPiece.SubItems(I_COL_SOUM_NOM_COMMANDE)

 rstPiece.Fields("NoSéquentiel") = itmPiece.SubItems(I_COL_SOUM_NO_SEQUENTIEL)
 End If
 ...
 If m_eType = TYPE_PROJET Then
 If Right$(txtNoProjSoum.Text, 2) <=   And Right$(txtNoProjSoum.Text, 2) >= 80 Then
...
20  Else
20  If Left$(itmPiece.ListSubItems(I_COL_SOUM_PROFIT).Tag, 6) = "RETOUR" Then
20  Call AjouterInutileDansExtra(itmPiece, sExtra)

20  bCalculExtra = True
...
2 If Right$(txtNoProjSoum.Text, 2) <=   And Right$(txtNoProjSoum.Text, 2) >= 60 Then
2 Call CalculerTotalRecordset(Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 2) & rstProjSoum.Fields("LiaisonChargeable"))
2 End If
228End If

22  If bCalculExtra = True Then
22  For iCompteurExtra = 1 To collExtra.count
...
2 Call AjouterSoumissionAuCumulatif
23 Else
2 Call AjouterProjetAuCumulatif
23 End If
...
23  woups"frmProjSoumMec", "EnregistrerProjSoum", Err, Erl, sNoProjSoum)
...
23  If Erl >= 1355 And Erl <= 2250 Then
2 Set rstSection = New ADODB.Recordset
 
2 If m_eLangage = ANGLAIS Then
2 Call rstSection.Open("SELECT NomSectionEN FROM GrbSoumProjSectionMec", g_connData, adOpenDynamic, adLockOptimistic)

2 If Not rstSection.EOF Then
2 sSection = rstSection.Fields("NomSectionEN")
2 Else
24 sSection = itmPiece.Tag
24 End If
24 Else
24 Call rstSection.Open("SELECT NomSectionFR FROM GrbSoumProjSectionMec", g_connData, adOpenDynamic, adLockOptimistic)
...
Private Sub AjouterPiecesExtraChargeableDansJob(ByVal itmSource As ListItem, ByVal sLiaison As String)
 ...
 Call rstProjet.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 2) & sLiaison & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
3 rstPiece.Fields("Provenance") = Right$(txtNoProjSoum.Text, 2)
...
wOups "frmProjSoumMec", "AjouterPiecesExtraDansJob", Err, Err.number, Err.Description

 Set rstSection = New ADODB.Recordset

 If m_eLangage = ANGLAIS Then
 Call rstSection.Open("SELECT NomSectionEN FROM GrbSoumProjSectionMec", g_connData, adOpenDynamic, adLockOptimistic)
 ...
 End If
 Else
 Call rstSection.Open("SELECT NomSectionFR FROM GrbSoumProjSectionMec", g_connData, adOpenDynamic, adLockOptimistic)
...
1 rstPiece.Fields("Type") = "M"
 ...
 rstPiece.Fields("IDSection") = itmSource.Tag
 rstPiece.Fields("NumItem") = Trim$(itmSource.SubItems(I_COL_SOUM_PIECE))
 rstPiece.Fields("Qté") = Replace(itmSource.Text, "*", "")
 rstPiece.Fields("Desc_FR") = Trim$(itmSource.SubItems(I_COL_SOUM_DESCR))
rstPiece.Fields("Desc_EN") = Trim$(itmSource.ListSubItems(I_COL_SOUM_DESCR).Tag)
 rstPiece.Fields("Manufact") = Trim$(itmSource.SubItems(I_COL_SOUM_MANUFACT))
 rstPiece.Fields("Prix_List") = Conversion(itmSource.SubItems(I_COL_SOUM_PRIX_LIST), MODE_PAS_FORMAT, 4)
...
1  If itmSource.SubItems(I_COL_SOUM_DISTRIB) <> vbNullString Then
 rstPiece.Fields("IDFRS") = CInt(itmSource.ListSubItems(I_COL_SOUM_DISTRIB).Tag)
 End If

 rstPiece.Fields("Prix_Total") = Conversion(itmSource.SubItems(I_COL_SOUM_TOTAL), MODE_PAS_FORMAT)
 rstPiece.Fields("Profit_argent") = Conversion(itmSource.SubItems(I_COL_SOUM_PROFIT), MODE_PAS_FORMAT)

 If Len(rstPiece.Fields("SousSection")) >= 255 Then
 rstPiece.Fields("SousSection") = itmSource.ListSubItems(I_COL_SOUM_PIECE).Tag
 Else
 rstPiece.Fields("SousSection") = Left$(itmSource.ListSubItems(I_COL_SOUM_PIECE).Tag, 255)
 End If
...
4 wOups "frmProjSoumMec", "AjouterPiecesExtraDansJob", Err, Err.number, Err.Description
...
Private Sub AjouterInutileDansExtra(ByVal itmSource As ListItem, ByVal sExtra As String)
 ...
 Call rstProjet.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 2) & sExtra & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
4  wOups "frmProjSoumMec", "AjouterInutileDansExtra", Err, Err.number, Err.Description
...
4 wOups "frmProjSoumMec", "AjouterAnnulationDansExtra", Err, Err.number, Err.Description
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdFermer_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirListViewModifications()
 ...
 sChamps = "IDProjet"
  ...
  sTableCreer = "GrbProjetMec"
  Else
  sChamps = "IDSoumission"
  sTable = "GrbSoumission_Modif"
  sTableCreer = "GrbSoumissionMec"
  End If
 
 'Ouverture du recordset selon le type
  Set rstEmploye = New ADODB.Recordset
10 Set rstCreation = New ADODB.Recordset
...
Call rstCreation.Close
1  Set rstCreation = Nothing
 
Set rstProjSoum = New ADODB.Recordset
 
 Call rstProjSoum.Open("SELECT * FROM " & sTable & " WHERE " & sChamps & " = '" & txtNoProjSoum.Text & "' AND Type = 'M' And TypeModif = 'MODIFICATION' ORDER BY Date, Heure", g_connData, adOpenDynamic, adLockOptimistic)
...
Call rstProjSoum.Open("SELECT * FROM " & sTable & " WHERE " & sChamps & " = '" & txtNoProjSoum.Text & "' AND Type = 'M' AND TypeModif = 'RECEPTION' ORDER BY Date, Heure", g_connData, adOpenDynamic, adLockOptimistic)
...
Call rstProjSoum.Open("SELECT * FROM " & sTable & " WHERE " & sChamps & " = '" & txtNoProjSoum.Text & "' AND Type = 'M' AND TypeModif = 'RETOUR' ORDER BY Date, Heure", g_connData, adOpenDynamic, adLockOptimistic)
...
4 Call rstProjSoum.Open("SELECT * FROM " & sTable & " WHERE " & sChamps & " = '" & txtNoProjSoum.Text & "' AND Type = 'M' AND TypeModif = 'FACTURATION' ORDER BY Date, Heure", g_connData, adOpenDynamic, adLockOptimistic)
...
Oups:
 ...
 wOups "frmProjSoumMec", "RemplirListViewModifications", Err, Err.number, Err.Description
End Sub
...
If ValiderFormatNumeroProjSoum(sNumero) = False Then
 ...
 If bNoValide = True Then
 If ValiderFormatMecanique(sNumero) = False Then
 bNoValide = False
 End If
1  End If
...
4  If rstProjSoum.EOF = False Then
4  If rstProjSoum.Fields("Ouvert") = False Then
4  Call MsgBox("Ce numéro est fermé!", vbOKOnly, "Erreur")
...
5  Call InitialiserVariables(sNumero)
...
60 Call RemplirSoumissionProjet(sNumero, sNoProjet)
  Else
...
6  wOups "frmProjSoumMec", "cmdAjouter_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "VerifierProjet", Err, Err.number, Err.Description
End Function
...
If rstProjSoum.Fields("TempsProjBarré") = False Then
 If Not IsNull(rstProjSoum.Fields("TempsDessinProj")) Then
 m_sTempsDessin = rstProjSoum.Fields("TempsDessinProj")
 Else
 m_sTempsDessin = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsCoupeProj")) Then
 m_sTempsCoupe = rstProjSoum.Fields("TempsCoupeProj")
 Else
 m_sTempsCoupe = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsMachinageProj")) Then
 m_sTempsMachinage = rstProjSoum.Fields("TempsMachinageProj")
 Else
1  m_sTempsMachinage = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsSoudureProj")) Then
 m_sTempsSoudure = rstProjSoum.Fields("TempsSoudureProj")
 Else
 m_sTempsSoudure = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsAssemblageProj")) Then
 m_sTempsAssemblage = rstProjSoum.Fields("TempsAssemblageProj")
 Else
 m_sTempsAssemblage = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsPeintureProj")) Then
 m_sTempsPeinture = rstProjSoum.Fields("TempsPeintureProj")
 Else
 m_sTempsPeinture = "0"
 End If

If Not IsNull(rstProjSoum.Fields("TempsTestProj")) Then
 m_sTempsTest = rstProjSoum.Fields("TempsTestProj")
Else
 m_sTempsTest = "0"
End If

3 If Not IsNull(rstProjSoum.Fields("TempsInstallationProj")) Then
 m_sTempsInstallation = rstProjSoum.Fields("TempsInstallationProj")
 Else
 m_sTempsInstallation = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsFormationProj")) Then
 m_sTempsFormation = rstProjSoum.Fields("TempsFormationProj")
 Else
 m_sTempsFormation = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsGestionProj")) Then
 m_sTempsGestion = rstProjSoum.Fields("TempsGestionProj")
 Else
 m_sTempsGestion = "0"
 End If

If Not IsNull(rstProjSoum.Fields("TempsShippingProj")) Then
 m_sTempsShipping = rstProjSoum.Fields("TempsShippingProj")
 Else
 m_sTempsShipping = "0"
End If
Else
4 If Not IsNull(rstProjSoum.Fields("TempsDessinConc")) Then
4 m_sTempsDessin = rstProjSoum.Fields("TempsDessinConc")
4 Else
4 m_sTempsDessin = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsCoupeConc")) Then
4 m_sTempsCoupe = rstProjSoum.Fields("TempsCoupeConc")
4 Else
4 m_sTempsCoupe = "0"
4 End If

4  If Not IsNull(rstProjSoum.Fields("TempsMachinageConc")) Then
4  m_sTempsMachinage = rstProjSoum.Fields("TempsMachinageConc")
4  Else
4  m_sTempsMachinage = "0"
4  End If

4  If Not IsNull(rstProjSoum.Fields("TempsSoudureConc")) Then
4  m_sTempsSoudure = rstProjSoum.Fields("TempsSoudureConc")
4  Else
50 m_sTempsSoudure = "0"
5 End If

 If Not IsNull(rstProjSoum.Fields("TempsAssemblageConc")) Then
 m_sTempsAssemblage = rstProjSoum.Fields("TempsAssemblageConc")
 Else
 m_sTempsAssemblage = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsPeintureConc")) Then
 m_sTempsPeinture = rstProjSoum.Fields("TempsPeintureConc")
 Else
 m_sTempsPeinture = "0"
 End If

5  If Not IsNull(rstProjSoum.Fields("TempsTestConc")) Then
5  m_sTempsTest = rstProjSoum.Fields("TempsTestConc")
5  Else
5  m_sTempsTest = "0"
5  End If

5  If Not IsNull(rstProjSoum.Fields("TempsInstallationConc")) Then
5  m_sTempsInstallation = rstProjSoum.Fields("TempsInstallationConc")
5  Else
60 m_sTempsInstallation = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsFormationConc")) Then
  m_sTempsFormation = rstProjSoum.Fields("TempsFormationConc")
  Else
  m_sTempsFormation = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TempsGestionConc")) Then
  m_sTempsGestion = rstProjSoum.Fields("TempsGestionConc")
  Else
  m_sTempsGestion = "0"
  End If

6  If Not IsNull(rstProjSoum.Fields("TempsShippingConc")) Then
6  m_sTempsShipping = rstProjSoum.Fields("TempsShippingConc")
6  Else
6  m_sTempsShipping = "0"
6  End If
6  End If

6  If Not IsNull(rstProjSoum.Fields("NbrePersonne")) Then
6  m_sNbrePersonne = rstProjSoum.Fields("NbrePersonne")
70 Else
  m_sNbrePersonne = "0"
  End If
...
7  If Not IsNull(rstProjSoum.Fields("TempsTransport")) Then
7  m_sTempsTransport = rstProjSoum.Fields("TempsTransport")
7  Else
7  m_sTempsTransport = "0"
7  End If

7  If Not IsNull(rstProjSoum.Fields("TempsUniteMobile")) Then
80 m_sTempsUniteMobile = rstProjSoum.Fields("TempsUniteMobile")
80 Else
  m_sTempsUniteMobile = "0"
  End If

  m_sPrixEmballage = rstProjSoum.Fields("PrixEmballage")

  Call rstConfig.Open("SELECT * FROM GrbConfig", g_connData, adOpenForwardOnly, adLockReadOnly)
...
8  If Not IsNull(rstConfig.Fields("TauxMachinage")) Then
8  m_sTauxMachinage = rstConfig.Fields("TauxMachinage")
8  Else
90 m_sTauxMachinage = "0"
  End If

  If Not IsNull(rstConfig.Fields("TauxSoudure")) Then
  m_sTauxSoudure = rstConfig.Fields("TauxSoudure")
  Else
  m_sTauxSoudure = "0"
  End If
...
1 If Not IsNull(rstConfig.Fields("TauxInstallationMec")) Then
1 m_sTauxInstallation = rstConfig.Fields("TauxInstallationMec")
 Else
1 m_sTauxInstallation = "0"
 End If

1 If Not IsNull(rstConfig.Fields("TauxFormationMec")) Then
 m_sTauxFormation = rstConfig.Fields("TauxFormationMec")
1Else
 m_sTauxFormation = "0"
1End If

10  If Not IsNull(rstConfig.Fields("TauxGestionProjetsMec")) Then
10  m_sTauxGestion = rstConfig.Fields("TauxGestionProjetsMec")
10  Else
10  m_sTauxGestion = "0"
10  End If

10  If Not IsNull(rstConfig.Fields("TauxShippingMec")) Then
10  m_sTauxShipping = rstConfig.Fields("TauxShippingMec")
10  Else
1 m_sTauxShipping = "0"
11End If

1 m_sTauxHebergement1 = rstConfig.Fields("Hebergement1")
1 m_sTauxHebergement2 = rstConfig.Fields("Hebergement2")
1 m_sTauxRepas = rstConfig.Fields("Repas")
1 m_sTauxTransport = rstConfig.Fields("Standard")
1 m_sTauxUniteMobile = rstConfig.Fields("UniteMobile")
11 Else
1 If Not IsNull(rstProjSoum.Fields("TauxDessin")) Then
1 m_sTauxDessin = rstProjSoum.Fields("TauxDessin")
1 Else
...
1 If Not IsNull(rstProjSoum.Fields("TauxCoupe")) Then
 m_sTauxCoupe = rstProjSoum.Fields("TauxCoupe")
1 Else
 m_sTauxCoupe = "0"
1 End If

 If Not IsNull(rstProjSoum.Fields("TauxMachinage")) Then
11  m_sTauxMachinage = rstProjSoum.Fields("TauxMachinage")
 Else
 m_sTauxMachinage = "0"
1 End If
...
1 If Not IsNull(rstProjSoum.Fields("TauxPeinture")) Then
1 m_sTauxPeinture = rstProjSoum.Fields("TauxPeinture")
1 Else
1 m_sTauxPeinture = "0"
1 End If

12  If Not IsNull(rstProjSoum.Fields("TauxTest")) Then
1 m_sTauxTest = rstProjSoum.Fields("TauxTest")
130 Else
13 m_sTauxTest = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TauxInstallation")) Then
1 m_sTauxInstallation = rstProjSoum.Fields("TauxInstallation")
1 Else
1 m_sTauxInstallation = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TauxFormation")) Then
1 m_sTauxFormation = rstProjSoum.Fields("TauxFormation")
1 Else
1 m_sTauxFormation = "0"
13  End If

1 If Not IsNull(rstProjSoum.Fields("TauxGestion")) Then
1 m_sTauxGestion = rstProjSoum.Fields("TauxGestion")
1 Else
1 m_sTauxGestion = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TauxShipping")) Then
1 m_sTauxShipping = rstProjSoum.Fields("TauxShipping")
140 Else
14 m_sTauxShipping = "0"
14 End If

14 If Not IsNull(rstProjSoum.Fields("TauxHebergement1")) Then
14 m_sTauxHebergement1 = rstProjSoum.Fields("TauxHebergement1")
14 Else
14 m_sTauxHebergement1 = "0"
14 End If

14 If Not IsNull(rstProjSoum.Fields("TauxHebergement2")) Then
14 m_sTauxHebergement2 = rstProjSoum.Fields("TauxHebergement2")
14 Else
14 m_sTauxHebergement2 = "0"
14  End If

14  If Not IsNull(rstProjSoum.Fields("TauxRepas")) Then
14  m_sTauxRepas = rstProjSoum.Fields("TauxRepas")
14  Else
14  m_sTauxRepas = "0"
14  End If

14  If Not IsNull(rstProjSoum.Fields("TauxTransport")) Then
14  m_sTauxTransport = rstProjSoum.Fields("TauxTransport")
150 Else
15 m_sTauxTransport = "0"
 End If

1 If Not IsNull(rstProjSoum.Fields("TauxUniteMobile")) Then
 m_sTauxUniteMobile = rstProjSoum.Fields("TauxUniteMobile")
 Else
...
If bVariables = True Then
 m_sProfit = rstConfig.Fields("ProfitMec")
 m_sCommission = rstConfig.Fields("Commission")
15  m_sImprevue = rstConfig.Fields("Imprévus")
15  Else
15  m_sProfit = rstProjSoum.Fields("Profit")
15  m_sCommission = rstProjSoum.Fields("Commission")
15  m_sImprevue = rstProjSoum.Fields("Imprevue")
15  End If

15  Call rstConfig.Close
15  Set rstConfig = Nothing
 
160 txtDescription.Text = rstProjSoum.Fields("Description")
160 txtNbreManuel.Text = rstProjSoum.Fields("manuel")
1  txtPrixManuel.Text = rstProjSoum.Fields("total_manuel")

1  txtTotalPieces.Text = rstProjSoum.Fields("Total_Piece")
1  txtTotalTemps.Text = rstProjSoum.Fields("Total_Temps")
1  txtPrixTotal.Text = rstProjSoum.Fields("PrixTotal")
1  txtImprevus.Text = rstProjSoum.Fields("Total_Imprevue")
1  txtProfit.Text = rstProjSoum.Fields("total_profit")
1  txtCommission.Text = rstProjSoum.Fields("total_commission")

1  If Not IsNull(rstProjSoum.Fields("CheminPhotos")) Then
 txtCheminPhotos.Text = rstProjSoum.Fields("CheminPhotos")
1  Else
16  txtCheminPhotos.Text = vbNullString
16  End If

16  If Not IsNull(rstProjSoum.Fields("MontantForfait")) Then
16  txtForfait.Text = rstProjSoum.Fields("MontantForfait")

16  If Not IsNull(rstProjSoum.Fields("InitialeForfait")) Then
16  lblForfaitInitiale.Caption = rstProjSoum.Fields("InitialeForfait")
16  Else
16  lblForfaitInitiale.Caption = ""
170 End If
Else
 txtForfait.Text = ""
...
1  Set rstProjSoum = Nothing

 'Affiche les pieces de la soumission
1  Call RemplirListViewSoumissionProjet(sNoProjet)

1  If bPrixPieces = True Then
 Call UpdatePieces
1  End If

1  m_bModeAffichage = False
...
17  wOups "frmProjSoumMec", "RemplirSoumissionProjet", Err, Err.number, Err.Description
End Sub
...
10 Set rstSection = New ADODB.Recordset
Set rstFRS = New ADODB.Recordset
...
Do While Not rstProjSoum.EOF
 ...
 Call rstSection.Open("SELECT " & sSection & " FROM GrbSoumProjSectionMec WHERE IDSection = " & rstProjSoum.Fields("IDSection"), g_connData, adOpenDynamic, adLockOptimistic)
...
6  'On met la description en francais dans le tag de la description en anglais
70 If Not IsNull(rstProjSoum.Fields("DESC_FR")) Then
 ...
 'On met la description en anglais dans le tag de la description en francais
  If Not IsNull(rstProjSoum.Fields("Desc_EN")) Then
   ...
   Else
7  itmProjSoum.ListSubItems(I_COL_SOUM_DESCR).Tag = vbNullString
7  End If
7  End If
7  End If
...
80 itmProjSoum.SubItems(I_COL_SOUM_MANUFACT) = rstProjSoum.Fields("Manufact")
  Else
 ...
 'Escompte
   ...
   Else
8  itmProjSoum.SubItems(I_COL_SOUM_ESCOMPTE) = " "
8  End If
...
90 itmProjSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(rstProjSoum.Fields("Prix_net"), MODE_ARGENT, 4)
  Else
 ...
 itmProjSoum.SubItems(I_COL_SOUM_TOTAL) = Conversion(Round(rstProjSoum.Fields("Prix_total"), 2), MODE_ARGENT)
9  Else
 itmProjSoum.SubItems(I_COL_SOUM_TOTAL) = " "
10End If

1 itmProjSoum.ListSubItems(I_COL_SOUM_TOTAL).ForeColor = lColor

 'Profit
1 If Trim(rstProjSoum.Fields("Profit_argent")) <> vbNullString Then
 itmProjSoum.SubItems(I_COL_SOUM_PROFIT) = Conversion(Round(rstProjSoum.Fields("Profit_Argent"), 2), MODE_ARGENT)
1Else
 itmProjSoum.SubItems(I_COL_SOUM_PROFIT) = " "
1End If
 
 itmProjSoum.ListSubItems(I_COL_SOUM_PROFIT).ForeColor = lColor

1 If Not IsNull(rstProjSoum.Fields("Commentaire")) Then
 itmProjSoum.SubItems(I_COL_SOUM_COMMENTAIRE) = rstProjSoum.Fields("Commentaire")
1Else
10  itmProjSoum.SubItems(I_COL_SOUM_COMMENTAIRE) = vbNullString
10  End If

10  itmProjSoum.ListSubItems(I_COL_SOUM_COMMENTAIRE).ForeColor = lColor
 
10  Call rstProjSoum.MoveNext
10  Loop
 
10  Call rstProjSoum.Close
10  Set rstProjSoum = Nothing

10  Set rstFRS = Nothing
...
11 wOups "frmProjSoumMec", "RemplirListViewProjSoum", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "RechercherProjSoum", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirProjSoum()
 ...
 End If
  ...
  If Not IsNull(rstProjSoum.Fields("LiaisonChargeable")) And Trim(rstProjSoum.Fields("LiaisonChargeable")) <> "" Then
  m_sLiaison = rstProjSoum.Fields("LiaisonChargeable")
  Else
  m_sLiaison = ""

  Do While Trim$(m_sLiaison) = ""
...
1  txtcontact.Text = rstContact.Fields("NomContact")
...
txtDescription.Text = rstProjSoum.Fields("Description")
 ...
 If Not IsNull(rstProjSoum.Fields("manuel")) Then
1  txtNbreManuel.Text = rstProjSoum.Fields("manuel")
 Else
 txtNbreManuel.Text = "0"
End If

txtPrixManuel.Text = rstProjSoum.Fields("total_manuel")
 
txtTotalPieces.Text = rstProjSoum.Fields("Total_Piece")
txtTotalTemps.Text = rstProjSoum.Fields("Total_Temps")
txtPrixTotal.Text = rstProjSoum.Fields("PrixTotal")
txtImprevus.Text = rstProjSoum.Fields("Total_Imprevue")
txtProfit.Text = rstProjSoum.Fields("total_profit")
txtCommission.Text = rstProjSoum.Fields("total_commission")
...
If m_eType = TYPE_PROJET Then
 ...
 txtPrixReception.Text = Conversion(rstProjSoum.Fields("PrixRéception"), MODE_ARGENT)
 Else
...
If Not IsNull(rstProjSoum.Fields("IDSoumission")) Then
 ...
 Call rstSoum.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & rstProjSoum.Fields("IDSoumission") & "'", g_connData, adOpenDynamic, adLockOptimistic)

 If Not rstSoum.EOF Then
 If Not IsNull(rstSoum.Fields("PrixTotal")) Then
...
4  Call rstSoum.Close
4  Set rstSoum = Nothing
4  End If
4  End If
...
50 wOups "frmProjSoumMec", "RemplirProjSoum", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirComboCategoriesPieces()
 ...
 Call cmbPieces.AddItem(rstCatalogueMec.Fields("CATEGORIE"))
...
Oups:
  ...
  wOups "frmProjSoumMec", "RemplirComboCategoriesPieces", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "RemplirComboClients", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "RemplirComboContacts", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "RemplirComboSections", Err, Err.number, Err.Description
End Sub
...
Private Sub cmdImprimer_Click()
 ...
 Call rstProjSoum.Open("SELECT * FROM GrbProjetMec WHERE Left$(IDProjet, 6) = '" & Left$(txtNoProjSoum.Text, 6) & "' ORDER BY IDProjet", g_connData, adOpenDynamic, adLockOptimistic)
 Else
 Call rstProjSoum.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "' ORDER BY IDProjet", g_connData, adOpenDynamic, adLockOptimistic)
  End If
  Else
  Call rstProjSoum.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & txtNoProjSoum.Text & "' ORDER BY IDSoumission", g_connData, adOpenDynamic, adLockOptimistic)
  End If
...
wOups "frmProjSoumMec", "cmdImprimer_Click", Err, Err.number, Err.Description
End Sub
...
Dim sNoProjet As String
Dim sNoSoumission As String
1  Dim dblPrixEmballage As Double
...
1  Set rstPiece = New ADODB.Recordset
 ...
 Call rstPiece.Open("SELECT * FROM GrbProjet_Pieces WHERE IDProjet = '" & sNoProjet & "' And Type = 'M' ORDER BY NuméroLigne", g_connData, adOpenDynamic, adLockOptimistic)
Else
 sNoProjet = vbNullString
 sNoSoumission = rstProjSoum.Fields("IDSoumission")

 Call rstPiece.Open("SELECT * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & sNoSoumission & "' And Type = 'M' ORDER BY NuméroLigne", g_connData, adOpenDynamic, adLockOptimistic)
2  End If
...
If m_eLangage = ANGLAIS Then
 ...
 Call rstTemp.Open("SELECT " & sChampsSection & " FROM GrbSoumProjSectionMec WHERE IDSection = " & rstPiece.Fields("IDSection"), g_connData, adOpenDynamic, adLockOptimistic)
...
50 rstImpProjSoum.Fields("NoLigne") = iCompteurSoum
...
5  rstImpProjSoum.Fields("NumItem") = rstPiece.Fields("NumItem")
5  rstImpProjSoum.Fields("Qté") = rstPiece.Fields("Qté")
 
60 If m_eLangage = ANGLAIS Then
 ...
 '************************************************************************************************
 'SECTION MODIFIER PAR GAÉTAN GINGRAS LE 0  FÉVRIER 2010
 '************************************************************************************************
  ...
  'Else
  ' rstImpProjSoum.Fields("ESCOMPTE") = Conversion(0, MODE_POURCENT)
  'End If
...
6  rstImpProjSoum.Fields("PRIX_TOTAL") = rstPiece.Fields("PRIX_TOTAL")
6  rstImpProjSoum.Fields("PROFIT_ARGENT") = rstPiece.Fields("PROFIT_ARGENT")
...
724 Call rstImpProjSoum.Open("SELECT * FROM Grbimpression_Soumission WHERE IDSoumission = '" & sProjet & "' ORDER BY NoLigne", g_connData, adOpenDynamic, adLockOptimistic)
  ...
  Set DR_SoumissionMec.DataSource = rstImpProjSoum
...
74  sqlstr = sqlstr + "FROM Grbimpression_soumission "
...
75 End If
 '***********************************************************************
  ...
  Call TraduireImpressionSoumission

   If m_eType = TYPE_PROJET Then
   DR_SoumissionMec.Sections("Section5").Controls("shpCadrePrixReception").Visible = True
7  DR_SoumissionMec.Sections("Section5").Controls("lblTitrePrixReception").Visible = True
7  DR_SoumissionMec.Sections("Section5").Controls("lblPrixReception").Visible = True

7  DR_SoumissionMec.Sections("Section5").Controls("shpCadrePrixSoumission").Visible = True
7  DR_SoumissionMec.Sections("Section5").Controls("lblTitrePrixSoumission").Visible = True
7  DR_SoumissionMec.Sections("Section5").Controls("lblPrixSoumission").Visible = True
7  Else
80 DR_SoumissionMec.Sections("Section5").Controls("shpCadrePrixReception").Visible = False
...
834 If MsgBox("Désirez-vous afficher la date en bas de page ?", vbYesNo + vbInformation, "Affichage de la date") = vbYes Then
  DR_SoumissionMec.Sections("section3").Controls("lbldate").Caption = ConvertDate(Date)
  Else
 ...
 'affiche entete
  ...
  If m_eType = TYPE_PROJET Then
  DR_SoumissionMec.Sections("Section2").Controls("lblprojet").Caption = rstProjSoum.Fields("IDProjet")
  Else
   DR_SoumissionMec.Sections("Section2").Controls("lblProjet").Caption = vbNullString
   End If
 
   DR_SoumissionMec.Sections("Section2").Controls("lbldescription").Caption = rstProjSoum.Fields("Description")
...
8  DR_SoumissionMec.Sections("Section2").Controls("lblclient").Caption = rstTemp.Fields("NomClient")

8  Call rstTemp.Close
 
8  Call rstTemp.Open("SELECT NomContact FROM GrbContact WHERE IDContact = " & rstProjSoum.Fields("IDContact"), g_connData, adOpenDynamic, adLockOptimistic)
 
8  DR_SoumissionMec.Sections("Section2").Controls("lblcontact").Caption = rstTemp.Fields("NomContact")
 
90 Call rstTemp.Close
...
90 If m_eType = TYPE_SOUMISSION Then
  ...
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxDessin").Caption = rstProjSoum.Fields("TauxDessin")
  Else
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxDessin").Caption = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TauxCoupe")) Then
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxCoupe").Caption = rstProjSoum.Fields("TauxCoupe")
  Else
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxCoupe").Caption = "0"
  End If

 If Not IsNull(rstProjSoum.Fields("TauxMachinage")) Then
   DR_SoumissionMec.Sections("Section5").Controls("lblTauxMachinage").Caption = rstProjSoum.Fields("TauxMachinage")
 Else
   DR_SoumissionMec.Sections("Section5").Controls("lblTauxMachinage").Caption = "0"
 End If

   If Not IsNull(rstProjSoum.Fields("TauxSoudure")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxSoudure").Caption = rstProjSoum.Fields("TauxSoudure")
9  Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxSoudure").Caption = "0"
10End If

1 If Not IsNull(rstProjSoum.Fields("TauxAssemblage")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxAssemblage").Caption = rstProjSoum.Fields("TauxAssemblage")
 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxAssemblage").Caption = "0"
 End If

1 If Not IsNull(rstProjSoum.Fields("TauxPeinture")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxPeinture").Caption = rstProjSoum.Fields("TauxPeinture")
1Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxPeinture").Caption = "0"
1End If

10  If Not IsNull(rstProjSoum.Fields("TauxTest")) Then
10  DR_SoumissionMec.Sections("Section5").Controls("lblTauxTest").Caption = rstProjSoum.Fields("TauxTest")
10  Else
10  DR_SoumissionMec.Sections("Section5").Controls("lblTauxTest").Caption = "0"
10  End If

10  If Not IsNull(rstProjSoum.Fields("TauxInstallation")) Then
10  DR_SoumissionMec.Sections("Section5").Controls("lblTauxInstallation").Caption = rstProjSoum.Fields("TauxInstallation")
10  Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxInstallation").Caption = "0"
11End If

1 If Not IsNull(rstProjSoum.Fields("TauxFormation")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxFormation").Caption = rstProjSoum.Fields("TauxFormation")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxFormation").Caption = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TauxGestion")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxGestion").Caption = rstProjSoum.Fields("TauxGestion")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxGestion").Caption = "0"
1 End If

11  If Not IsNull(rstProjSoum.Fields("TauxShipping")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxShipping").Caption = rstProjSoum.Fields("TauxShipping")
 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTauxShipping").Caption = "0"
 End If

1 If Not IsNull(rstProjSoum.Fields("TempsDessin")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = rstProjSoum.Fields("TempsDessin")
11  Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TempsCoupe")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = rstProjSoum.Fields("TempsCoupe")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TempsMachinage")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = rstProjSoum.Fields("TempsMachinage")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = "0"
1 End If

12  If Not IsNull(rstProjSoum.Fields("TempsSoudure")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = rstProjSoum.Fields("TempsSoudure")
12  Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = "0"
12  End If

1 If Not IsNull(rstProjSoum.Fields("TempsAssemblage")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = rstProjSoum.Fields("TempsAssemblage")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = "0"
13End If

1 If Not IsNull(rstProjSoum.Fields("TempsPeinture")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = rstProjSoum.Fields("TempsPeinture")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TempsTest")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = rstProjSoum.Fields("TempsTest")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = "0"
1 End If

13  If Not IsNull(rstProjSoum.Fields("TempsInstallation")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = rstProjSoum.Fields("TempsInstallation")
13  Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = "0"
1End If

1 If Not IsNull(rstProjSoum.Fields("TempsFormation")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationSoum").Caption = rstProjSoum.Fields("TempsFormation")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationSoum").Caption = "0"
14End If

14 If Not IsNull(rstProjSoum.Fields("TempsGestion")) Then
14 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = rstProjSoum.Fields("TempsGestion")
14 Else
14 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = "0"
14 End If

14 If Not IsNull(rstProjSoum.Fields("TempsShipping")) Then
14 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = rstProjSoum.Fields("TempsShipping")
14 Else
14 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = "0"
14 End If

14  If Not IsNull(rstProjSoum.Fields("TempsDessin")) Then
...
15 If Not IsNull(rstProjSoum.Fields("TempsCoupe")) Then
 If IsNumeric(rstProjSoum.Fields("TempsCoupe")) Then
 dblTempsCoupe = CDbl(rstProjSoum.Fields("TempsCoupe"))
 Else
 dblTempsCoupe = 0
 End If
 Else
 ...
 If Not IsNull(rstProjSoum.Fields("TempsMachinage")) Then
 If IsNumeric(rstProjSoum.Fields("TempsMachinage")) Then
15  dblTempsMachinage = CDbl(rstProjSoum.Fields("TempsMachinage"))
15  Else
15  dblTempsMachinage = 0
15  End If
15  Else
15  dblTempsMachinage = 0
15  End If

15  If Not IsNull(rstProjSoum.Fields("TempsSoudure")) Then
160 If IsNumeric(rstProjSoum.Fields("TempsSoudure")) Then
 dblTempsSoudure = CDbl(rstProjSoum.Fields("TempsSoudure"))
 Else
 dblTempsSoudure = 0
 End If
 Else
 ...
 Else
16  dblTempsAssemblage = 0
16  End If
16  Else
16  dblTempsAssemblage = 0
16  End If

16  If Not IsNull(rstProjSoum.Fields("TempsPeinture")) Then
16  If IsNumeric(rstProjSoum.Fields("TempsPeinture")) Then
16  dblTempsPeinture = CDbl(rstProjSoum.Fields("TempsPeinture"))
170 Else
 dblTempsPeinture = 0
 End If
 Else
 ...
 If IsNumeric(rstProjSoum.Fields("TempsTest")) Then
...
17  If Not IsNull(rstProjSoum.Fields("TempsInstallation")) Then
17  If IsNumeric(rstProjSoum.Fields("TempsInstallation")) Then
17  dblTempsInstallation = CDbl(rstProjSoum.Fields("TempsInstallation"))
17  Else
17  dblTempsInstallation = 0
180 End If
 Else
 ...
 If IsNumeric(rstProjSoum.Fields("TempsFormation")) Then
 dblTempsFormation = CDbl(rstProjSoum.Fields("TempsFormation"))
 Else
 dblTempsFormation = 0
 End If
 Else
...
1   If Not IsNull(rstProjSoum.Fields("TempsGestion")) Then
1   If IsNumeric(rstProjSoum.Fields("TempsGestion")) Then
1   dblTempsGestion = CDbl(rstProjSoum.Fields("TempsGestion"))
18  Else
18  dblTempsGestion = 0
18  End If
18  Else
190 dblTempsGestion = 0
 End If

1  If Not IsNull(rstProjSoum.Fields("TempsShipping")) Then
1  If IsNumeric(rstProjSoum.Fields("TempsShipping")) Then
1  dblTempsShipping = CDbl(rstProjSoum.Fields("TempsShipping"))
1  Else
1  dblTempsShipping = 0
1  End If
1  Else
1  dblTempsShipping = 0
1  End If
...
1   DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinProj").Caption = "---"
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeProj").Caption = "---"
1   DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageProj").Caption = "---"
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureProj").Caption = "---"
1   DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageProj").Caption = "---"
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureProj").Caption = "---"
19  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestProj").Caption = "---"
200 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationProj").Caption = "---"
...
20  DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationConc").Caption = "---"
20  DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationConc").Caption = "---"
20  DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionConc").Caption = "---"
20  DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingConc").Caption = "---"

20  DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHConc").Caption = "---"
20  Else
20  If Not IsNull(rstProjSoum.Fields("TauxDessin")) Then
20  DR_SoumissionMec.Sections("Section5").Controls("lblTauxDessin").Caption = rstProjSoum.Fields("TauxDessin")
210 Else
21 DR_SoumissionMec.Sections("Section5").Controls("lblTauxDessin").Caption = "0"
2 End If

2 If Not IsNull(rstProjSoum.Fields("TauxCoupe")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTauxCoupe").Caption = rstProjSoum.Fields("TauxCoupe")
2 Else
DR_SoumissionMec.Sections("Section5").Controls("lblTauxCoupe").Caption = "0"
2 End If

2 If Not IsNull(rstProjSoum.Fields("TauxMachinage")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTauxMachinage").Caption = rstProjSoum.Fields("TauxMachinage")
2 Else
DR_SoumissionMec.Sections("Section5").Controls("lblTauxMachinage").Caption = "0"
21  End If

2 If Not IsNull(rstProjSoum.Fields("TauxSoudure")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxSoudure").Caption = rstProjSoum.Fields("TauxSoudure")
2 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxSoudure").Caption = "0"
2 End If
...
21  DR_SoumissionMec.Sections("Section5").Controls("lblTauxAssemblage").Caption = rstProjSoum.Fields("TauxAssemblage")
 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxAssemblage").Caption = "0"
2 End If

2 If Not IsNull(rstProjSoum.Fields("TauxPeinture")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxPeinture").Caption = rstProjSoum.Fields("TauxPeinture")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxPeinture").Caption = "0"
2 End If

2 If Not IsNull(rstProjSoum.Fields("TauxTest")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxTest").Caption = rstProjSoum.Fields("TauxTest")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxTest").Caption = "0"
22  End If

2 If Not IsNull(rstProjSoum.Fields("TauxInstallation")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxInstallation").Caption = rstProjSoum.Fields("TauxInstallation")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxInstallation").Caption = "0"
2 End If

22  If Not IsNull(rstProjSoum.Fields("TauxFormation")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxFormation").Caption = rstProjSoum.Fields("TauxFormation")
230 Else
23 DR_SoumissionMec.Sections("Section5").Controls("lblTauxFormation").Caption = "0"
2 End If

2 If Not IsNull(rstProjSoum.Fields("TauxGestion")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxGestion").Caption = rstProjSoum.Fields("TauxGestion")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxGestion").Caption = "0"
2 End If

2 If Not IsNull(rstProjSoum.Fields("TauxShipping")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxShipping").Caption = rstProjSoum.Fields("TauxShipping")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxShipping").Caption = "0"
23  End If

2 If Not IsNull(rstProjSoum.Fields("IDSoumission")) Then
2 Set rstSoum = New ADODB.Recordset

2 Call rstSoum.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & rstProjSoum.Fields("IDSoumission") & "'", g_connData, adOpenDynamic, adLockOptimistic)

2 If Not rstSoum.EOF Then
2 If Not IsNull(rstSoum.Fields("TempsDessin")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = rstSoum.Fields("TempsDessin")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = "0"
24 End If

24 If Not IsNull(rstSoum.Fields("TempsCoupe")) Then
24 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = rstSoum.Fields("TempsCoupe")
24 Else
24 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = "0"
24 End If

24 If Not IsNull(rstSoum.Fields("TempsMachinage")) Then
24 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = rstSoum.Fields("TempsMachinage")
24 Else
24 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = "0"
24 End If

24  If Not IsNull(rstSoum.Fields("TempsSoudure")) Then
24  DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = rstSoum.Fields("TempsSoudure")
24  Else
24  DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = "0"
24  End If

24  If Not IsNull(rstSoum.Fields("TempsAssemblage")) Then
24  DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = rstSoum.Fields("TempsAssemblage")
24  Else
250 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = "0"
2End If

 If Not IsNull(rstSoum.Fields("TempsPeinture")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = rstSoum.Fields("TempsPeinture")
 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = "0"
 End If

 If Not IsNull(rstSoum.Fields("TempsTest")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = rstSoum.Fields("TempsTest")
 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = "0"
 End If

25  If Not IsNull(rstSoum.Fields("TempsInstallation")) Then
25  DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = rstSoum.Fields("TempsInstallation")
25  Else
25  DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = "0"
25  End If

25  If Not IsNull(rstSoum.Fields("TempsFormation")) Then
25  DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationSoum").Caption = rstSoum.Fields("TempsFormation")
25  Else
260 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationSoum").Caption = "0"
 End If

 If Not IsNull(rstSoum.Fields("TempsGestion")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = rstSoum.Fields("TempsGestion")
 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = "0"
 End If

 If Not IsNull(rstSoum.Fields("TempsShipping")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = rstSoum.Fields("TempsShipping")
 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = "0"
 End If

26  If Not IsNull(rstSoum.Fields("TempsDessin")) Then
26  If IsNumeric(rstSoum.Fields("TempsDessin")) Then
26  dblTempsDessin = CDbl(rstSoum.Fields("TempsDessin"))
26  Else
26  dblTempsDessin = 0
26  End If
26  Else
...
270 End If
 ...
 If IsNumeric(rstSoum.Fields("TempsCoupe")) Then
 dblTempsCoupe = CDbl(rstSoum.Fields("TempsCoupe"))
 Else
 dblTempsCoupe = 0
 End If
 Else
 ...
 If IsNumeric(rstSoum.Fields("TempsMachinage")) Then
2   dblTempsMachinage = CDbl(rstSoum.Fields("TempsMachinage"))
2   Else
27  dblTempsMachinage = 0
27  End If
27  Else
27  dblTempsMachinage = 0
27  End If

27  If Not IsNull(rstSoum.Fields("TempsSoudure")) Then
280 If IsNumeric(rstSoum.Fields("TempsSoudure")) Then
 dblTempsSoudure = CDbl(rstSoum.Fields("TempsSoudure"))
 Else
 dblTempsSoudure = 0
 End If
 Else
 ...
 If IsNumeric(rstSoum.Fields("TempsAssemblage")) Then
 dblTempsAssemblage = CDbl(rstSoum.Fields("TempsAssemblage"))
 Else
2   dblTempsAssemblage = 0
2   End If
2   Else
2   dblTempsAssemblage = 0
28  End If

28  If Not IsNull(rstSoum.Fields("TempsPeinture")) Then
28  If IsNumeric(rstSoum.Fields("TempsPeinture")) Then
28  dblTempsPeinture = CDbl(rstSoum.Fields("TempsPeinture"))
290 Else
 dblTempsPeinture = 0
 End If
 Else
 ...
 If Not IsNull(rstSoum.Fields("TempsTest")) Then
 If IsNumeric(rstSoum.Fields("TempsTest")) Then
 dblTempsTest = CDbl(rstSoum.Fields("TempsTest"))
 Else
 dblTempsTest = 0
 End If
 Else
...
2   If Not IsNull(rstSoum.Fields("TempsInstallation")) Then
 If IsNumeric(rstSoum.Fields("TempsInstallation")) Then
2   dblTempsInstallation = CDbl(rstSoum.Fields("TempsInstallation"))
 Else
29  dblTempsInstallation = 0
300 End If
 Else
 dblTempsInstallation = 0
 End If
 ...
 If IsNumeric(rstSoum.Fields("TempsFormation")) Then
 dblTempsFormation = CDbl(rstSoum.Fields("TempsFormation"))
 Else
 dblTempsFormation = 0
 End If
 Else
...
30  If Not IsNull(rstSoum.Fields("TempsGestion")) Then
30  If IsNumeric(rstSoum.Fields("TempsGestion")) Then
30  dblTempsGestion = CDbl(rstSoum.Fields("TempsGestion"))
30  Else
30  dblTempsGestion = 0
30  End If
30  Else
 dblTempsGestion = 0
3 End If
 ...
 If Not IsNull(rstSoum.Fields("TempsShipping")) Then
 If IsNumeric(rstSoum.Fields("TempsShipping")) Then
 dblTempsShipping = CDbl(rstSoum.Fields("TempsShipping"))
 Else
 dblTempsShipping = 0
 End If
 Else
...
31  DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = "---"
...
DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = "---"
DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = "---"
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = "---"
DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = "---"
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = "---"
DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = "---"
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = "---"
DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = "---"
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationSoum").Caption = "---"
DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = "---"
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = "---"

33 DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHSoum").Caption = "---"
3 End If

3 If Not IsNull(rstProjSoum.Fields("TempsDessinProj")) Then
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinProj").Caption = rstProjSoum.Fields("TempsDessinProj")
3 Else
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinProj").Caption = "0"
3 End If

3 If Not IsNull(rstProjSoum.Fields("TempsCoupeProj")) Then
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeProj").Caption = rstProjSoum.Fields("TempsCoupeProj")
3 Else
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeProj").Caption = "0"
33  End If

3 If Not IsNull(rstProjSoum.Fields("TempsMachinageProj")) Then
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageProj").Caption = rstProjSoum.Fields("TempsMachinageProj")
3 Else
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageProj").Caption = "0"
3 End If

3 If Not IsNull(rstProjSoum.Fields("TempsSoudureProj")) Then
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureProj").Caption = rstProjSoum.Fields("TempsSoudureProj")
340 Else
34 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureProj").Caption = "0"
34 End If

34 If Not IsNull(rstProjSoum.Fields("TempsAssemblageProj")) Then
34 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageProj").Caption = rstProjSoum.Fields("TempsAssemblageProj")
34 Else
34 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageProj").Caption = "0"
34 End If

34 If Not IsNull(rstProjSoum.Fields("TempsPeintureProj")) Then
34 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureProj").Caption = rstProjSoum.Fields("TempsPeintureProj")
34 Else
34 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureProj").Caption = "0"
34  End If

34  If Not IsNull(rstProjSoum.Fields("TempsTestProj")) Then
34  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestProj").Caption = rstProjSoum.Fields("TempsTestProj")
34  Else
34  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestProj").Caption = "0"
34  End If

34  If Not IsNull(rstProjSoum.Fields("TempsInstallationProj")) Then
34  DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationProj").Caption = rstProjSoum.Fields("TempsInstallationProj")
350 Else
35 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationProj").Caption = "0"
 End If

3 If Not IsNull(rstProjSoum.Fields("TempsFormationProj")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationProj").Caption = rstProjSoum.Fields("TempsFormationProj")
3 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationProj").Caption = "0"
3 End If

 If Not IsNull(rstProjSoum.Fields("TempsGestionProj")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionProj").Caption = rstProjSoum.Fields("TempsGestionProj")
 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionProj").Caption = "0"
35  End If

35  If Not IsNull(rstProjSoum.Fields("TempsShippingProj")) Then
35  DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingProj").Caption = rstProjSoum.Fields("TempsShippingProj")
35  Else
35  DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingProj").Caption = "0"
35  End If

35  If Not IsNull(rstProjSoum.Fields("TempsDessinProj")) Then
35  If IsNumeric(rstProjSoum.Fields("TempsDessinProj")) Then
360 dblTempsDessin = CDbl(rstProjSoum.Fields("TempsDessinProj"))
3  Else
 dblTempsDessin = 0
 End If
 Else
 ...
 If Not IsNull(rstProjSoum.Fields("TempsCoupeProj")) Then
 If IsNumeric(rstProjSoum.Fields("TempsCoupeProj")) Then
 dblTempsCoupe = CDbl(rstProjSoum.Fields("TempsCoupeProj"))
 Else
 dblTempsCoupe = 0
36  End If
36  Else
...
36  If Not IsNull(rstProjSoum.Fields("TempsMachinageProj")) Then
36  If IsNumeric(rstProjSoum.Fields("TempsMachinageProj")) Then
36  dblTempsMachinage = CDbl(rstProjSoum.Fields("TempsMachinageProj"))
36  Else
370 dblTempsMachinage = 0
3  End If
 Else
 dblTempsMachinage = 0
 End If
 ...
 If Not IsNull(rstProjSoum.Fields("TempsSoudureProj")) Then
 If IsNumeric(rstProjSoum.Fields("TempsSoudureProj")) Then
 dblTempsSoudure = CDbl(rstProjSoum.Fields("TempsSoudureProj"))
 Else
 dblTempsSoudure = 0
 End If
 Else
...
37  If Not IsNull(rstProjSoum.Fields("TempsAssemblageProj")) Then
37  If IsNumeric(rstProjSoum.Fields("TempsAssemblageProj")) Then
37  dblTempsAssemblage = CDbl(rstProjSoum.Fields("TempsAssemblageProj"))
37  Else
37  dblTempsAssemblage = 0
37  End If
380 Else
dblTempsAssemblage = 0
 ...
 If Not IsNull(rstProjSoum.Fields("TempsPeintureProj")) Then
 If IsNumeric(rstProjSoum.Fields("TempsPeintureProj")) Then
 dblTempsPeinture = CDbl(rstProjSoum.Fields("TempsPeintureProj"))
 Else
 dblTempsPeinture = 0
 End If
 Else
...
3   If Not IsNull(rstProjSoum.Fields("TempsTestProj")) Then
3   If IsNumeric(rstProjSoum.Fields("TempsTestProj")) Then
3   dblTempsTest = CDbl(rstProjSoum.Fields("TempsTestProj"))
3   Else
38  dblTempsTest = 0
38  End If
38  Else
...
3  If Not IsNull(rstProjSoum.Fields("TempsInstallationProj")) Then
 If IsNumeric(rstProjSoum.Fields("TempsInstallationProj")) Then
 dblTempsInstallation = CDbl(rstProjSoum.Fields("TempsInstallationProj"))
 Else
 dblTempsInstallation = 0
 End If
 Else
 ...
 If Not IsNull(rstProjSoum.Fields("TempsFormationProj")) Then
 If IsNumeric(rstProjSoum.Fields("TempsFormationProj")) Then
 dblTempsFormation = CDbl(rstProjSoum.Fields("TempsFormationProj"))
3   Else
 dblTempsFormation = 0
3   End If
 Else
3   dblTempsFormation = 0
 End If

39  If Not IsNull(rstProjSoum.Fields("TempsGestionProj")) Then
400 If IsNumeric(rstProjSoum.Fields("TempsGestionProj")) Then
 dblTempsGestion = CDbl(rstProjSoum.Fields("TempsGestionProj"))
4 Else
4 dblTempsGestion = 0
4 End If
4Else
...
4 If Not IsNull(rstProjSoum.Fields("TempsShippingProj")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsShippingProj")) Then
 dblTempsShipping = CDbl(rstProjSoum.Fields("TempsShippingProj"))
4 Else
40  dblTempsShipping = 0
40  End If
40  Else
40  dblTempsShipping = 0
40  End If

40  dblTotalTemps = dblTempsDessin + _
 dblTempsCoupe + _
 dblTempsMachinage + _
 dblTempsSoudure + _
 dblTempsAssemblage + _
...
40  DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHProj").Caption = dblTotalTemps

40  If rstProjSoum.Fields("TempsProjBarré") = True Then
4 If Not IsNull(rstProjSoum.Fields("TempsDessinConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinConc").Caption = rstProjSoum.Fields("TempsDessinConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsCoupeConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeConc").Caption = rstProjSoum.Fields("TempsCoupeConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsMachinageConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageConc").Caption = rstProjSoum.Fields("TempsMachinageConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsSoudureConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureConc").Caption = rstProjSoum.Fields("TempsSoudureConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureConc").Caption = "0"
41  End If

4 If Not IsNull(rstProjSoum.Fields("TempsAssemblageConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageConc").Caption = rstProjSoum.Fields("TempsAssemblageConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsPeintureConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureConc").Caption = rstProjSoum.Fields("TempsPeintureConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsTestConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestConc").Caption = rstProjSoum.Fields("TempsTestConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsInstallationConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationConc").Caption = rstProjSoum.Fields("TempsInstallationConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsFormationConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationConc").Caption = rstProjSoum.Fields("TempsFormationConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsGestionConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionConc").Caption = rstProjSoum.Fields("TempsGestionConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionConc").Caption = "0"
4 End If

4 If Not IsNull(rstProjSoum.Fields("TempsShippingConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingConc").Caption = rstProjSoum.Fields("TempsShippingConc")
4 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingConc").Caption = "0"
4 End If
 
4 If Not IsNull(rstProjSoum.Fields("TempsDessinConc")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsDessinConc")) Then
4 dblTempsDessin = CDbl(rstProjSoum.Fields("TempsDessinConc"))
4 Else
4 dblTempsDessin = 0
4 End If
44 Else
...
44 If Not IsNull(rstProjSoum.Fields("TempsCoupeConc")) Then
44 If IsNumeric(rstProjSoum.Fields("TempsCoupeConc")) Then
44 dblTempsCoupe = CDbl(rstProjSoum.Fields("TempsCoupeConc"))
44 Else
44 dblTempsCoupe = 0
44 End If
44 Else
...
44  If Not IsNull(rstProjSoum.Fields("TempsMachinageConc")) Then
44  If IsNumeric(rstProjSoum.Fields("TempsMachinageConc")) Then
44  dblTempsMachinage = CDbl(rstProjSoum.Fields("TempsMachinageConc"))
44  Else
44  dblTempsMachinage = 0
44  End If
44  Else
450 dblTempsMachinage = 0
45 End If

 If Not IsNull(rstProjSoum.Fields("TempsSoudureConc")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsSoudureConc")) Then
 dblTempsSoudure = CDbl(rstProjSoum.Fields("TempsSoudureConc"))
4 Else
 dblTempsSoudure = 0
4 End If
 Else
4 dblTempsSoudure = 0
 ...
 If Not IsNull(rstProjSoum.Fields("TempsAssemblageConc")) Then
45  If IsNumeric(rstProjSoum.Fields("TempsAssemblageConc")) Then
45  dblTempsAssemblage = CDbl(rstProjSoum.Fields("TempsAssemblageConc"))
45  Else
45  dblTempsAssemblage = 0
45  End If
45  Else
45  dblTempsAssemblage = 0
45  End If

460 If Not IsNull(rstProjSoum.Fields("TempsPeintureConc")) Then
4  If IsNumeric(rstProjSoum.Fields("TempsPeintureConc")) Then
4  dblTempsPeinture = CDbl(rstProjSoum.Fields("TempsPeintureConc"))
4  Else
4  dblTempsPeinture = 0
4  End If
4  Else
4  dblTempsPeinture = 0
4  End If
...
4  If Not IsNull(rstProjSoum.Fields("TempsTestConc")) Then
4  If IsNumeric(rstProjSoum.Fields("TempsTestConc")) Then
4  dblTempsTest = CDbl(rstProjSoum.Fields("TempsTestConc"))
46  Else
46  dblTempsTest = 0
46  End If
46  Else
...
46  If Not IsNull(rstProjSoum.Fields("TempsInstallationConc")) Then
46  If IsNumeric(rstProjSoum.Fields("TempsInstallationConc")) Then
470 dblTempsInstallation = CDbl(rstProjSoum.Fields("TempsInstallationConc"))
4  Else
4  dblTempsInstallation = 0
4  End If
4  Else
4  dblTempsInstallation = 0
4  End If
...
4  If Not IsNull(rstProjSoum.Fields("TempsFormationConc")) Then
4  If IsNumeric(rstProjSoum.Fields("TempsFormationConc")) Then
4  dblTempsFormation = CDbl(rstProjSoum.Fields("TempsFormationConc"))
4  Else
4  dblTempsFormation = 0
4   End If
4   Else
47  dblTempsFormation = 0
47  End If
 
47  If Not IsNull(rstProjSoum.Fields("TempsGestionConc")) Then
47  If IsNumeric(rstProjSoum.Fields("TempsGestionConc")) Then
47  dblTempsGestion = CDbl(rstProjSoum.Fields("TempsGestionConc"))
47  Else
480 dblTempsGestion = 0
4  End If
4  Else
4  dblTempsGestion = 0
4  End If
...
4  If Not IsNull(rstProjSoum.Fields("TempsShippingConc")) Then
4  If IsNumeric(rstProjSoum.Fields("TempsShippingConc")) Then
4  dblTempsShipping = CDbl(rstProjSoum.Fields("TempsShippingConc"))
4  Else
...
4   DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHConc").Caption = dblTotalTemps
48  Else
48  DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinConc").Caption = "---"
48  DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeConc").Caption = "---"
48  DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageConc").Caption = "---"
490 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingConc").Caption = "---"

4  DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHConc").Caption = "---"
4  End If

4  Call CalculerTempsReelsImpression(rstProjSoum.Fields("IDProjet"))
4  End If
 
 'Autres frais
4 If m_eType = TYPE_PROJET Then
4   DR_SoumissionMec.Sections("Section5").Controls("lblNbrePersonne").Caption = "0"
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsHebergement").Caption = "0"
4   DR_SoumissionMec.Sections("Section5").Controls("lblTauxHebergement1").Caption = "0"
4 DR_SoumissionMec.Sections("Section5").Controls("lblTauxHebergement2").Caption = "0"
4   DR_SoumissionMec.Sections("Section5").Controls("lblTempsRepas").Caption = "0"
4 DR_SoumissionMec.Sections("Section5").Controls("lblTauxRepas").Caption = "0"
49  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTransport").Caption = "0"
500 DR_SoumissionMec.Sections("Section5").Controls("lblTauxTransport").Caption = "0"
50DR_SoumissionMec.Sections("Section5").Controls("lblTempsUniteMobile").Caption = "0"
5DR_SoumissionMec.Sections("Section5").Controls("lblTauxUniteMobile").Caption = "0"
50 Else
5 If Not IsNull(rstProjSoum.Fields("NbrePersonne")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblNbrePersonne").Caption = rstProjSoum.Fields("NbrePersonne")
5Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblNbrePersonne").Caption = "0"
5End If

5 If Not IsNull(rstProjSoum.Fields("TempsHebergement")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblTempsHebergement").Caption = rstProjSoum.Fields("TempsHebergement")
5Else
50  DR_SoumissionMec.Sections("Section5").Controls("lblTempsHebergement").Caption = "0"
50  End If

50  If Not IsNull(rstProjSoum.Fields("TauxHebergement1")) Then
50  DR_SoumissionMec.Sections("Section5").Controls("lblTauxHebergement1").Caption = rstProjSoum.Fields("TauxHebergement1")
50  Else
50  DR_SoumissionMec.Sections("Section5").Controls("lblTauxHebergement1").Caption = "0"
50  End If

50  If Not IsNull(rstProjSoum.Fields("TauxHebergement2")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblTauxHebergement2").Caption = rstProjSoum.Fields("TauxHebergement2")
51Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblTauxHebergement2").Caption = "0"
5 End If
 
5 If Not IsNull(rstProjSoum.Fields("TempsRepas")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblTempsRepas").Caption = rstProjSoum.Fields("TempsRepas")
5 Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblTempsRepas").Caption = "0"
5 End If

5 If Not IsNull(rstProjSoum.Fields("TauxRepas")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblTauxRepas").Caption = rstProjSoum.Fields("TauxRepas")
5 Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblTauxRepas").Caption = "0"
5 End If

If Not IsNull(rstProjSoum.Fields("TempsTransport")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTransport").Caption = rstProjSoum.Fields("TempsTransport")
Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTransport").Caption = "0"
End If

51  If Not IsNull(rstProjSoum.Fields("TauxTransport")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxTransport").Caption = rstProjSoum.Fields("TauxTransport")
5 Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblTauxTransport").Caption = "0"
5 End If

5 If Not IsNull(rstProjSoum.Fields("TempsUniteMobile")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblTempsUniteMobile").Caption = rstProjSoum.Fields("TempsUniteMobile")
5 Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblTempsUniteMobile").Caption = "0"
5 End If

5 If Not IsNull(rstProjSoum.Fields("TauxUniteMobile")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblTauxUniteMobile").Caption = rstProjSoum.Fields("TauxUniteMobile")
5 Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblTauxUniteMobile").Caption = "0"
5 End If
527End If

52  DR_SoumissionMec.Sections("Section5").Controls("lblPrixEmballage").Caption = rstProjSoum.Fields("PrixEmballage")
528DR_SoumissionMec.Sections("Section5").Controls("lblPrixManuel").Caption = rstProjSoum.Fields("Total_Manuel")

52  DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsAR").Caption = Conversion(rstProjSoum.Fields("total_temps"), MODE_ARGENT)
529DR_SoumissionMec.Sections("Section5").Controls("lblTotalPieceAR").Caption = Conversion(rstProjSoum.Fields("total_piece"), MODE_ARGENT)
52  DR_SoumissionMec.Sections("Section5").Controls("lblProfit").Caption = Conversion((rstProjSoum.Fields("profit") - 1) * 100, MODE_POURCENT)
530DR_SoumissionMec.Sections("Section5").Controls("lblTotalProfit").Caption = Conversion(rstProjSoum.Fields("total_profit"), MODE_ARGENT)
530 DR_SoumissionMec.Sections("Section5").Controls("lblImprevue").Caption = Conversion(rstProjSoum.Fields("imprevue"), MODE_POURCENT)
53 DR_SoumissionMec.Sections("Section5").Controls("lblImprevueAR").Caption = Conversion(rstProjSoum.Fields("total_imprevue"), MODE_ARGENT)
53 DR_SoumissionMec.Sections("Section5").Controls("lblCommission").Caption = Conversion(rstProjSoum.Fields("commission"), MODE_POURCENT)
53 DR_SoumissionMec.Sections("Section5").Controls("lblCommissionAR").Caption = Conversion(rstProjSoum.Fields("total_commission"), MODE_ARGENT)

53 If m_eType = TYPE_PROJET Then
5 If Not IsNull(rstProjSoum.Fields("PrixRéception")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblPrixReception").Caption = Conversion(rstProjSoum.Fields("PrixRéception"), MODE_ARGENT)
5 Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblPrixReception").Caption = Conversion(0, MODE_ARGENT)
5 End If

5 If Not IsNull(rstProjSoum.Fields("IDSoumission")) Then
5 Set rstPrixSoum = New ADODB.Recordset

5 Call rstPrixSoum.Open("SELECT PrixTotal FROM GrbSoumissionMec WHERE IDSoumission = '" & rstProjSoum.Fields("IDSoumission") & "'", g_connData, adOpenDynamic, adLockOptimistic)

5 If Not rstPrixSoum.EOF Then
5 If Not IsNull(rstPrixSoum.Fields("PrixTotal")) Then
5 DR_SoumissionMec.Sections("Section5").Controls("lblPrixSoumission").Caption = Conversion(rstPrixSoum.Fields("PrixTotal"), MODE_ARGENT)
5 Else
5 DR_SoumissionMec.Sections("Section5").Controls("lblPrixSoumission").Caption = Conversion("0", MODE_ARGENT)
5 End If
5 Else
54 DR_SoumissionMec.Sections("Section5").Controls("lblPrixSoumission").Caption = Conversion("0", MODE_ARGENT)
54 End If

54 Call rstPrixSoum.Close
54 Set rstPrixSoum = Nothing
54 Else
54 DR_SoumissionMec.Sections("Section5").Controls("lblPrixSoumission").Caption = Conversion("0", MODE_ARGENT)
54 End If
54 End If

54 If m_eType = TYPE_PROJET Then
54 dblTotalHebergement = 0
54 dblTotalRepas = 0
54  dblTotalTransport = 0
54  dblTotalUniteMobile = 0
547Else
54  If Not IsNull(rstProjSoum.Fields("TotalHebergement")) Then
54  dblTotalHebergement = CDbl(rstProjSoum.Fields("TotalHebergement"))
54  Else
54  dblTotalHebergement = 0
54  End If
 
550 If Not IsNull(rstProjSoum.Fields("TotalRepas")) Then
55 dblTotalRepas = CDbl(rstProjSoum.Fields("TotalRepas"))
 Else
dblTotalRepas = 0
 End If

5 If Not IsNull(rstProjSoum.Fields("TempsTransport")) And Not IsNull(rstProjSoum.Fields("TauxTransport")) Then
...
55  Else
55  dblTotalUniteMobile = 0
55  End If
55  End If

558dblPrixEmballage = CDbl(Replace(rstProjSoum.Fields("PrixEmballage"), ".", ","))
 
55  dblTotalReste = dblTotalHebergement + dblTotalRepas + dblTotalTransport + dblTotalUniteMobile + dblPrixEmballage

559dblTotalAutre = dblTotalReste + CDbl(rstProjSoum.Fields("total_manuel"))
 
55  DR_SoumissionMec.Sections("Section5").Controls("lblAutre").Caption = Conversion(CStr(dblTotalAutre), MODE_ARGENT)
 
560DR_SoumissionMec.Sections("Section5").Controls("lblGrandTotalAR").Caption = Conversion(rstProjSoum.Fields("prixtotal"), MODE_ARGENT)
 
560 If rstProjSoum.Fields("MontantForfait") <> "" Then
5  DR_SoumissionMec.Sections("Section5").Controls("shpCadreForfait").Visible = True
5  DR_SoumissionMec.Sections("Section5").Controls("lblTitreForfait").Visible = True
5  DR_SoumissionMec.Sections("Section5").Controls("lblForfait").Visible = True

5  DR_SoumissionMec.Sections("Section5").Controls("lblTitreForfait").Caption = DR_SoumissionMec.Sections("Section5").Controls("lblTitreForfait").Caption & " ( " & rstProjSoum.Fields("InitialeForfait") & " )"
5  DR_SoumissionMec.Sections("Section5").Controls("lblForfait").Caption = rstProjSoum.Fields("MontantForfait")
5  Else
5  DR_SoumissionMec.Sections("Section5").Controls("shpCadreForfait").Visible = False
5  DR_SoumissionMec.Sections("Section5").Controls("lblTitreForfait").Visible = False
5  DR_SoumissionMec.Sections("Section5").Controls("lblForfait").Visible = False
5  End If
...
566DR_SoumissionMec.Orientation = rptOrientLandscape
 
56  Call DR_SoumissionMec.Show(vbModal)
 
56  Call rstImpProjSoum.Close
56  Set rstImpProjSoum = Nothing

56  Set rstTemp = Nothing
...
56  wOups "frmProjSoumMec", "ImprimerProjSoum", Err, Err.number, Err.Description
End Sub
...
1  bAjouterSection = False
 ...
 rstImpListePiece.Fields("Section") = rstTemp.Fields(sSection)
 Else
 rstImpListePiece.Fields("Section") = " "
4 End If
...
60 Loop
 ...
 ''''''''''''''''''''''''''''''''''''''''''''''''''
  ...
  Set DR_Liste_piece.DataSource = rstImpListePiece
 
  Call TraduireImpressionListePiece
 
 'Affiche la date
  DR_Liste_piece.Sections("section3").Controls("lbldate").Caption = ConvertDate(Date)

 'Affiche l'entête
  DR_Liste_piece.Sections("section4").Controls("lblsoumission").Caption = sNoSoumission
 
  If m_eType = TYPE_PROJET Then
  DR_Liste_piece.Sections("section4").Controls("lblprojet").Caption = rstProjSoum.Fields("IDProjet")
  Else
6  DR_Liste_piece.Sections("section4").Controls("lblProjet").Caption = vbNullString
6  End If
 
6  DR_Liste_piece.Sections("section4").Controls("lbldescription").Caption = rstProjSoum.Fields("Description")
 
6  Call rstTemp.Open("SELECT NomClient FROM GrbClient WHERE IDClient = " & rstProjSoum.Fields("IDClient"), g_connData, adOpenDynamic, adLockOptimistic)
 
6  DR_Liste_piece.Sections("section4").Controls("lblclient").Caption = rstTemp.Fields("NomClient")
 
6  Call rstTemp.Close
 
6  Call rstTemp.Open("SELECT NomContact FROM GrbContact WHERE IDContact = " & rstProjSoum.Fields("IDContact"), g_connData, adOpenDynamic, adLockOptimistic)
 
6  DR_Liste_piece.Sections("Section4").Controls("lblcontact").Caption = rstTemp.Fields("NomContact")
 
70 Call rstTemp.Close
 
 'Affiche le rapport liste des pieces
70 DR_Liste_piece.Orientation = rptOrientPortrait
...
Oups:
  ...
  wOups "frmProjSoumMec", "ImprimerListePieces", Err, Err.number, Err.Description
End Sub
...
10 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureReel").Caption = "0"
...
Do While Not rstTotal.EOF
 ...
 Case "Coupe": DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeReel").Caption = Round(rstTotal.Fields("Total"), 2)
 Case "Machinage": DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageReel").Caption = Round(rstTotal.Fields("Total"), 2)
 Case "Soudure": DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureReel").Caption = Round(rstTotal.Fields("Total"), 2)
 Case "Assemblage": DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageReel").Caption = Round(rstTotal.Fields("Total"), 2)
 Case "Peinture": DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureReel").Caption = Round(rstTotal.Fields("Total"), 2)
 Case "Test": DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestReel").Caption = Round(rstTotal.Fields("Total"), 2)
 Case "Installation": DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationReel").Caption = Round(rstTotal.Fields("Total"), 2)
 Case "Formation": DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationReel").Caption = Round(rstTotal.Fields("Total"), 2)
1  Case "Gestion": DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionReel").Caption = Round(rstTotal.Fields("Total"), 2)
 Case "Shipping": DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingReel").Caption = Round(rstTotal.Fields("Total"), 2)
 End Select
 End If
...
If Not IsNull(rstTotal.Fields("Total")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHReel").Caption = Round(rstTotal.Fields("Total"), 2)
Else
...
wOups "frmProjSoumMec", "CalculerTempsReels", Err, Err.number, Err.Description
End Sub
...
10 wOups "frmProjSoumMec", "TraduireImpressionListePiece", Err, Err.number, Err.Description
End Sub
...
Private Sub TraduireImpressionSoumission()
 ...
 '************************************************************************************************
  ...
  'DR_SoumissionMec.Sections("Section2").Controls("lblTitrePrixListe").Caption = "Listed price"
  'DR_SoumissionMec.Sections("Section2").Controls("lblTitreEscompte").Caption = "Discount"
DR_SoumissionMec.Sections("Section2").Controls("lblTitreCoutant").Caption = "Cost"
1 DR_SoumissionMec.Sections("Section2").Controls("lblTitreFournisseur").Caption = "Supplier"
...
1  DR_SoumissionMec.Sections("Section5").Controls("lblTitreTransportUniteMobile").Caption = "Mobile unit freight :"
...
3 DR_SoumissionMec.Sections("Section5").Controls("lblTitreImprevue").Caption = "Unforeseen:"
...
4 DR_SoumissionMec.Sections("Section2").Controls("lblTitreNoItem").Caption = "No. item"
4 DR_SoumissionMec.Sections("Section2").Controls("lblTitreDescription").Caption = "Description"
4 DR_SoumissionMec.Sections("Section2").Controls("lblTitreManufacturier").Caption = "Manufacturier"
4 'DR_SoumissionMec.Sections("Section2").Controls("lblTitrePrixListe").Caption = "Prix de liste"
4 'DR_SoumissionMec.Sections("Section2").Controls("lblTitreEscompte").Caption = "Escompte"
4 DR_SoumissionMec.Sections("Section2").Controls("lblTitreCoutant").Caption = "Coûtant"
4 DR_SoumissionMec.Sections("Section2").Controls("lblTitreFournisseur").Caption = "Fournisseur"
4 DR_SoumissionMec.Sections("Section2").Controls("lblTitreTotal").Caption = "Total"
...
4 DR_SoumissionMec.Sections("Section5").Controls("lblTitreMachinage").Caption = "Machinage :"
4 DR_SoumissionMec.Sections("Section5").Controls("lblTitreCoupePreparation").Caption = "Coupe et préparation :"
4 DR_SoumissionMec.Sections("Section5").Controls("lblTitreAssemblageSoudure").Caption = "Soudure et meulage :"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTitreAssemblageSysteme").Caption = "Assemblage des systèmes :"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTitrePeintureFinition").Caption = "Peinture et finition :"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTitreTestFinal").Caption = "Tests finaux :"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTitreGestion").Caption = "Gestion du projet :"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTitreShipping").Caption = "Expédition :"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTitreConceptionDessin").Caption = "Conception et dessin :"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTitreFormation").Caption = "Formation du personnel :"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTitreInstallation").Caption = "Installation :"
50 DR_SoumissionMec.Sections("Section5").Controls("lblTitreNbrePersonne").Caption = "Nombre de personnes :"
5 DR_SoumissionMec.Sections("Section5").Controls("lblTitreHebergement1").Caption = "Hébergement (1 lit):"
...
5  DR_SoumissionMec.Sections("Section5").Controls("lblHeure4").Caption = "Heures"
5  DR_SoumissionMec.Sections("Section5").Controls("lblHeure5").Caption = "Heures"
5  DR_SoumissionMec.Sections("Section5").Controls("lblHeure6").Caption = "Heures"
5  DR_SoumissionMec.Sections("Section5").Controls("lblHeure7").Caption = "Heures"
5  DR_SoumissionMec.Sections("Section5").Controls("lblHeure8").Caption = "Heures"
5  DR_SoumissionMec.Sections("Section5").Controls("lblHeure9").Caption = "Heures"
5  DR_SoumissionMec.Sections("Section5").Controls("lblHeure10").Caption = "Heures"
5  DR_SoumissionMec.Sections("Section5").Controls("lblHeure11").Caption = "Heures"
60 DR_SoumissionMec.Sections("Section5").Controls("lblHeure12").Caption = "Heures"
...
6  DR_SoumissionMec.Sections("Section5").Controls("lblTitrePrixSoumission").Caption = "$ Soumission"
6  DR_SoumissionMec.Sections("Section5").Controls("lblTitreForfait").Caption = "Forfait"
6  End If
...
6  wOups "frmProjSoumMec", "TraduireImpressionSoumission", Err, Err.number, Err.Description
End Sub
...
1  If cmbProjSoum.ListIndex > -1 Then
 If m_eType = TYPE_SOUMISSION Then
 If VerifierSiDejaProjet = True Then
 Call MsgBox("Vous ne pouvez pas modifier cette soumission, le projet a déjà été crée!", vbOKOnly, "Erreur")
...
wOups "frmProjSoumMec", "cmdModifier_Click", Err, Err.number, Err.Description
End Sub
...
Private Sub InitialiserNouveauxTaux()
 ...
 Call rstConfig.Open("SELECT TauxDessinMec, TauxCoupe, TauxMachinage, TauxSoudure, TauxAssemblageMec, TauxPeinture, TauxTestMec, TauxFormationMec, TauxInstallationMec, TauxGestionProjetsMec, TauxShippingMec, Hebergement1, Hebergement2, Repas, Standard, UniteMobile FROM GrbConfig", g_connData, adOpenDynamic, adLockOptimistic)
...
Else
 ...
 m_sTauxUniteMobile = rstConfig.Fields("UniteMobile")
3  End If
...
3  wOups "frmProjSoumMec", "InitialiserNouveauxTaux", Err, Err.number, Err.Description
End Sub
...
1  If m_eType = TYPE_SOUMISSION Then
 If VerifierSiDejaProjet = True Then
 Call MsgBox("Vous ne pouvez pas supprimer cette soumission, le projet a déjà été crée!", vbOKOnly, "Erreur")
 ...
 Call rstProjet.Open("SELECT IDSoumission FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'", g_connData, adOpenForwardOnly, adLockReadOnly)
 ...
 'Efface les Pièces
 Call g_connData.Execute("DELETE * FROM GrbProjet_Pieces WHERE IDProjet = '" & txtNoProjSoum.Text & "' AND Type = 'M'")
...
4 Call rstProjSoum.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'", g_connData, adOpenForwardOnly, adLockReadOnly)
...
4  Call g_connData.Execute("DELETE * FROM GrbProjet_Modif WHERE IDProjet = '" & txtNoProjSoum.Text & "' AND Type = 'M'")
 
 'Efface le projet
4  Call g_connData.Execute("DELETE * FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'")
 
 'Efface le projet dans la table GrbProjSoum
...
50 End If
 ...
 Else
 'Efface les pièces
 Call g_connData.Execute("DELETE * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & txtNoProjSoum.Text & "' AND Type = 'M'")
 
 'Efface les modifications
 Call g_connData.Execute("DELETE * FROM GrbSoumission_Modif WHERE IDSoumission = '" & txtNoProjSoum.Text & "' AND Type = 'M'")
 
 'Efface la soumission
 Call g_connData.Execute("DELETE * FROM GrbSoumissionMec WHERE IDSoumission = '" & txtNoProjSoum.Text & "'")
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdSupprimer_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "Form_Load", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirColonnes()
 ...
 'Si les bonnes colonnes sont déjà toutes affichées
  If lvwSoumission.ColumnHeaders.count =   Then
  Exit Sub
  End If
  Else
  m_bDroitPrix = True
 ...
 'Si les bonnes colonnes sont déjà toutes affichées
If lvwSoumission.ColumnHeaders.count = 15 Then
Exit Sub
 End If
End If
...
Call lvwSoumission.ColumnHeaders.Add(, , "No. Item", 2200)
...
If bCacherPrix = False Then
 ...
 Call lvwSoumission.ColumnHeaders.Add(, , "Profit", 920.1261, vbRightJustify)
 End If

1  Call lvwSoumission.ColumnHeaders.Add(, , "Commentaire", 1000)
...
Call lvwSoumission.ColumnHeaders.Add(, , "Provenance", 1440)

Exit Sub

Oups:

wOups "frmProjSoumMec", "RemplirColonnes", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "BarrerChamps", Err, Err.number, Err.Description
End Sub
...
10 Call lvwSoumission.ListItems.Clear

Exit Sub

Oups:

wOups "frmProjSoumMec", "ViderChamps", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirComboProjSoum(ByVal sNoProjSoum As String)
 ...
 Call rstProjSoum.Open("SELECT IDProjet FROM GrbProjetMec INNER JOIN GrbProjSoum ON GrbProjetMec.IDProjet = GrbProjSoum.IDProjSoum WHERE Ouvert = True ORDER BY IDProjet DESC", g_connData, adOpenDynamic, adLockOptimistic)
 Else
 Call rstProjSoum.Open("SELECT IDProjet FROM GrbProjetMec ORDER BY IDProjet DESC", g_connData, adOpenDynamic, adLockOptimistic)
 End If
 Else
  If cmbOuvertFerme.ListIndex = I_CMB_OUVERT Then
  Call rstProjSoum.Open("SELECT IDSoumission FROM GrbSoumissionMec INNER JOIN GrbProjSoum ON GrbSoumissionMec.IDSoumission = GrbProjSoum.IDProjSoum WHERE Ouvert = True ORDER BY IDSoumission DESC", g_connData, adOpenDynamic, adLockOptimistic)
  Else
  Call rstProjSoum.Open("SELECT IDSoumission FROM GrbSoumissionMec ORDER BY IDSoumission DESC", g_connData, adOpenDynamic, adLockOptimistic)
  End If
  End If
...
Oups:
 ...
 wOups "frmProjSoumMec", "RemplirComboProjSoum", Err, Err.number, Err.Description
End Sub
...
Private Sub CalculerPrixReel(ByVal sNoItem As String)
 ...
 Call rstConfig.Close
  ...
  Call rstPieceFRS.Open("SELECT PrixReel, PRIX_NET, PRIX_SP, DeviseMonétaire FROM GrbPiecesFRS WHERE PIECE = '" & Replace(sNoItem, "'", "''") & "' AND Type = 'M'", g_connData, adOpenDynamic, adLockOptimistic)
...
1 If rstPieceFRS.Fields("DeviseMonétaire") = "USA" Then
...
Oups:
 ...
 wOups "frmProjSoumMec", "CalculerPrixReel", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "RemplirComboFournisseur", Err, Err.number, Err.Description
End Sub
...
If m_bPieceInutile = True Or m_bChangementFRS = True Then
 Call rstPieceFRS.Open("SELECT GrbPiecesFRS.*, GrbFournisseur.NomFournisseur FROM GrbPiecesFRS INNER JOIN GrbFournisseur ON GrbPiecesFRS.IDFRS = GrbFournisseur.IDFRS WHERE PIECE = '" & Trim$(Replace(lvwSoumission.SelectedItem.SubItems(I_COL_SOUM_PIECE), "'", "''")) & "' AND Type = 'M' ORDER BY CDbl(PrixReel)", g_connData, adOpenDynamic, adLockOptimistic)
Else
If m_bRecherchePiece = True Then
 Call rstPieceFRS.Open("SELECT GrbPiecesFRS.*, GrbFournisseur.NomFournisseur FROM GrbPiecesFRS INNER JOIN GrbFournisseur ON GrbPiecesFRS.IDFRS = GrbFournisseur.IDFRS WHERE PIECE = '" & Trim$(Replace(lvwPieceTrouve.SelectedItem.SubItems(I_COL_RECH_NO_ITEM), "'", "''")) & "' AND Type = 'M' ORDER BY CDbl(PrixReel)", g_connData, adOpenDynamic, adLockOptimistic)
 Else
 Call rstPieceFRS.Open("SELECT GrbPiecesFRS.*, GrbFournisseur.NomFournisseur FROM GrbPiecesFRS INNER JOIN GrbFournisseur ON GrbPiecesFRS.IDFRS = GrbFournisseur.IDFRS WHERE PIECE = '" & Trim$(Replace(lvwPieces.SelectedItem.SubItems(I_COL_PIECES_NO_ITEM), "'", "''")) & "' AND Type = 'M' ORDER BY CDbl(PrixReel)", g_connData, adOpenDynamic, adLockOptimistic)
 End If
End If
...
4  itmFRS.ListSubItems(I_COL_FRS_PRIX_LIST).ForeColor = lColor
 ...
 'Escompte
4  If rstPieceFRS.Fields("ESCOMPTE") <> vbNullString Then
50 itmFRS.SubItems(I_COL_FRS_ESCOMPTE) = Conversion(Replace(rstPieceFRS.Fields("ESCOMPTE"), "_", vbNullString) * 100, MODE_POURCENT)
5 End If
...
5  Set rstInv = New ADODB.Recordset

5  Call rstInv.Open("SELECT * FROM GrbInventaireMec WHERE TRIM(NoItem) = '" & Trim$(Replace(rstPieceFRS.Fields("PIECE"), "'", "''")) & "'", g_connData, adOpenForwardOnly, adLockReadOnly)
 
60 If Not rstInv.EOF Then
 ...
 'Pour garder en mémoire le prix d'origine, je le mets dans le
 'tag de la colonne Prix Listé
  If itmFRS.SubItems(I_COL_FRS_PRIX_LIST) = vbNullString Then
  itmFRS.SubItems(I_COL_FRS_PRIX_LIST) = " "
6  End If
...
6  End If
6  Else
70 itmFRS.ListSubItems(I_COL_FRS_PRIX_LIST).Tag = Replace(rstPieceFRS.Fields("PRIX_SP"), ".", ",")
  End If
...
80 Else
  ...
  End If
   ...
   If bAjouterDP = True Then
   Set itmFRS = lvwfournisseur.ListItems.Add

8  itmFRS.Text = "CHOISIR ULTÉRIEUREMENT"
8  itmFRS.SubItems(I_COL_FRS_PRIX_LIST) = " "
8  itmFRS.SubItems(I_COL_FRS_ESCOMPTE) = " "
8  itmFRS.SubItems(I_COL_FRS_PRIX_NET) = " "
90 itmFRS.SubItems(I_COL_FRS_PRIX_SP) = " "
90 End If
...
Oups:
  ...
  wOups "frmProjSoumMec", "RemplirListViewFournisseur", Err, Err.number, Err.Description
End Sub
...
1  bDebut = True
 ...
 Else
 itmPieces.SubItems(I_COL_PIECES_DESCR_EN) = vbNullString
 End If
End If
...
4 wOups "frmProjSoumMec", "RemplirListViewPieces", Err, Err.number, Err.Description
End Sub
...
If lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_PIECE) = cmbSections.Text Then
 ...
 If lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_DESCR) = sSousSection And lvwSoumission.ListItems(iCompteur).ListSubItems(I_COL_SOUM_DESCR).Bold = True Then
...
Oups:
 ...
 wOups "frmProjSoumMec", "TrouverIndexSection", Err, Err.number, Err.Description
End Function
...
Oups:
 ...
 wOups "frmProjSoumMec", "AjouterSousSection", Err, Err.number, Err.Description
End Function
...
Private Sub AjouterNegatifDansListView(ByVal dblQuantite As Double, ByVal sSousSection As String)
 ...
 Dim bQteOK As Boolean
  ...
  sNoProjet = Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 2) & m_sLiaison

If m_bRecherchePiece = True Then
Call rstProjet.Open("SELECT * FROM GrbProjet_Pieces WHERE IDProjet = '" & sNoProjet & "' AND NumItem = '" & lvwPieceTrouve.SelectedItem.SubItems(I_COL_RECH_NO_ITEM) & "' AND IDFRS = " & lvwfournisseur.SelectedItem.Tag, g_connData, adOpenDynamic, adLockOptimistic)
 Else
 Call rstProjet.Open("SELECT * FROM GrbProjet_Pieces WHERE IDProjet = '" & sNoProjet & "' AND NumItem = '" & lvwPieces.SelectedItem.SubItems(I_COL_PIECES_NO_ITEM) & "' AND IDFRS = " & lvwfournisseur.SelectedItem.Tag, g_connData, adOpenDynamic, adLockOptimistic)
 End If
End If
...
Call rstProjet.Close
2  Set rstProjet = Nothing

bSelected = False
 
 'S'il y a des items dans le ListView
2  If lvwSoumission.ListItems.count > 0 Then
...
3  If lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_QUOTER) = "Oui" Then
...
3  Else
 ...
 'On met l'id de la section dans le tag du listItem
40 itmSoum.Tag = cmbSections.ItemData(cmbSections.ListIndex) 'IDSection
...
4  Else
4  If m_bRecherchePiece = True Then
4  itmSoum.SubItems(I_COL_SOUM_DESCR) = lvwPieceTrouve.SelectedItem.SubItems(I_COL_RECH_DESCR_FR)
4  itmSoum.ListSubItems(I_COL_SOUM_DESCR).Tag = lvwPieceTrouve.SelectedItem.SubItems(I_COL_RECH_DESCR_EN)
50 Else
itmSoum.SubItems(I_COL_SOUM_DESCR) = lvwPieces.SelectedItem.SubItems(I_COL_PIECES_DESCR_FR)
 ...
 itmSoum.ListSubItems(I_COL_SOUM_MANUFACT).Tag = cmbSections.ListIndex + 1 'Ordre de la section
...
5  itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag = sPrixList
5  End If
 
5  itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).ForeColor = lColor
 
 'Si il y a un prix net, on le met l'escompte et le prix net sinon, on prend le prix
 'spécial pour mettre dans le prix net
60 If Trim$(sEscompte) <> vbNullString Then
...
6  itmSoum.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = lColor
 ...
 'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
6  itmSoum.SubItems(I_COL_SOUM_TOTAL) = Conversion(Round(Replace(itmSoum.Text, "*", vbNullString) * itmSoum.SubItems(I_COL_SOUM_PRIX_NET) * CSng(m_sProfit), 2), MODE_ARGENT, 2)
 
6  itmSoum.ListSubItems(I_COL_SOUM_TOTAL).ForeColor = lColor
 
 'Pour le profit, c'est le prix total - (prix net * quantité)
6  itmSoum.SubItems(I_COL_SOUM_PROFIT) = Conversion(CStr(Round(itmSoum.SubItems(I_COL_SOUM_TOTAL) - (itmSoum.SubItems(I_COL_SOUM_PRIX_NET) * Replace(itmSoum.Text, "*", vbNullString)), 2)), MODE_ARGENT)

6  itmSoum.ListSubItems(I_COL_SOUM_PROFIT).ForeColor = lColor

6  If itmSoum.SubItems(I_COL_SOUM_ESCOMPTE) = vbNullString Then
70 itmSoum.SubItems(I_COL_SOUM_ESCOMPTE) = " "
70 End If
...
Oups:
  ...
  wOups "frmProjSoumMec", "AjouterDansListViewSoumission", Err, Err.number, Err.Description
End Sub
...
If VerifierSiPieceExiste(sSousSection, iIndex) = True Then
 If sSousSection <> "PAS DE SOUS-SECTION" Then
 If MsgBox("Cette pièce existe déjà dans la sous-section '" & sSousSection & "' de la section '" & cmbSections.Text & "'." & vbNewLine & _
...
1  End If
 Else
 If MsgBox("Cette pièce existe déjà dans la sous-section vide de la section '" & cmbSections.Text & "'." & vbNewLine & _
 "Voulez-vous l'ajouter à nouveau ?", vbYesNo) = vbYes Then
 bAjouter = True
 Else
 bAjouter = False
...
3 End If
 ...
 'On met l'id de la section dans le tag du listItem
 itmSoum.Tag = cmbSections.ItemData(cmbSections.ListIndex) 'IDSection
...
End If
 ...
 'On met le nom de la sous-section dans le tag du no d'item
itmSoum.ListSubItems(I_COL_SOUM_PIECE).Tag = sSousSection
...
4 itmSoum.ListSubItems(I_COL_SOUM_DESCR).Tag = lvwPieceTrouve.SelectedItem.SubItems(I_COL_RECH_DESCR_EN)
4 Else
4 itmSoum.SubItems(I_COL_SOUM_DESCR) = lvwPieces.SelectedItem.SubItems(I_COL_PIECES_DESCR_FR)
4 itmSoum.ListSubItems(I_COL_SOUM_DESCR).Tag = lvwPieces.SelectedItem.SubItems(I_COL_PIECES_DESCR_EN)
4 End If
4 End If
...
4  itmSoum.ListSubItems(I_COL_SOUM_DESCR).ForeColor = lColor
 ...
 'On met le nom du fabricant dans la colonne et l'ordre de la section dans le tag
4  If m_bRecherchePiece = True Then
4  itmSoum.SubItems(I_COL_SOUM_MANUFACT) = lvwPieceTrouve.SelectedItem.SubItems(I_COL_RECH_MANUFACT)
4  Else
4  itmSoum.SubItems(I_COL_SOUM_MANUFACT) = lvwPieces.SelectedItem.SubItems(I_COL_PIECES_MANUFACT)
4  End If
 
4  itmSoum.ListSubItems(I_COL_SOUM_MANUFACT).Tag = cmbSections.ListIndex + 1 'Ordre de la section

4  itmSoum.ListSubItems(I_COL_SOUM_MANUFACT).ForeColor = lColor
 
 'Prix listé
50 If Trim$(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_PRIX_LIST)) = vbNullString Then
itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion("0", MODE_ARGENT, 4)
 Else
 If lvwfournisseur.SelectedItem.ListSubItems(I_COL_FRS_PERS_RESS).Tag = "USA" Then
 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(CStr(Round(CDbl(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_PRIX_LIST)) / CDbl(sTauxUSA), 4)), MODE_ARGENT, 4)
 Else
 If lvwfournisseur.SelectedItem.ListSubItems(I_COL_FRS_PERS_RESS).Tag = "SPA" Then
 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(CStr(Round(CDbl(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_PRIX_LIST)) / CDbl(sTauxSPA), 4)), MODE_ARGENT, 4)
 Else
 itmSoum.SubItems(I_COL_SOUM_PRIX_LIST) = Conversion(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_PRIX_LIST), MODE_ARGENT, 4)
 End If
 End If
5  End If
 
5  itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag = lvwfournisseur.SelectedItem.ListSubItems(I_COL_FRS_PRIX_LIST).Tag
 
5  itmSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).ForeColor = lColor
 
 'Si il y a un prix net, on le met l'escompte et le prix net sinon, on prend le prix
 'spécial pour mettre dans le prix net
5  If Trim$(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_PRIX_NET)) <> vbNullString Then
5  If Trim$(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_ESCOMPTE)) <> "" Then
5  itmSoum.SubItems(I_COL_SOUM_ESCOMPTE) = Conversion(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_ESCOMPTE), MODE_POURCENT)
5  Else
5  itmSoum.SubItems(I_COL_SOUM_ESCOMPTE) = Conversion(0, MODE_POURCENT)
60 End If
...
6  If lvwfournisseur.SelectedItem.ListSubItems(I_COL_FRS_PERS_RESS).Tag = "USA" Then
6  itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(CStr(Round(CDbl(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_PRIX_SP)) / CDbl(sTauxUSA), 4)), MODE_ARGENT, 4)
6  Else
6  If lvwfournisseur.SelectedItem.ListSubItems(I_COL_FRS_PERS_RESS).Tag = "USA" Then
6  itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(CStr(Round(CDbl(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_PRIX_SP)) / CDbl(sTauxSPA), 4)), MODE_ARGENT, 4)
6  Else
6  itmSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(lvwfournisseur.SelectedItem.SubItems(I_COL_FRS_PRIX_SP), MODE_ARGENT, 4)
6  End If
70 End If
  Else
  itmSoum.SubItems(I_COL_SOUM_ESCOMPTE) = Conversion("0", MODE_POURCENT)
 ...
 'On met le fournisseur dans la colonne et l'id dans le tag
  ...
  Else
  sDistrib = lvwfournisseur.SelectedItem.Text
   End If
 
   itmSoum.SubItems(I_COL_SOUM_DISTRIB) = sDistrib
7  itmSoum.ListSubItems(I_COL_SOUM_DISTRIB).Tag = lvwfournisseur.SelectedItem.Tag

7  itmSoum.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = lColor
...
7  itmSoum.ListSubItems(I_COL_SOUM_TOTAL).ForeColor = lColor
 ...
 'Pour le profit, c'est le prix total - (prix net * quantité)
7  itmSoum.SubItems(I_COL_SOUM_PROFIT) = Conversion(CStr(Round(itmSoum.SubItems(I_COL_SOUM_TOTAL) - (itmSoum.SubItems(I_COL_SOUM_PRIX_NET) * Replace(itmSoum.Text, "*", vbNullString)), 2)), MODE_ARGENT)
 
7  itmSoum.ListSubItems(I_COL_SOUM_PROFIT).ForeColor = lColor
 
80 If m_eType = TYPE_PROJET Then
  itmSoum.SubItems(I_COL_SOUM_FACTURATION) = " "
  End If
...
Private Function VerifierSiPieceExiste(ByVal sSousSection As String, ByVal iIndex As Integer) As Boolean
 ...
 If lvwSoumission.ListItems.count >= iIndex Then
 If lvwSoumission.ListItems(iIndex).ListSubItems(I_COL_SOUM_PIECE).Tag = sSousSection Then
 iCompteur = iIndex
 Else
 iCompteur = iIndex - 1
 End If
 Else
  ...
  Do While lvwSoumission.ListItems(iCompteur).ListSubItems(I_COL_SOUM_PIECE).Tag = sSousSection
  iCompteur = iCompteur - 1
  Loop
...
1 Else
 ...
 Do While lvwSoumission.ListItems(iCompteur).ListSubItems(I_COL_SOUM_PIECE).Tag = sSousSection
 If lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_PIECE) = sPiece Then
 bExiste = True
...
VerifierSiPieceExiste = bExiste

 Exit Function

Oups:

1  wOups "frmProjSoumMec", "VerifierSiPieceExiste", Err, Err.number, Err.Description
End Function
...
Oups:
  ...
  wOups "frmProjSoumMec", "VerifierEmplacement", Err, Err.number, Err.Description
End Function
...
Oups:
 ...
 wOups "frmProjSoumMec", "ValeurParDefaut", Err, Err.number, Err.Description
End Sub
...
Private Sub RemplirListViewProjSoum(ByVal sNoProjSoum As String)
 ...
 Dim lColor As Long
  ...
  If m_eType = TYPE_PROJET Then
  Call rstProjSoum.Open("SELECT * FROM GrbProjet_Pieces WHERE IDProjet = '" & sNoProjSoum & "' ORDER BY NuméroLigne", g_connData, adOpenDynamic, adLockOptimistic)
  Else
  Call rstProjSoum.Open("SELECT * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & sNoProjSoum & "' ORDER BY NuméroLigne", g_connData, adOpenDynamic, adLockOptimistic)
  End If
 
10 If m_eLangage = ANGLAIS Then
1 sSection = "NomSectionEN"
Else
 sSection = "NomSectionFR"
End If
...
4  If rstProjSoum.Fields("PieceExtraNonChargeable") = True Then
4  lColor = COLOR_ROSE
4  bBold = True
4  Else
50 If rstProjSoum.Fields("PieceExtraChargeable") = True Then
 lColor = COLOR_BLEU
 bBold = True
 Else
...
7  If m_eType = TYPE_PROJET Then
7  If g_bModificationProjetsMec = True Then
 'Facturation
...
1 If Trim(rstProjSoum.Fields("Prix_List")) <> vbNullString Then
...
1 itmProjSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).Bold = bBold
 
1 itmProjSoum.ListSubItems(I_COL_SOUM_PRIX_LIST).Tag = rstProjSoum.Fields("PrixOrigine")
 
 'Escompte
1 If Trim(rstProjSoum.Fields("Escompte")) <> vbNullString Then
1 itmProjSoum.SubItems(I_COL_SOUM_ESCOMPTE) = Conversion(rstProjSoum.Fields("Escompte"), MODE_POURCENT)
 Else
1 itmProjSoum.SubItems(I_COL_SOUM_ESCOMPTE) = " "
 End If
 
1 itmProjSoum.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor = lColor

 itmProjSoum.ListSubItems(I_COL_SOUM_ESCOMPTE).Bold = bBold
 
 'Prix net
11  If Trim(rstProjSoum.Fields("Prix_net")) <> vbNullString Then
 itmProjSoum.SubItems(I_COL_SOUM_PRIX_NET) = Conversion(rstProjSoum.Fields("Prix_net"), MODE_ARGENT, 4)
 Else
...
1 If m_eType = TYPE_PROJET Then
1 If Not IsNull(rstProjSoum.Fields("DateRéception")) Then
...
1 End If
 ...
 'Prix total
1 If Trim(rstProjSoum.Fields("Prix_total")) <> vbNullString Then
...
1 itmProjSoum.ListSubItems(I_COL_SOUM_TOTAL).Bold = bBold

 'Profit
1 If Trim(rstProjSoum.Fields("Profit_argent")) <> vbNullString Then
1 itmProjSoum.SubItems(I_COL_SOUM_PROFIT) = Conversion(Round(rstProjSoum.Fields("Profit_Argent"), 2), MODE_ARGENT)
1 Else
1 itmProjSoum.SubItems(I_COL_SOUM_PROFIT) = " "
1 End If

1 If m_eType = TYPE_PROJET Then
1 If rstProjSoum.Fields("PieceExtraNonChargeable") = True Then
1 itmProjSoum.ListSubItems(I_COL_SOUM_PROFIT).Tag = "EXTRA"
1 End If
1 End If
 
14 itmProjSoum.ListSubItems(I_COL_SOUM_PROFIT).ForeColor = lColor

14 itmProjSoum.ListSubItems(I_COL_SOUM_PROFIT).Bold = bBold

14 If Not IsNull(rstProjSoum.Fields("Commentaire")) Then
14 itmProjSoum.SubItems(I_COL_SOUM_COMMENTAIRE) = rstProjSoum.Fields("Commentaire")
14 Else
14 itmProjSoum.SubItems(I_COL_SOUM_COMMENTAIRE) = vbNullString
14 End If

14 itmProjSoum.ListSubItems(I_COL_SOUM_COMMENTAIRE).ForeColor = lColor

14 itmProjSoum.ListSubItems(I_COL_SOUM_COMMENTAIRE).Bold = bBold

14 If m_eType = TYPE_PROJET Then
14 If Not IsNull(rstProjSoum.Fields("DateCommande")) Then
14  If Trim(rstProjSoum.Fields("DateCommande")) <> "" Then
14  itmProjSoum.SubItems(I_COL_SOUM_DATE_COMMANDE) = rstProjSoum.Fields("DateCommande")
14  Else
14  itmProjSoum.SubItems(I_COL_SOUM_DATE_COMMANDE) = " "
14  End If
14  Else
14  itmProjSoum.SubItems(I_COL_SOUM_DATE_COMMANDE) = " "
14  End If

150 itmProjSoum.ListSubItems(I_COL_SOUM_DATE_COMMANDE).ForeColor = lColor

1 itmProjSoum.ListSubItems(I_COL_SOUM_DATE_COMMANDE).Bold = bBold

 itmProjSoum.ListSubItems(I_COL_SOUM_DATE_COMMANDE).Tag = rstProjSoum.Fields("NoRetour")

 If Not IsNull(rstProjSoum.Fields("DateRequise")) Then
 If Trim(rstProjSoum.Fields("DateRequise")) <> "" Then
 itmProjSoum.SubItems(I_COL_SOUM_DATE_REQUISE) = rstProjSoum.Fields("DateRequise")
 Else
...
15  itmProjSoum.ListSubItems(I_COL_SOUM_DATE_REQUISE).ForeColor = lColor

15  itmProjSoum.ListSubItems(I_COL_SOUM_DATE_REQUISE).Bold = bBold

15  itmProjSoum.ListSubItems(I_COL_SOUM_DATE_REQUISE).Tag = rstProjSoum.Fields("DateRetour")

15  If Not IsNull(rstProjSoum.Fields("NomCommande")) Then
15  itmProjSoum.SubItems(I_COL_SOUM_NOM_COMMANDE) = rstProjSoum.Fields("NomCommande")
15  Else
15  itmProjSoum.SubItems(I_COL_SOUM_NOM_COMMANDE) = vbNullString
15  End If

160 itmProjSoum.ListSubItems(I_COL_SOUM_NOM_COMMANDE).ForeColor = lColor

 itmProjSoum.ListSubItems(I_COL_SOUM_NOM_COMMANDE).Bold = bBold

 If Not IsNull(rstProjSoum.Fields("NoSéquentiel")) Then
 itmProjSoum.SubItems(I_COL_SOUM_NO_SEQUENTIEL) = rstProjSoum.Fields("NoSéquentiel")
 Else
 itmProjSoum.SubItems(I_COL_SOUM_NO_SEQUENTIEL) = vbNullString
 End If

 itmProjSoum.ListSubItems(I_COL_SOUM_NO_SEQUENTIEL).ForeColor = lColor

 itmProjSoum.ListSubItems(I_COL_SOUM_NO_SEQUENTIEL).Bold = bBold

 If Not IsNull(rstProjSoum.Fields("Provenance")) Then
 If Trim(rstProjSoum.Fields("Provenance")) <> "" Then
...
16  Else
16  itmProjSoum.SubItems(I_COL_SOUM_PROVENANCE) = ""
16  End If
16  Else
16  itmProjSoum.SubItems(I_COL_SOUM_PROVENANCE) = ""
16  End If

16  itmProjSoum.ListSubItems(I_COL_SOUM_PROVENANCE).ForeColor = lColor
 
16  itmProjSoum.ListSubItems(I_COL_SOUM_PROVENANCE).Bold = bBold
170 Else
 If Not IsNull(rstProjSoum.Fields("Provenance")) Then
 If Trim(rstProjSoum.Fields("Provenance")) <> "" Then
 itmProjSoum.SubItems(I_COL_SOUMISSION_PROV) = Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 3) & "-" & rstProjSoum.Fields("Provenance")
 Else
 itmProjSoum.SubItems(I_COL_SOUMISSION_PROV) = ""
 End If
 Else
 ...
 itmProjSoum.ListSubItems(I_COL_SOUMISSION_PROV).ForeColor = lColor
 
 itmProjSoum.ListSubItems(I_COL_SOUMISSION_PROV).Bold = bBold
1   End If
1   Else
 'Fournisseur
17  If Not IsNull(rstProjSoum.Fields("IDFRS")) And rstProjSoum.Fields("IDFRS") <> "0" Then
17  If itmProjSoum.SubItems(I_COL_SOUM_SP_PIECE) <> "Texte" And itmProjSoum.SubItems(I_COL_SOUM_SP_PIECE) <> "Text" Then
17  Call rstFRS.Open("SELECT NomFournisseur FROM GrbFournisseur WHERE IDFRS = " & rstProjSoum.Fields("IDFRS"), g_connData, adOpenDynamic, adLockOptimistic)
 
 'On affiche le nom dans la colonne
17  itmProjSoum.SubItems(I_COL_SOUM_SP_DISTRIB) = rstFRS.Fields("NomFournisseur")
 
17  itmProjSoum.ListSubItems(I_COL_SOUM_SP_DISTRIB).ForeColor = lColor

17  itmProjSoum.ListSubItems(I_COL_SOUM_SP_DISTRIB).Bold = bBold
 
 'On affiche l'ID dans le tag
180 itmProjSoum.ListSubItems(I_COL_SOUM_SP_DISTRIB).Tag = rstProjSoum.Fields("IDFRS")
 ...
 itmProjSoum.SubItems(I_COL_SOUM_SP_COMMENTAIRE) = rstProjSoum.Fields("Commentaire")
 Else
 itmProjSoum.SubItems(I_COL_SOUM_SP_COMMENTAIRE) = vbNullString
 End If
 
 itmProjSoum.ListSubItems(I_COL_SOUM_SP_COMMENTAIRE).ForeColor = lColor

1   itmProjSoum.ListSubItems(I_COL_SOUM_SP_COMMENTAIRE).Bold = bBold

1   If m_eType = TYPE_PROJET Then
1   If Not IsNull(rstProjSoum.Fields("DateCommande")) Then
1   If Trim(rstProjSoum.Fields("DateCommande")) <> "" Then
18  itmProjSoum.SubItems(I_COL_SOUM_SP_DATE_COMMANDE) = rstProjSoum.Fields("DateCommande")
18  Else
18  itmProjSoum.SubItems(I_COL_SOUM_SP_DATE_COMMANDE) = " "
18  End If
190 Else
 itmProjSoum.SubItems(I_COL_SOUM_SP_DATE_COMMANDE) = " "
1  End If

1  itmProjSoum.ListSubItems(I_COL_SOUM_SP_DATE_COMMANDE).ForeColor = lColor

1  itmProjSoum.ListSubItems(I_COL_SOUM_SP_DATE_COMMANDE).Bold = bBold

1  itmProjSoum.ListSubItems(I_COL_SOUM_SP_DATE_COMMANDE).Tag = rstProjSoum.Fields("NoRetour")

1  If Not IsNull(rstProjSoum.Fields("DateRequise")) Then
1  If Trim(rstProjSoum.Fields("DateRequise")) <> "" Then
1  itmProjSoum.SubItems(I_COL_SOUM_SP_DATE_REQUISE) = rstProjSoum.Fields("DateRequise")
1  Else
1  itmProjSoum.SubItems(I_COL_SOUM_SP_DATE_REQUISE) = " "
1  End If
 Else
1   itmProjSoum.SubItems(I_COL_SOUM_SP_DATE_REQUISE) = " "
 End If

1   itmProjSoum.ListSubItems(I_COL_SOUM_SP_DATE_REQUISE).ForeColor = lColor

 itmProjSoum.ListSubItems(I_COL_SOUM_SP_DATE_REQUISE).Bold = bBold

1   itmProjSoum.ListSubItems(I_COL_SOUM_SP_DATE_REQUISE).Tag = rstProjSoum.Fields("DateRetour")

 itmProjSoum.SubItems(I_COL_SOUM_SP_NOM_COMMANDE) = rstProjSoum.Fields("NomCommande")

19  itmProjSoum.ListSubItems(I_COL_SOUM_SP_NOM_COMMANDE).ForeColor = lColor

200 itmProjSoum.ListSubItems(I_COL_SOUM_SP_NOM_COMMANDE).Bold = bBold

 itmProjSoum.SubItems(I_COL_SOUM_SP_NO_SEQUENTIEL) = rstProjSoum.Fields("NoSéquentiel")

 itmProjSoum.ListSubItems(I_COL_SOUM_SP_NO_SEQUENTIEL).ForeColor = lColor

 itmProjSoum.ListSubItems(I_COL_SOUM_SP_NO_SEQUENTIEL).Bold = bBold

 If Not IsNull(rstProjSoum.Fields("Provenance")) Then
 If Trim(rstProjSoum.Fields("Provenance")) <> "" Then
 itmProjSoum.SubItems(I_COL_SOUM_SP_PROVENANCE) = Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 3) & "-" & rstProjSoum.Fields("Provenance")
 Else
 itmProjSoum.SubItems(I_COL_SOUM_SP_PROVENANCE) = ""
 End If
 Else
20  itmProjSoum.SubItems(I_COL_SOUM_SP_PROVENANCE) = ""
20  End If

20  itmProjSoum.ListSubItems(I_COL_SOUM_SP_PROVENANCE).ForeColor = lColor

20  itmProjSoum.ListSubItems(I_COL_SOUM_SP_PROVENANCE).Bold = bBold
20  Else
20  If Not IsNull(rstProjSoum.Fields("Provenance")) Then
20  If Trim(rstProjSoum.Fields("Provenance")) <> "" Then
20  itmProjSoum.SubItems(I_COL_SOUMISSION_SP_PROV) = Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 3) & "-" & rstProjSoum.Fields("Provenance")
 Else
 itmProjSoum.SubItems(I_COL_SOUMISSION_SP_PROV) = ""
 End If
 Else
 itmProjSoum.SubItems(I_COL_SOUMISSION_SP_PROV) = ""
 End If

 itmProjSoum.ListSubItems(I_COL_SOUMISSION_SP_PROV).ForeColor = lColor

 itmProjSoum.ListSubItems(I_COL_SOUMISSION_SP_PROV).Bold = bBold
End If
2 End If
 
2 Call rstProjSoum.MoveNext
21 Loop
 
21  If lvwSoumission.ListItems.count > 0 Then
2 Call Deselect
...
21  Set rstProjSoum = Nothing

2 Set rstFRS = Nothing
21  Set rstSection = Nothing
...
22 woups"frmProjSoumMec", "RemplirListViewProjSoum", Err, Erl, sNoProjSoum)
End Sub
...
10 Dim dblTotalShipping As Double
Dim dblHebergement As Double
Dim dblRepas As Double
...
1  End If
 ...
 dblTotalCoupe = CDbl(m_sTempsCoupe) * CDbl(m_sTauxCoupe)
 dblTotalMachinage = CDbl(m_sTempsMachinage) * CDbl(m_sTauxMachinage)
dblTotalSoudure = CDbl(m_sTempsSoudure) * CDbl(m_sTauxSoudure)
 dblTotalAssemblage = CDbl(m_sTempsAssemblage) * CDbl(m_sTauxAssemblage)
dblTotalPeinture = CDbl(m_sTempsPeinture) * CDbl(m_sTauxPeinture)
...
3 If m_eType = TYPE_PROJET Then
 ...
 Else
 dblHebergement = dblHebergement + CDbl(m_sTempsHebergement) * CDbl(m_sTauxHebergement1)
 
 iNbrePersonne = iNbrePersonne - 1
 End If
 Loop
 
 dblRepas = CDbl(m_sTempsRepas) * CDbl(m_sTauxRepas) * CDbl(m_sNbrePersonne)
 dblTransport = CDbl(m_sTempsTransport) * CDbl(m_sTauxTransport)
 dblUniteMobile = CDbl(m_sTempsUniteMobile) * CDbl(m_sTauxUniteMobile)
End If
...
4  dblTotalImprevue = Round((dblPrixPieces + dblProfit) * CDbl(m_sImprevue), 2)
...
4  dblCommission = Round(dblPrixTotal * CDbl(m_sCommission), 2)
...
4  txtTotalPieces.Text = Conversion(CStr(Round(dblPrixPieces, 2)), MODE_ARGENT)
4  txtTotalTemps.Text = Conversion(CStr(Round(dblTotalTemps, 2)), MODE_ARGENT)
4  txtPrixTotal.Text = Conversion(CStr(Round(dblGrandTotal, 2)), MODE_ARGENT)
 
4  If bDemande = True Then
50 txtPrixTotal.ForeColor = COLOR_JAUNE
5 Else
 txtPrixTotal.ForeColor = COLOR_ROUGE
 End If

 txtImprevus.Text = Conversion(CStr(Round(dblTotalImprevue, 2)), MODE_ARGENT)
 txtCommission.Text = Conversion(CStr(Round(dblCommission, 2)), MODE_ARGENT)
 txtProfit.Text = Conversion(CStr(Round(dblProfit, 2)), MODE_ARGENT)
 Else
 For iCompteur = 1 To lvwSoumission.ListItems.count
 'Si ce n'est pas une section
 If lvwSoumission.ListItems(iCompteur).Tag <> vbNullString Then
 ...
 If lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_PIECE) <> vbNullString And lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_PIECE) <> "Texte" And lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_PIECE) <> "Text" Then
 If m_bDroitPrix = True Then
5  If lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_DISTRIB) = vbNullString Then
5  bDemande = True
...
Oups:
  ...
  wOups "frmProjSoumMec", "CalculerPrix", Err, Err.number, Err.Description
End Sub
...
1  End If
 ...
 Else
 Call rstPiece.Open("SELECT * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & sNoProjSoum & "' AND Type = 'M'", g_connData, adOpenDynamic, adLockOptimistic)
 End If
...
4 Case "Coupe":
4 If Not IsNull(rstProjSoum.Fields("TauxCoupe")) Then
4 dblTotalCoupe = CDbl(rstPunch.Fields("Total")) * CDbl(rstProjSoum.Fields("TauxCoupe"))
4 Else
4 dblTotalCoupe = 0
4 End If
 
4 Case "Machinage":
4 If Not IsNull(rstProjSoum.Fields("TauxMachinage")) Then
4  dblTotalMachinage = CDbl(rstPunch.Fields("Total")) * CDbl(rstProjSoum.Fields("TauxMachinage"))
4  Else
4  dblTotalMachinage = 0
4  End If
 
4  Case "Soudure":
4  If Not IsNull(rstProjSoum.Fields("TauxSoudure")) Then
4  dblTotalSoudure = CDbl(rstPunch.Fields("Total")) * CDbl(rstProjSoum.Fields("TauxSoudure"))
4  Else
50 dblTotalSoudure = 0
 End If
 
 Case "Assemblage":
 If Not IsNull(rstProjSoum.Fields("TauxAssemblage")) Then
 dblTotalAssemblage = CDbl(rstPunch.Fields("Total")) * CDbl(rstProjSoum.Fields("TauxAssemblage"))
 Else
 dblTotalAssemblage = 0
 End If
 
 Case "Peinture":
 If Not IsNull(rstProjSoum.Fields("TauxPeinture")) Then
 dblTotalPeinture = CDbl(rstPunch.Fields("Total")) * CDbl(rstProjSoum.Fields("TauxPeinture"))
 Else
5  dblTotalPeinture = 0
5  End If
...
60 Case "Installation":
  If Not IsNull(rstProjSoum.Fields("TauxInstallation")) Then
  dblTotalInstallation = CDbl(rstPunch.Fields("Total")) * CDbl(rstProjSoum.Fields("TauxInstallation"))
  Else
  dblTotalInstallation = 0
  End If
...
6  Case "Shipping":
6  If Not IsNull(rstProjSoum.Fields("TauxShipping")) Then
70 dblTotalShipping = CDbl(rstPunch.Fields("Total")) * CDbl(rstProjSoum.Fields("TauxShipping"))
  Else
  dblTotalShipping = 0
  End If
  End Select
  ...
  Set rstPunch = Nothing
  Else
  If Not IsNull(rstProjSoum.Fields("TempsDessin")) And Not IsNull(rstProjSoum.Fields("TauxDessin")) Then
   dblTotalDessin = CDbl(rstProjSoum.Fields("TempsDessin")) * CDbl(rstProjSoum.Fields("TauxDessin"))
   Else
7  dblTotalDessin = 0
7  End If

7  If Not IsNull(rstProjSoum.Fields("TempsCoupe")) And Not IsNull(rstProjSoum.Fields("TauxCoupe")) Then
7  dblTotalCoupe = CDbl(rstProjSoum.Fields("TempsCoupe")) * CDbl(rstProjSoum.Fields("TauxCoupe"))
7  Else
7  dblTotalCoupe = 0
80 End If

  If Not IsNull(rstProjSoum.Fields("TempsMachinage")) And Not IsNull(rstProjSoum.Fields("TauxMachinage")) Then
  dblTotalMachinage = CDbl(rstProjSoum.Fields("TempsMachinage")) * CDbl(rstProjSoum.Fields("TauxMachinage"))
  Else
  dblTotalMachinage = 0
  End If

  If Not IsNull(rstProjSoum.Fields("TempsSoudure")) And Not IsNull(rstProjSoum.Fields("TauxSoudure")) Then
  dblTotalSoudure = CDbl(rstProjSoum.Fields("TempsSoudure")) * CDbl(rstProjSoum.Fields("TauxSoudure"))
  Else
  dblTotalSoudure = 0
  End If
...
8  If Not IsNull(rstProjSoum.Fields("TempsPeinture")) And Not IsNull(rstProjSoum.Fields("TauxPeinture")) Then
8  dblTotalPeinture = CDbl(rstProjSoum.Fields("TempsPeinture")) * CDbl(rstProjSoum.Fields("TauxPeinture"))
8  Else
8  dblTotalPeinture = 0
90 End If
  ...
  dblTotalInstallation = CDbl(rstProjSoum.Fields("TempsInstallation")) * CDbl(rstProjSoum.Fields("TauxInstallation"))
  Else
  dblTotalInstallation = 0
  End If
 ...
 If Not IsNull(rstProjSoum.Fields("TempsGestion")) And Not IsNull(rstProjSoum.Fields("TauxGestion")) Then
   dblTotalGestion = CDbl(rstProjSoum.Fields("TempsGestion")) * CDbl(rstProjSoum.Fields("TauxGestion"))
 Else
9  dblTotalGestion = 0
 End If

10 If Not IsNull(rstProjSoum.Fields("TempsShipping")) And Not IsNull(rstProjSoum.Fields("TauxShipping")) Then
 dblTotalShipping = CDbl(rstProjSoum.Fields("TempsShipping")) * CDbl(rstProjSoum.Fields("TauxShipping"))
1 Else
 dblTotalShipping = 0
1 End If
 End If
 
1dblTotalTemps = dblTotalDessin + _
 dblTotalCoupe + _
 dblTotalMachinage + _
 dblTotalSoudure + _
 dblTotalAssemblage + _
...
10  dblUniteMobile = 0
10  Else
10  If Not IsNull(rstProjSoum.Fields("TotalHebergement")) Then
10  dblHebergement = CDbl(rstProjSoum.Fields("TotalHebergement"))
10  Else
10  dblHebergement = 0
10  End If
 
10  If Not IsNull(rstProjSoum.Fields("TotalRepas")) Then
...
1 If IsNumeric(rstProjSoum.Fields("PrixEmballage")) Then
 dblPrixEmballage = CDbl(rstProjSoum.Fields("PrixEmballage"))
1 Else
 dblPrixEmballage = 0
11  End If
...
1 dblTotalImprevue = Round((dblPrixPieces + dblProfit) * CDbl(rstProjSoum.Fields("Imprevue")), 2)
 
1 dblPrixTotal = dblPrixPieces + dblProfit + dblTotalTemps + dblTotalImprevue + dblTotalManuel + dblTotalResteTemps
 
 'Le calcul de la commission est sur les manuels (Nbre de page * prix par pages * nbre de copies) + (prix des pièces * pourcentage d'imprévus) + total des temps
1 dblCommission = Round(dblPrixTotal * CDbl(rstProjSoum.Fields("Commission")), 2)
 
 'Le prix total est le calcul des manuels (Nbre de page * prix par pages * nbre de copies) + (prix des pièces * pourcentage d'imprévus) + total des temps + total de la commission
1 dblGrandTotal = dblPrixTotal + dblCommission
 
 'Format monétaires avec 2 chiffres après la virgule
1 rstProjSoum.Fields("Total_Piece") = Conversion(CStr(Round(dblPrixPieces, 2)), MODE_ARGENT)
1 rstProjSoum.Fields("Total_Temps") = Conversion(CStr(Round(dblTotalTemps, 2)), MODE_ARGENT)
12  rstProjSoum.Fields("PrixTotal") = Conversion(CStr(Round(dblGrandTotal, 2)), MODE_ARGENT)
1 rstProjSoum.Fields("total_Imprevue") = Conversion(CStr(Round(dblTotalImprevue, 2)), MODE_ARGENT)
12  rstProjSoum.Fields("total_commission") = Conversion(CStr(Round(dblCommission, 2)), MODE_ARGENT)
1 rstProjSoum.Fields("total_profit") = Conversion(CStr(Round(dblProfit, 2)), MODE_ARGENT)

12  Call rstProjSoum.Update

1 Call rstPiece.Close
12  Set rstPiece = Nothing
12  Else
130 If m_eType = TYPE_PROJET Then
13 Call MsgBox("Le projet " & sNoProjSoum & " est inexistant!", vbOKOnly, "Erreur")
1 Else
1 Call MsgBox("La soumission " & sNoProjSoum & " est inexistant!", vbOKOnly, "Erreur")
1 End If
13 End If
...
13 wOups "frmProjSoumMec", "CalculerTotalRecordset", Err, Err.number, Err.Description
End Sub
...
4  m_bChangementFRS = False
4  Else
4  If Right$(txtNoProjSoum.Text, 2) >= "01" And Right$(txtNoProjSoum.Text, 2) <= "19" Then
4  sExtra = InputBox("Dans quel extra le retour doit être fait ? (2 chiffres seulement)")

4  If Len(sExtra) <> 2 Then
50 Call MsgBox("Format incorrect!", vbOKOnly, "Erreur")
...
5  Call rstProjet.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 2) & sExtra & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
6  Set itmAncien = lvwSoumission.SelectedItem
6  Set itmNouveau = lvwSoumission.ListItems.Add(itmAncien.Index + 1)

6  itmNouveau.Checked = itmAncien.Checked
 
 'Quantité
6  itmNouveau.Text = "-" & sQuantite

 'On met l'id de la section dans le tag du listItem
6  itmNouveau.Tag = itmAncien.Tag
    
 'No d'item
70 itmNouveau.SubItems(I_COL_SOUM_PIECE) = itmAncien.SubItems(I_COL_SOUM_PIECE)
 ...
 'Prix listé
  ...
  itmNouveau.SubItems(I_COL_SOUM_PRIX_NET) = itmAncien.SubItems(I_COL_SOUM_PRIX_NET)
 
 'On met le fournisseur dans la colonne et l'id dans le tag
  itmNouveau.SubItems(I_COL_SOUM_DISTRIB) = lvwfournisseur.SelectedItem.Text
  itmNouveau.ListSubItems(I_COL_SOUM_DISTRIB).Tag = lvwfournisseur.SelectedItem.Tag
...
7  If Right$(txtNoProjSoum.Text, 2) >= "01" And Right$(txtNoProjSoum.Text, 2) <= "19" Then
 'Pour savoir lors de l'enregistrement qu'il faut le lier avec le 81
7  itmNouveau.ListSubItems(I_COL_SOUM_PROFIT).Tag = "RETOUR " & sExtra
7  End If

7  itmNouveau.SubItems(I_COL_SOUM_DATE_COMMANDE) = " "
7  itmNouveau.SubItems(I_COL_SOUM_DATE_REQUISE) = " "
7  itmNouveau.SubItems(I_COL_SOUM_NOM_COMMANDE) = " "
80 itmNouveau.SubItems(I_COL_SOUM_NO_SEQUENTIEL) = " "
  ...
  itmNouveau.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = COLOR_NOIR
  itmNouveau.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor = COLOR_NOIR
  itmNouveau.ListSubItems(I_COL_SOUM_MANUFACT).ForeColor = COLOR_NOIR
...
8  itmNouveau.ListSubItems(I_COL_SOUM_DESCR).ForeColor = COLOR_BRUN
8  itmNouveau.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = COLOR_BRUN
8  itmNouveau.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor = COLOR_BRUN
8  itmNouveau.ListSubItems(I_COL_SOUM_MANUFACT).ForeColor = COLOR_BRUN
90 itmNouveau.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_BRUN
...
Oups:
 ...
 wOups "frmProjSoumMec", "ChoisirFournisseurMateriel", Err, Err.number, Err.Description
End Sub
...
If bDemanderSS = True Then
If m_sSousSection <> S_PAS_SOUS_SECTION Then
...
Else
4  wOups "frmProjSoumMec", "ChoisirFournisseur", Err, Err.number, Err.Description
End If
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "lvwFournisseur_DblClick", Err, Err.number, Err.Description
End Sub
...
Private Sub lvwPieces_DblClick()
 ...
 Call FrmCatalogueMec.AfficherForm(cmbPieces.Text, lvwPieces.SelectedItem.SubItems(I_COL_PIECES_MANUFACT), lvwPieces.SelectedItem.SubItems(I_COL_PIECES_NO_ITEM))

 Screen.MousePointer = vbDefault
  End If
  End If
  Else
  Call MsgBox("Il n'y a pas de sections!", vbOKOnly, "Erreur")
  End If
...
Oups:
  ...
  wOups "frmProjSoumMec", "lvwPieces_DblClick", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "AfficherListeFournisseurs", Err, Err.number, Err.Description
End Sub
...
Private Sub lvwPieces_KeyDown(KeyCode As Integer, Shift As Integer)
 ...
 If Trim$(sTexte) <> vbNullString Then
 If Len(Trim$(sTexte)) >= 2 Then
 Call RemplirListViewRecherche(I_COL_PIECES_NO_ITEM, sTexte)
...
wOups "frmProjSoumMec", "lvwPieces_KeyDown", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "lvwSoumission_DblClick", Err, Err.number, Err.Description
End Sub
...
Private Sub AjouterPrix()
 ...
 'Positionne le frame
 fraPrix.Top = lvwSoumission.Top + 500
...
Oups:
 ...
 wOups "frmProjSoumMec", "AjouterPrix", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "ModifierTexte", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "ModifierSousSection", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "ChangerFournisseurRetour", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "RechercherPieceListViewSoumission", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "lvwSoumission_ItemCheck", Err, Err.number, Err.Description
End Sub
...
2  wOups "frmProjSoumMec", "lvwSoumission_KeyDown", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "FacturerDate", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "FacturerNC", Err, Err.number, Err.Description
End Sub
...
4  End If
4  Else
50 Call MsgBox("La pièce " & lvwSoumission.ListItems(iCompteur).SubItems(I_COL_SOUM_PIECE) & " ne peut pas être supprimée!", vbOKOnly, "Erreur")
...
60 lvwSoumission.ListItems(1).Selected = True
  End If
  End If
...
Oups:
  ...
  wOups "frmProjSoumMec", "EffacerItemListViewSoumission", Err, Err.number, Err.Description
End Sub
...
Private Sub lvwSoumission_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
 ...
 If lvwSoumission.SelectedItem.Tag <> "" Then
 If lvwSoumission.SelectedItem.ListSubItems(I_COL_SOUM_PROFIT).ForeColor <> COLOR_BLEU And lvwSoumission.SelectedItem.ListSubItems(I_COL_SOUM_PROFIT).ForeColor <> COLOR_ROSE Then
 bAfficherMenu = True
 Else
 bAfficherMenu = False
 End If
...
wOups "frmProjSoumMec", "lvwSoumission_MouseDown", Err, Err.number, Err.Description
End Sub
...
4  mnuMauvaisPrix.Visible = True
4  mnuInutile.Visible = True
4  mnuTexte.Visible = True
4  mnuChangerSS.Visible = True
4  mnuFournisseur.Visible = True
4  mnuAnnulerCommande.Visible = True
4  mnuSupprimer.Visible = True
4  mnuAjouterPrix.Visible = True
50 mnuSortieMagasin.Visible = True
50 mnuQuantite.Visible = True

 mnuFacturer.Visible = bFacturer
 mnuNC.Visible = bNC
 mnuDateRequise.Visible = bDateRequise
 mnuCommentaire.Visible = bCommentaire
 mnuMauvaisPrix.Visible = bMauvaisPrix
 mnuInutile.Visible = bMaterielInutile
 mnuTexte.Visible = bTexte
 mnuChangerSS.Visible = bSousSection
 mnuFournisseur.Visible = bFournisseur
 mnuAnnulerCommande.Visible = bAnnulerCommande
5  mnuSupprimer.Visible = bSupprimer
5  mnuAjouterPrix.Visible = bAjouterPrix
5  mnuSortieMagasin.Visible = bSortieMagasin
5  mnuQuantite.Visible = bQuantite

5  Exit Sub

Oups:

5  wOups "frmProjSoumMec", "RemplirOptionsMenuRightClick", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuAjouterPrix_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuAnnulerCommande_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuChangerSS_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "mnuDateRequise_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuCommentaire_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuFacturer_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuFournisseur_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuInutile_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuMauvaisPrix", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuNC_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuQuantite_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuSortieMagasin_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuSupprimer_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mnuTexte_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "EnleverSelection", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mvwDateRequise_GotFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "txtCheminPhotos_KeyDown", Err, Err.number, Err.Description
End Sub
...
Private Sub txtPrixManuel_LostFocus()
 ...
 txtPrixManuel.Text = Replace(txtPrixManuel.Text, ".", ",")
...
Oups:
 ...
 wOups "frmProjSoumMec", "txtPrixManuel_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "txtPrixList_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "txtPrixNet_Change", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "txtPrixNet_GotFocus", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "CalculerPrixNet", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "txtPrixNet_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "ViderChamps_frs", Err, Err.number, Err.Description
End Sub
...
If txtPrixNet.Enabled = True Then
 'Ouverture du recordset
 Call rstPrix.Open("SELECT * FROM GrbPiecesFRS WHERE PIECE = '" & Replace(lvwSoumission.ListItems(CInt(fraPrix.Tag)).SubItems(I_COL_SOUM_PIECE), "'", "''") & "' AND IDFRS = " & cmbfrs.ItemData(cmbfrs.ListIndex) & " AND PRIX_NET <> ''", g_connData, adOpenDynamic, adLockOptimistic)

 If rstPrix.EOF Then
 Call rstPrix.AddNew

 rstPrix.Fields("PIECE").Value = lvwSoumission.ListItems(CInt(fraPrix.Tag)).SubItems(I_COL_SOUM_PIECE)
...
Else
 Call rstPrix.Open("SELECT * FROM GrbPiecesFRS WHERE PIECE = '" & Replace(lvwSoumission.ListItems(CInt(fraPrix.Tag)).SubItems(I_COL_SOUM_PIECE), "'", "''") & "' AND IDFRS = " & cmbfrs.ItemData(cmbfrs.ListIndex) & " AND PRIX_SP <> ''", g_connData, adOpenDynamic, adLockOptimistic)
...
wOups "frmProjSoumMec", "ModifierPrixCatalogue", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "optCAN_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "AfficherDrapeau", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "optSpain_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "optUSA_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mskEscompte_GotFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mskEscompte_LostFocus", Err, Err.number, Err.Description
End Sub
...
5  txtNbreManuel.Text = 0
5  txtPrixManuel.Text = 0

5  txtForfait.Text = ""
60 lblForfaitInitiale.Caption = ""
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdAjouter_Click", Err, Err.number, Err.Description
End Sub
...
Private Function VerifierSiOuvert(ByRef sUser As String) As Boolean
 ...
 If m_eType = TYPE_PROJET Then
 Call rstProjSoum.Open("SELECT Modification, Par FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
 Else
 Call rstProjSoum.Open("SELECT Modification, Par FROM GrbSoumissionMec WHERE IDSoumission = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
 End If
...
wOups "frmProjSoumMec", "VerifierSiOuvert", Err, Err.number, Err.Description
End Function
...
Private Sub OuvrirProjSoum(ByVal bOuvrir As Boolean)
 ...
 If IsNumeric(Right$(txtNoProjSoum.Text, 2)) Then
 If ((Right$(txtNoProjSoum.Text, 2) >= "00" And Right$(txtNoProjSoum.Text, 2) <= "19") Or (Right$(txtNoProjSoum.Text, 2) >= "80" And Right$(txtNoProjSoum.Text, 2) <= "98")) And (m_eType = TYPE_PROJET) Then
 If Right$(txtNoProjSoum.Text, 2) >= "00" And Right$(txtNoProjSoum.Text, 2) <= "19" Then
 Call rstProjSoum.Open("SELECT Modification, Par FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "' OR IDProjet = '" & Left$(txtNoProjSoum.Text, 6) & "-" & Right$(txtNoProjSoum.Text, 2) + 80 & "'", g_connData, adOpenDynamic, adLockOptimistic)
 Else
 Call rstProjSoum.Open("SELECT Modification, Par FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "' OR IDProjet = '" & Left$(txtNoProjSoum.Text, 6) & "-" & Right$("0" & Right$(txtNoProjSoum.Text, 2) - 80, 2) & "'", g_connData, adOpenDynamic, adLockOptimistic)
 End If
 Else
  If m_eType = TYPE_PROJET Then
  Call rstProjSoum.Open("SELECT Modification, Par FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
1  wOups "frmProjSoumMec", "OuvrirProjSoum", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdReset_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "lvwPieceTrouve_DblClick", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdOKPieceTrouve_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdAnnulerPieceTrouve", Err, Err.number, Err.Description
End Sub
...
Else
 Call rstPiece.Open("SELECT * FROM GrbCatalogueMec WHERE INSTR(1," & sChamps & ",'" & Replace(sTexte, "'", "''") & "')> 0 ", g_connData, adOpenDynamic, adLockOptimistic)
End If
...
1  itmPiece.SubItems(I_COL_RECH_MANUFACT) = rstPiece.Fields("FABRICANT")
 Else
...
Call rstPiece.Close
2  Set rstPiece = Nothing

Exit Sub

Oups:

2  wOups "frmProjSoumMec", "RemplirListViewRecherche", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mvwDateFacturation_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "mvwDateFacturation_DateClick", Err, Err.number, Err.Description
End Sub
...
10 Dim dblTempsShipping As Double
Dim dblTotalTemps As Double
Dim sChampsSection As String
Dim sNoProjet As String
Dim sNoSoumission As String
...
1  sNoProjet = rstProjSoum.Fields("IDProjet")
 sNoSoumission = rstProjSoum.Fields("IDSoumission")

 Set rstPiece = New ADODB.Recordset

Call rstPiece.Open("SELECT * FROM GrbProjet_Pieces WHERE IDProjet = '" & sNoProjet & "' And Type = 'M' And Facturation = '" & sNoFacture & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
Do While Not rstPiece.EOF
 ...
 rstImpProjSoum.Fields("SousSection") = sSousSection
...
4  rstImpProjSoum.Fields("NumItem") = rstPiece.Fields("NumItem")
4  rstImpProjSoum.Fields("Qté") = rstPiece.Fields("Qté")
 
4  If m_eLangage = ANGLAIS Then
4  rstImpProjSoum.Fields("Description") = rstPiece.Fields("DESC_EN")
4  Else
4  rstImpProjSoum.Fields("Description") = rstPiece.Fields("DESC_FR")
4  End If
...
4  rstImpProjSoum.Fields("MANUFACT") = rstPiece.Fields("MANUFACT")
50 'rstImpProjSoum.Fields("PRIX_LIST") = rstPiece.Fields("PRIX_LIST")
 
5 'If Trim(rstPiece.Fields("ESCOMPTE")) <> vbNullString Then
 ' rstImpProjSoum.Fields("ESCOMPTE") = Conversion(Replace(rstPiece.Fields("ESCOMPTE"), ".", ","), MODE_POURCENT)
 'Else
 ' rstImpProjSoum.Fields("ESCOMPTE") = Conversion(0, MODE_POURCENT)
 'End If
...
5  rstImpProjSoum.Fields("PRIX_TOTAL") = rstPiece.Fields("PRIX_TOTAL")
5  rstImpProjSoum.Fields("PROFIT_ARGENT") = rstPiece.Fields("PROFIT_ARGENT")
...
5  Call rstImpProjSoum.Update
 
5  iCompteurSoum = iCompteurSoum + 1
...
5  Loop
 ...
 'Ferme les tables
5  Call rstImpProjSoum.Close
 
 ''''''''''''''''''''''''''''''''''
 ' rapport soumission, met dans l'ordre de ligne
 ''''''''''''''''''''''''''''''''''''
5  Call rstImpProjSoum.Open("SELECT * FROM Grbimpression_soumission WHERE IDSoumission = '" & sNoProjet & "' ORDER BY NoLigne", g_connData, adOpenDynamic, adLockOptimistic)
 
60 Set DR_SoumissionMec.DataSource = rstImpProjSoum

60 Call CalculerPrixFacturation(sNoFacture, sCommission, sPrixTotal, sProfit, sTotalPiece, sImprevue, sTotalTemps, sAutre)
...
6  DR_SoumissionMec.Sections("Section2").Controls("lblTitreNoFacture").Visible = True
6  DR_SoumissionMec.Sections("Section2").Controls("lblNoFacture").Visible = True
 
 'Affiche la date
6  DR_SoumissionMec.Sections("section3").Controls("lbldate").Caption = ConvertDate(Date)
 
 'Affiche entete
6  DR_SoumissionMec.Sections("Section2").Controls("lblSoumission").Caption = rstProjSoum.Fields("IDSoumission")
 
6  DR_SoumissionMec.Sections("Section2").Controls("lblprojet").Caption = rstProjSoum.Fields("IDProjet")
 
6  DR_SoumissionMec.Sections("Section2").Controls("lbldescription").Caption = rstProjSoum.Fields("Description")
 
6  Call rstTemp.Open("SELECT NomClient FROM GrbClient WHERE IDClient = " & rstProjSoum.Fields("IDClient"), g_connData, adOpenDynamic, adLockOptimistic)
 
6  DR_SoumissionMec.Sections("Section2").Controls("lblclient").Caption = rstTemp.Fields("NomClient")

70 DR_SoumissionMec.Sections("Section2").Controls("lblNoFacture").Caption = sNoFacture
...
70 Call rstTemp.Close
  ...
  DR_SoumissionMec.Sections("Section2").Controls("lblcontact").Caption = rstTemp.Fields("NomContact")
 ...
 'Temps
  ...
  If Not IsNull(rstProjSoum.Fields("TauxCoupe")) Then
   DR_SoumissionMec.Sections("Section5").Controls("lblTauxCoupe").Caption = rstProjSoum.Fields("TauxCoupe")
   Else
7  DR_SoumissionMec.Sections("Section5").Controls("lblTauxCoupe").Caption = "0"
7  End If

7  If Not IsNull(rstProjSoum.Fields("TauxMachinage")) Then
7  DR_SoumissionMec.Sections("Section5").Controls("lblTauxMachinage").Caption = rstProjSoum.Fields("TauxMachinage")
7  Else
7  DR_SoumissionMec.Sections("Section5").Controls("lblTauxMachinage").Caption = "0"
80 End If
  ...
  If Not IsNull(rstProjSoum.Fields("TauxAssemblage")) Then
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxAssemblage").Caption = rstProjSoum.Fields("TauxAssemblage")
  Else
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxAssemblage").Caption = "0"
  End If
...
8  If Not IsNull(rstProjSoum.Fields("TauxTest")) Then
8  DR_SoumissionMec.Sections("Section5").Controls("lblTauxTest").Caption = rstProjSoum.Fields("TauxTest")
8  Else
8  DR_SoumissionMec.Sections("Section5").Controls("lblTauxTest").Caption = "0"
90 End If

  If Not IsNull(rstProjSoum.Fields("TauxInstallation")) Then
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxInstallation").Caption = rstProjSoum.Fields("TauxInstallation")
  Else
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxInstallation").Caption = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TauxFormation")) Then
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxFormation").Caption = rstProjSoum.Fields("TauxFormation")
  Else
  DR_SoumissionMec.Sections("Section5").Controls("lblTauxFormation").Caption = "0"
  End If

  If Not IsNull(rstProjSoum.Fields("TauxGestion")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxGestion").Caption = rstProjSoum.Fields("TauxGestion")
   Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxGestion").Caption = "0"
   End If

 If Not IsNull(rstProjSoum.Fields("TauxShipping")) Then
   DR_SoumissionMec.Sections("Section5").Controls("lblTauxShipping").Caption = rstProjSoum.Fields("TauxShipping")
 Else
9  DR_SoumissionMec.Sections("Section5").Controls("lblTauxShipping").Caption = "0"
 End If

10 If Not IsNull(rstProjSoum.Fields("TempsDessin")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = rstProjSoum.Fields("TempsDessin")
1Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = "0"
1End If
...
1 If Not IsNull(rstProjSoum.Fields("TempsMachinage")) Then
10  DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = rstProjSoum.Fields("TempsMachinage")
10  Else
10  DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = "0"
10  End If

10  If Not IsNull(rstProjSoum.Fields("TempsSoudure")) Then
10  DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = rstProjSoum.Fields("TempsSoudure")
10  Else
10  DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = "0"
110 End If
...
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = rstProjSoum.Fields("TempsInstallation")
 Else
11  DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = "0"
 End If
...
1 If Not IsNull(rstProjSoum.Fields("TempsGestion")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = rstProjSoum.Fields("TempsGestion")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = "0"
1 End If

1 If Not IsNull(rstProjSoum.Fields("TempsShipping")) Then
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = rstProjSoum.Fields("TempsShipping")
1 Else
1 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = "0"
1 End If
 
12  If Not IsNull(rstProjSoum.Fields("TempsDessin")) Then
1 If IsNumeric(rstProjSoum.Fields("TempsDessin")) Then
1 dblTempsDessin = CDbl(rstProjSoum.Fields("TempsDessin"))
1 Else
1 dblTempsDessin = 0
13 End If
1 Else
...
1 If Not IsNull(rstProjSoum.Fields("TempsCoupe")) Then
1 If IsNumeric(rstProjSoum.Fields("TempsCoupe")) Then
1 dblTempsCoupe = CDbl(rstProjSoum.Fields("TempsCoupe"))
1 Else
1 dblTempsCoupe = 0
1 End If
1 Else
...
13  If Not IsNull(rstProjSoum.Fields("TempsMachinage")) Then
1 If IsNumeric(rstProjSoum.Fields("TempsMachinage")) Then
1 dblTempsMachinage = CDbl(rstProjSoum.Fields("TempsMachinage"))
1 Else
1 dblTempsMachinage = 0
1 End If
140 Else
14 dblTempsMachinage = 0
14 End If

14 If Not IsNull(rstProjSoum.Fields("TempsSoudure")) Then
14 If IsNumeric(rstProjSoum.Fields("TempsSoudure")) Then
14 dblTempsSoudure = CDbl(rstProjSoum.Fields("TempsSoudure"))
14 Else
14 dblTempsSoudure = 0
14 End If
14 Else
14 dblTempsSoudure = 0
14 End If

14  If Not IsNull(rstProjSoum.Fields("TempsAssemblage")) Then
14  If IsNumeric(rstProjSoum.Fields("TempsAssemblage")) Then
14  dblTempsAssemblage = CDbl(rstProjSoum.Fields("TempsAssemblage"))
14  Else
14  dblTempsAssemblage = 0
14  End If
14  Else
14  dblTempsAssemblage = 0
150 End If

15 If Not IsNull(rstProjSoum.Fields("TempsPeinture")) Then
 If IsNumeric(rstProjSoum.Fields("TempsPeinture")) Then
 dblTempsPeinture = CDbl(rstProjSoum.Fields("TempsPeinture"))
 Else
 dblTempsPeinture = 0
 End If
 Else
 ...
 If Not IsNull(rstProjSoum.Fields("TempsTest")) Then
 If IsNumeric(rstProjSoum.Fields("TempsTest")) Then
15  dblTempsTest = CDbl(rstProjSoum.Fields("TempsTest"))
15  Else
15  dblTempsTest = 0
15  End If
15  Else
...
15  If Not IsNull(rstProjSoum.Fields("TempsInstallation")) Then
160 If IsNumeric(rstProjSoum.Fields("TempsInstallation")) Then
 ...
 dblTempsFormation = CDbl(rstProjSoum.Fields("TempsFormation"))
 Else
16  dblTempsFormation = 0
16  End If
16  Else
16  dblTempsFormation = 0
16  End If

16  If Not IsNull(rstProjSoum.Fields("TempsGestion")) Then
16  If IsNumeric(rstProjSoum.Fields("TempsGestion")) Then
16  dblTempsGestion = CDbl(rstProjSoum.Fields("TempsGestion"))
170 Else
 dblTempsGestion = 0
 End If
 Else
...
17  dblTotalTemps = dblTempsDessin + _
 dblTempsCoupe + _
 dblTempsMachinage + _
 dblTempsSoudure + _
 dblTempsAssemblage + _
...
17  DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHSoum").Caption = dblTotalTemps

17  DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinProj").Caption = "---"
17  DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeProj").Caption = "---"
17  DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageProj").Caption = "---"
180 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureProj").Caption = "---"
 ...
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeConc").Caption = "---"
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageConc").Caption = "---"
1   DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureConc").Caption = "---"
1   DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageConc").Caption = "---"
1   DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureConc").Caption = "---"
1   DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestConc").Caption = "---"
18  DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationConc").Caption = "---"
18  DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationConc").Caption = "---"
18  DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionConc").Caption = "---"
18  DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingConc").Caption = "---"

190 DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHConc").Caption = "---"
Else
1  If Not IsNull(rstProjSoum.Fields("TauxDessin")) Then
1  DR_SoumissionMec.Sections("Section5").Controls("lblTauxDessin").Caption = rstProjSoum.Fields("TauxDessin")
1  Else
1  DR_SoumissionMec.Sections("Section5").Controls("lblTauxDessin").Caption = "0"
1  End If

1  If Not IsNull(rstProjSoum.Fields("TauxCoupe")) Then
1  DR_SoumissionMec.Sections("Section5").Controls("lblTauxCoupe").Caption = rstProjSoum.Fields("TauxCoupe")
1  Else
1  DR_SoumissionMec.Sections("Section5").Controls("lblTauxCoupe").Caption = "0"
1  End If

 If Not IsNull(rstProjSoum.Fields("TauxMachinage")) Then
1   DR_SoumissionMec.Sections("Section5").Controls("lblTauxMachinage").Caption = rstProjSoum.Fields("TauxMachinage")
 Else
1   DR_SoumissionMec.Sections("Section5").Controls("lblTauxMachinage").Caption = "0"
 End If

1   If Not IsNull(rstProjSoum.Fields("TauxSoudure")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTauxSoudure").Caption = rstProjSoum.Fields("TauxSoudure")
19  Else
200 DR_SoumissionMec.Sections("Section5").Controls("lblTauxSoudure").Caption = "0"
 End If
...
20  If Not IsNull(rstProjSoum.Fields("TauxTest")) Then
20  DR_SoumissionMec.Sections("Section5").Controls("lblTauxTest").Caption = rstProjSoum.Fields("TauxTest")
20  Else
20  DR_SoumissionMec.Sections("Section5").Controls("lblTauxTest").Caption = "0"
20  End If

20  If Not IsNull(rstProjSoum.Fields("TauxInstallation")) Then
20  DR_SoumissionMec.Sections("Section5").Controls("lblTauxInstallation").Caption = rstProjSoum.Fields("TauxInstallation")
20  Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTauxInstallation").Caption = "0"
21End If

2 If Not IsNull(rstProjSoum.Fields("TauxFormation")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTauxFormation").Caption = rstProjSoum.Fields("TauxFormation")
2 Else
DR_SoumissionMec.Sections("Section5").Controls("lblTauxFormation").Caption = "0"
2 End If
...
21  If Not IsNull(rstProjSoum.Fields("TauxShipping")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTauxShipping").Caption = rstProjSoum.Fields("TauxShipping")
 Else
...
21  Call rstSoum.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & rstProjSoum.Fields("IDSoumission") & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
2 If Not IsNull(rstSoum.Fields("TempsCoupe")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = rstSoum.Fields("TempsCoupe")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = "0"
2 End If

2 If Not IsNull(rstSoum.Fields("TempsMachinage")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = rstSoum.Fields("TempsMachinage")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = "0"
2 End If

2 If Not IsNull(rstSoum.Fields("TempsSoudure")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = rstSoum.Fields("TempsSoudure")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = "0"
2 End If

2 If Not IsNull(rstSoum.Fields("TempsAssemblage")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = rstSoum.Fields("TempsAssemblage")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = "0"
2 End If

2 If Not IsNull(rstSoum.Fields("TempsPeinture")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = rstSoum.Fields("TempsPeinture")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = "0"
2 End If

2 If Not IsNull(rstSoum.Fields("TempsTest")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = rstSoum.Fields("TempsTest")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = "0"
2 End If

2 If Not IsNull(rstSoum.Fields("TempsInstallation")) Then
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = rstSoum.Fields("TempsInstallation")
2 Else
2 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = "0"
2 End If

24 If Not IsNull(rstSoum.Fields("TempsFormation")) Then
24 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationSoum").Caption = rstSoum.Fields("TempsFormation")
24 Else
24 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationSoum").Caption = "0"
24 End If

24 If Not IsNull(rstSoum.Fields("TempsGestion")) Then
24 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = rstSoum.Fields("TempsGestion")
24 Else
24 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = "0"
24 End If

24 If Not IsNull(rstSoum.Fields("TempsShipping")) Then
24  DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = rstSoum.Fields("TempsShipping")
24  Else
24  DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = "0"
24  End If
 
24  If Not IsNull(rstSoum.Fields("TempsDessin")) Then
24  If IsNumeric(rstSoum.Fields("TempsDessin")) Then
24  dblTempsDessin = CDbl(rstSoum.Fields("TempsDessin"))
24  Else
250 dblTempsDessin = 0
2 End If
 Else
 dblTempsDessin = 0
 End If
...
25  If Not IsNull(rstSoum.Fields("TempsMachinage")) Then
25  If IsNumeric(rstSoum.Fields("TempsMachinage")) Then
25  dblTempsMachinage = CDbl(rstSoum.Fields("TempsMachinage"))
25  Else
25  dblTempsMachinage = 0
25  End If
260 Else
 dblTempsMachinage = 0
 End If
 ...
 If IsNumeric(rstSoum.Fields("TempsSoudure")) Then
 dblTempsSoudure = CDbl(rstSoum.Fields("TempsSoudure"))
 Else
 dblTempsSoudure = 0
 End If
...
26  If Not IsNull(rstSoum.Fields("TempsAssemblage")) Then
26  If IsNumeric(rstSoum.Fields("TempsAssemblage")) Then
26  dblTempsAssemblage = CDbl(rstSoum.Fields("TempsAssemblage"))
26  Else
26  dblTempsAssemblage = 0
26  End If
26  Else
26  dblTempsAssemblage = 0
270 End If
 ...
 If Not IsNull(rstSoum.Fields("TempsPeinture")) Then
 If IsNumeric(rstSoum.Fields("TempsPeinture")) Then
 dblTempsPeinture = CDbl(rstSoum.Fields("TempsPeinture"))
 Else
 dblTempsPeinture = 0
 End If
 Else
 ...
 If Not IsNull(rstSoum.Fields("TempsTest")) Then
 If IsNumeric(rstSoum.Fields("TempsTest")) Then
2   dblTempsTest = CDbl(rstSoum.Fields("TempsTest"))
2   Else
27  dblTempsTest = 0
27  End If
27  Else
...
27  If Not IsNull(rstSoum.Fields("TempsInstallation")) Then
280 If IsNumeric(rstSoum.Fields("TempsInstallation")) Then
 dblTempsInstallation = CDbl(rstSoum.Fields("TempsInstallation"))
 Else
 dblTempsInstallation = 0
 End If
 Else
...
28  If Not IsNull(rstSoum.Fields("TempsGestion")) Then
28  If IsNumeric(rstSoum.Fields("TempsGestion")) Then
28  dblTempsGestion = CDbl(rstSoum.Fields("TempsGestion"))
290 Else
 dblTempsGestion = 0
 End If
 Else
...
2   dblTotalTemps = dblTempsDessin + _
 dblTempsCoupe + _
 dblTempsMachinage + _
 dblTempsSoudure + _
 dblTempsAssemblage + _
...
2   Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = "---"
29  DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = "---"
300 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = "---"
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = "---"
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = "---"
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = "---"
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = "---"
...
3 Call rstSoum.Close
30  Set rstSoum = Nothing
30  Else
30  DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinSoum").Caption = "---"
30  DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeSoum").Caption = "---"
30  DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageSoum").Caption = "---"
30  DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureSoum").Caption = "---"
30  DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageSoum").Caption = "---"
30  DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureSoum").Caption = "---"
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestSoum").Caption = "---"
31 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationSoum").Caption = "---"
DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationSoum").Caption = "---"
DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionSoum").Caption = "---"
DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingSoum").Caption = "---"
...
3 If Not IsNull(rstProjSoum.Fields("TempsDessinProj")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinProj").Caption = rstProjSoum.Fields("TempsDessinProj")
3 Else
DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinProj").Caption = "0"
3 End If

31  If Not IsNull(rstProjSoum.Fields("TempsCoupeProj")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeProj").Caption = rstProjSoum.Fields("TempsCoupeProj")
 Else
DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeProj").Caption = "0"
 End If

3 If Not IsNull(rstProjSoum.Fields("TempsMachinageProj")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageProj").Caption = rstProjSoum.Fields("TempsMachinageProj")
31  Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageProj").Caption = "0"
3 End If

3 If Not IsNull(rstProjSoum.Fields("TempsSoudureProj")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureProj").Caption = rstProjSoum.Fields("TempsSoudureProj")
3 Else
DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureProj").Caption = "0"
3 End If

3 If Not IsNull(rstProjSoum.Fields("TempsAssemblageProj")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageProj").Caption = rstProjSoum.Fields("TempsAssemblageProj")
3 Else
DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageProj").Caption = "0"
3 End If

32  If Not IsNull(rstProjSoum.Fields("TempsPeintureProj")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureProj").Caption = rstProjSoum.Fields("TempsPeintureProj")
32  Else
DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureProj").Caption = "0"
32  End If

3 If Not IsNull(rstProjSoum.Fields("TempsTestProj")) Then
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestProj").Caption = rstProjSoum.Fields("TempsTestProj")
3 Else
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestProj").Caption = "0"
33End If

3 If Not IsNull(rstProjSoum.Fields("TempsInstallationProj")) Then
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationProj").Caption = rstProjSoum.Fields("TempsInstallationProj")
3 Else
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationProj").Caption = "0"
3 End If

3 If Not IsNull(rstProjSoum.Fields("TempsFormationProj")) Then
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationProj").Caption = rstProjSoum.Fields("TempsFormationProj")
3 Else
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsFormationProj").Caption = "0"
3 End If

33  If Not IsNull(rstProjSoum.Fields("TempsGestionProj")) Then
DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionProj").Caption = rstProjSoum.Fields("TempsGestionProj")
33  Else
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsGestionProj").Caption = "0"
3End If

3 If Not IsNull(rstProjSoum.Fields("TempsShippingProj")) Then
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingProj").Caption = rstProjSoum.Fields("TempsShippingProj")
3 Else
3 DR_SoumissionMec.Sections("Section5").Controls("lblTempsShippingProj").Caption = "0"
34End If

34 If Not IsNull(rstProjSoum.Fields("TempsDessinProj")) Then
34 If IsNumeric(rstProjSoum.Fields("TempsDessinProj")) Then
34 dblTempsDessin = CDbl(rstProjSoum.Fields("TempsDessinProj"))
34 Else
34 dblTempsDessin = 0
34 End If
34 Else
...
34 If Not IsNull(rstProjSoum.Fields("TempsCoupeProj")) Then
34  If IsNumeric(rstProjSoum.Fields("TempsCoupeProj")) Then
34  dblTempsCoupe = CDbl(rstProjSoum.Fields("TempsCoupeProj"))
34  Else
34  dblTempsCoupe = 0
34  End If
34  Else
...
350 If Not IsNull(rstProjSoum.Fields("TempsMachinageProj")) Then
35 If IsNumeric(rstProjSoum.Fields("TempsMachinageProj")) Then
 dblTempsMachinage = CDbl(rstProjSoum.Fields("TempsMachinageProj"))
 Else
 dblTempsMachinage = 0
 End If
 Else
 ...
 dblTempsSoudure = CDbl(rstProjSoum.Fields("TempsSoudureProj"))
35  Else
35  dblTempsSoudure = 0
35  End If
35  Else
35  dblTempsSoudure = 0
35  End If

35  If Not IsNull(rstProjSoum.Fields("TempsAssemblageProj")) Then
35  If IsNumeric(rstProjSoum.Fields("TempsAssemblageProj")) Then
360 dblTempsAssemblage = CDbl(rstProjSoum.Fields("TempsAssemblageProj"))
3  Else
 dblTempsAssemblage = 0
 End If
 Else
...
36  End If
36  Else
36  dblTempsPeinture = 0
36  End If

36  If Not IsNull(rstProjSoum.Fields("TempsTestProj")) Then
36  If IsNumeric(rstProjSoum.Fields("TempsTestProj")) Then
36  dblTempsTest = CDbl(rstProjSoum.Fields("TempsTestProj"))
36  Else
370 dblTempsTest = 0
3  End If
 Else
 ...
 End If
 Else
3   dblTempsInstallation = 0
3   End If

37  If Not IsNull(rstProjSoum.Fields("TempsFormationProj")) Then
37  If IsNumeric(rstProjSoum.Fields("TempsFormationProj")) Then
37  dblTempsFormation = CDbl(rstProjSoum.Fields("TempsFormationProj"))
37  Else
37  dblTempsFormation = 0
37  End If
380 Else
dblTempsFormation = 0
 End If
 ...
 If Not IsNull(rstProjSoum.Fields("TempsGestionProj")) Then
 If IsNumeric(rstProjSoum.Fields("TempsGestionProj")) Then
 dblTempsGestion = CDbl(rstProjSoum.Fields("TempsGestionProj"))
 Else
 dblTempsGestion = 0
 End If
...
3   If Not IsNull(rstProjSoum.Fields("TempsShippingProj")) Then
3   If IsNumeric(rstProjSoum.Fields("TempsShippingProj")) Then
3   dblTempsShipping = CDbl(rstProjSoum.Fields("TempsShippingProj"))
3   Else
38  dblTempsShipping = 0
38  End If
38  Else
38  dblTempsShipping = 0
390 End If

39dblTotalTemps = dblTempsDessin + _
 dblTempsCoupe + _
 dblTempsMachinage + _
 dblTempsSoudure + _
 dblTempsAssemblage + _
 ...
 If rstProjSoum.Fields("TempsProjBarré") = True Then
 If Not IsNull(rstProjSoum.Fields("TempsDessinConc")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinConc").Caption = rstProjSoum.Fields("TempsDessinConc")
 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinConc").Caption = "0"
 End If

 If Not IsNull(rstProjSoum.Fields("TempsCoupeConc")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeConc").Caption = rstProjSoum.Fields("TempsCoupeConc")
 Else
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeConc").Caption = "0"
3   End If

 If Not IsNull(rstProjSoum.Fields("TempsMachinageConc")) Then
3   DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageConc").Caption = rstProjSoum.Fields("TempsMachinageConc")
 Else
3   DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageConc").Caption = "0"
 End If

39  If Not IsNull(rstProjSoum.Fields("TempsSoudureConc")) Then
400 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureConc").Caption = rstProjSoum.Fields("TempsSoudureConc")
40 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureConc").Caption = "0"
4 End If
...
4 If Not IsNull(rstProjSoum.Fields("TempsPeintureConc")) Then
 DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureConc").Caption = rstProjSoum.Fields("TempsPeintureConc")
4 Else
40  DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureConc").Caption = "0"
40  End If

40  If Not IsNull(rstProjSoum.Fields("TempsTestConc")) Then
40  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestConc").Caption = rstProjSoum.Fields("TempsTestConc")
40  Else
40  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestConc").Caption = "0"
40  End If

40  If Not IsNull(rstProjSoum.Fields("TempsInstallationConc")) Then
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationConc").Caption = rstProjSoum.Fields("TempsInstallationConc")
41 Else
4 DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationConc").Caption = "0"
4 End If
...
41  If Not IsNull(rstProjSoum.Fields("TempsDessinConc")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsDessinConc")) Then
4 dblTempsDessin = CDbl(rstProjSoum.Fields("TempsDessinConc"))
4 Else
4 dblTempsDessin = 0
...
4 If Not IsNull(rstProjSoum.Fields("TempsCoupeConc")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsCoupeConc")) Then
4 dblTempsCoupe = CDbl(rstProjSoum.Fields("TempsCoupeConc"))
4 Else
4 dblTempsCoupe = 0
4 End If
4 Else
...
4 If Not IsNull(rstProjSoum.Fields("TempsMachinageConc")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsMachinageConc")) Then
4 dblTempsMachinage = CDbl(rstProjSoum.Fields("TempsMachinageConc"))
4 Else
...
4 If Not IsNull(rstProjSoum.Fields("TempsSoudureConc")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsSoudureConc")) Then
4 dblTempsSoudure = CDbl(rstProjSoum.Fields("TempsSoudureConc"))
4 Else
4 dblTempsSoudure = 0
4 End If
4 Else
...
4 If Not IsNull(rstProjSoum.Fields("TempsAssemblageConc")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsAssemblageConc")) Then
4 dblTempsAssemblage = CDbl(rstProjSoum.Fields("TempsAssemblageConc"))
4 Else
4 dblTempsAssemblage = 0
4 End If
44 Else
44 dblTempsAssemblage = 0
44 End If

44 If Not IsNull(rstProjSoum.Fields("TempsPeintureConc")) Then
44 If IsNumeric(rstProjSoum.Fields("TempsPeintureConc")) Then
44 dblTempsPeinture = CDbl(rstProjSoum.Fields("TempsPeintureConc"))
44 Else
44 dblTempsPeinture = 0
44 End If
44 Else
44 dblTempsPeinture = 0
44  End If

44  If Not IsNull(rstProjSoum.Fields("TempsTestConc")) Then
44  If IsNumeric(rstProjSoum.Fields("TempsTestConc")) Then
44  dblTempsTest = CDbl(rstProjSoum.Fields("TempsTestConc"))
44  Else
44  dblTempsTest = 0
44  End If
44  Else
...
45 End If
 ...
 If Not IsNull(rstProjSoum.Fields("TempsInstallationConc")) Then
4 If IsNumeric(rstProjSoum.Fields("TempsInstallationConc")) Then
 dblTempsInstallation = CDbl(rstProjSoum.Fields("TempsInstallationConc"))
4 Else
 dblTempsInstallation = 0
4 End If
 Else
4 dblTempsInstallation = 0
 ...
 If Not IsNull(rstProjSoum.Fields("TempsFormationConc")) Then
45  If IsNumeric(rstProjSoum.Fields("TempsFormationConc")) Then
45  dblTempsFormation = CDbl(rstProjSoum.Fields("TempsFormationConc"))
45  Else
45  dblTempsFormation = 0
45  End If
45  Else
45  dblTempsFormation = 0
45  End If
 
460 If Not IsNull(rstProjSoum.Fields("TempsGestionConc")) Then
4  If IsNumeric(rstProjSoum.Fields("TempsGestionConc")) Then
4  dblTempsGestion = CDbl(rstProjSoum.Fields("TempsGestionConc"))
4  Else
4  dblTempsGestion = 0
4  End If
4  Else
...
46  dblTotalTemps = dblTempsDessin + _
 dblTempsCoupe + _
 dblTempsMachinage + _
 dblTempsSoudure + _
 dblTempsAssemblage + _
...
46  DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsRHConc").Caption = dblTotalTemps
470 Else
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsDessinConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsCoupeConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsMachinageConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsSoudureConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsAssemblageConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsPeintureConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTestConc").Caption = "---"
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsInstallationConc").Caption = "---"
...
47  Call CalculerTempsReelsImpression(rstProjSoum.Fields("IDProjet"))

 'Autres frais
47  If Not IsNull(rstProjSoum.Fields("NbrePersonne")) Then
47  DR_SoumissionMec.Sections("Section5").Controls("lblNbrePersonne").Caption = rstProjSoum.Fields("NbrePersonne")
479Else
47  DR_SoumissionMec.Sections("Section5").Controls("lblNbrePersonne").Caption = "0"
480End If

480 DR_SoumissionMec.Sections("Section5").Controls("lblTempsHebergement").Caption = rstProjSoum.Fields("TempsHebergement")
4  DR_SoumissionMec.Sections("Section5").Controls("lblTauxHebergement1").Caption = rstProjSoum.Fields("TauxHebergement1")
4  DR_SoumissionMec.Sections("Section5").Controls("lblTauxHebergement2").Caption = rstProjSoum.Fields("TauxHebergement2")
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsRepas").Caption = rstProjSoum.Fields("TempsRepas")
4  DR_SoumissionMec.Sections("Section5").Controls("lblTauxRepas").Caption = rstProjSoum.Fields("TauxRepas")
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsTransport").Caption = rstProjSoum.Fields("TempsTransport")
4  DR_SoumissionMec.Sections("Section5").Controls("lblTauxTransport").Caption = rstProjSoum.Fields("TauxTransport")
4  DR_SoumissionMec.Sections("Section5").Controls("lblTempsUniteMobile").Caption = rstProjSoum.Fields("TempsUniteMobile")
4  DR_SoumissionMec.Sections("Section5").Controls("lblTauxUniteMobile").Caption = rstProjSoum.Fields("TauxUniteMobile")
4  DR_SoumissionMec.Sections("Section5").Controls("lblPrixEmballage").Caption = rstProjSoum.Fields("PrixEmballage")
4  DR_SoumissionMec.Sections("Section5").Controls("lblPrixManuel").Caption = rstProjSoum.Fields("Total_Manuel")

486DR_SoumissionMec.Sections("Section5").Controls("lblTotalTempsAR").Caption = Conversion(sTotalTemps, MODE_ARGENT)
4   DR_SoumissionMec.Sections("Section5").Controls("lblTotalPieceAR").Caption = Conversion(sTotalPiece, MODE_ARGENT)
487DR_SoumissionMec.Sections("Section5").Controls("lblProfit").Caption = Conversion(rstProjSoum.Fields("profit") * 100, MODE_POURCENT)
4   DR_SoumissionMec.Sections("Section5").Controls("lblTotalProfit").Caption = Conversion(sProfit, MODE_ARGENT)
488DR_SoumissionMec.Sections("Section5").Controls("lblImprevue").Caption = Conversion(rstProjSoum.Fields("imprevue"), MODE_POURCENT)
48  DR_SoumissionMec.Sections("Section5").Controls("lblImprevueAR").Caption = Conversion(sImprevue, MODE_ARGENT)
489DR_SoumissionMec.Sections("Section5").Controls("lblCommission").Caption = Conversion(rstProjSoum.Fields("commission"), MODE_POURCENT)
48  DR_SoumissionMec.Sections("Section5").Controls("lblCommissionAR").Caption = Conversion(sCommission, MODE_ARGENT)

490 If Not IsNull(rstProjSoum.Fields("PrixRéception")) Then
49DR_SoumissionMec.Sections("Section5").Controls("lblPrixReception").Caption = Conversion(rstProjSoum.Fields("PrixRéception"), MODE_ARGENT)
4  Else
4  DR_SoumissionMec.Sections("Section5").Controls("lblPrixReception").Caption = Conversion(0, MODE_ARGENT)
4  End If

4  DR_SoumissionMec.Sections("Section5").Controls("lblAutre").Caption = Conversion(sAutre, MODE_ARGENT)

4  DR_SoumissionMec.Sections("Section5").Controls("lblGrandTotalAR").Caption = Conversion(sPrixTotal, MODE_ARGENT)
 ...
 'Affiche le rapport soumission
4  DR_SoumissionMec.Orientation = rptOrientLandscape
 
4  Call DR_SoumissionMec.Show(vbModal)
 
4  Call rstImpProjSoum.Close
4  Set rstImpProjSoum = Nothing

4  Set rstTemp = Nothing
...
4 wOups "frmProjSoumMec", "ImprimerProjSoum", Err, Err.number, Err.Description
End Sub
...
Do While Not rstPiece.EOF
 ...
 rstImpListePiece("NoLigne") = iCompteurPiece
1  rstImpListePiece("IDSoumission") = sNoSoumission
 
 If Not IsNull(rstTemp.Fields(sChampsSection)) Then
 rstImpListePiece.Fields("NomSection") = rstTemp.Fields(sChampsSection)
 Else
...
4  DR_Liste_piece.Sections("section3").Controls("lbldate").Caption = ConvertDate(Date)
 ...
 'affiche l'entête
4  DR_Liste_piece.Sections("section4").Controls("lblsoumission").Caption = rstProjSoum.Fields("IDSoumission")
 
4  DR_Liste_piece.Sections("section4").Controls("lblprojet").Caption = rstProjSoum.Fields("IDProjet")
...
50 Call rstTemp.Open("SELECT NomContact FROM GrbContact WHERE IDContact = " & rstProjSoum.Fields("IDContact"), g_connData, adOpenDynamic, adLockOptimistic)
...
Oups:
 ...
 wOups "frmProjSoumMec", "ImprimerListePiecesFacturation", Err, Err.number, Err.Description
End Sub
...
2  iNbrePersonne = Int(m_sNbrePersonne)
...
dblUniteMobile = CDbl(m_sTempsUniteMobile) * CDbl(m_sTauxUniteMobile)
 ...
 'Correction d'un bug de Type Incompatible
If IsNumeric(m_sPrixEmballage) Then
 dblPrixEmballage = CDbl(m_sPrixEmballage)
Else
 dblPrixEmballage = 0
End If
...
If IsNumeric(txtPrixManuel.Text) Then
dblTotalManuel = CDbl(txtPrixManuel.Text)
Else
dblTotalManuel = 0
End If
 
3  dblTotalImprevue = (dblPrixPieces + dblProfit) * CDbl(m_sImprevue)
 
dblPrixTotal = dblPrixPieces + dblProfit + dblTotalTemps + dblTotalImprevue + dblTotalManuel + dblTotalResteTemps
 
 'Le calcul de la commission est sur les manuels (Nbre de page * prix par pages * nbre de copies) + (prix des pièces * pourcentage d'imprévus) + total des temps
3  dblCommission = dblPrixTotal * CDbl(m_sCommission)
 
 'Le prix total est le calcul des manuels (Nbre de page * prix par pages * nbre de copies) + (prix des pièces * pourcentage d'imprévus) + total des temps + total de la commission
 dblGrandTotal = dblPrixTotal + dblCommission
 
 'Format monétaires avec 2 chiffres après la virgule
40 sTotalPiece = Conversion(CStr(Round(dblPrixPieces, 2)), MODE_ARGENT)
sTotalTemps = Conversion(CStr(Round(dblTotalTemps, 2)), MODE_ARGENT)
4 sPrixTotal = Conversion(CStr(Round(dblGrandTotal, 2)), MODE_ARGENT)
4 sImprevue = Conversion(CStr(Round(dblTotalImprevue, 2)), MODE_ARGENT)
4 sCommission = Conversion(CStr(Round(dblCommission, 2)), MODE_ARGENT)
4 sProfit = Conversion(CStr(Round(dblProfit, 2)), MODE_ARGENT)
4 sAutre = Conversion(CStr(Round(dblTotalResteTemps, 2)), MODE_ARGENT)

4 Exit Sub

Oups:

4 wOups "frmProjSoumMec", "CalculerPrix", Err, Err.number, Err.Description
End Sub
...
Private Sub CalculerPrixReception()
 ...
 'On ajoute le montant
  ...
  Else
  dblPrixReception = Round(dblPrixReception + 0, 2)
  End If
  Else
 'Si c'est un retour
...
wOups "frmProjSoumMec", "CalculerPrixReception", Err, Err.number, Err.Description
End Sub
...
1 Call rstProjet.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & Left$(txtNoProjSoum.Text, Len(txtNoProjSoum.Text) - 2) & sExtra & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
itmAnnulation.SubItems(I_COL_SOUM_TOTAL) = "-" & itmAvant.SubItems(I_COL_SOUM_TOTAL)
 ...
 'Pour le profit, c'est le prix total - (prix net * quantité)
itmAnnulation.SubItems(I_COL_SOUM_PROFIT) = "-" & itmAvant.SubItems(I_COL_SOUM_PROFIT)
...
2  itmAnnulation.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_VERT_FORET
itmAnnulation.ListSubItems(I_COL_SOUM_DESCR).ForeColor = COLOR_VERT_FORET
2  itmAnnulation.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = COLOR_VERT_FORET
itmAnnulation.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor = COLOR_VERT_FORET
2  itmAnnulation.ListSubItems(I_COL_SOUM_MANUFACT).ForeColor = COLOR_VERT_FORET
itmAnnulation.ListSubItems(I_COL_SOUM_PRIX_LIST).ForeColor = COLOR_VERT_FORET
30 itmAnnulation.ListSubItems(I_COL_SOUM_PRIX_NET).ForeColor = COLOR_VERT_FORET
...
itmAnnulation.ListSubItems(I_COL_SOUM_DESCR).Bold = True
itmAnnulation.ListSubItems(I_COL_SOUM_DISTRIB).Bold = True
itmAnnulation.ListSubItems(I_COL_SOUM_ESCOMPTE).Bold = True
itmAnnulation.ListSubItems(I_COL_SOUM_MANUFACT).Bold = True
itmAnnulation.ListSubItems(I_COL_SOUM_PRIX_LIST).Bold = True
itmAnnulation.ListSubItems(I_COL_SOUM_PRIX_NET).Bold = True
itmAnnulation.ListSubItems(I_COL_SOUM_PROFIT).Bold = True
itmAnnulation.ListSubItems(I_COL_SOUM_TOTAL).Bold = True

3  itmAvant.ListSubItems(I_COL_SOUM_PIECE).ForeColor = COLOR_VERT_FORET
itmAvant.ListSubItems(I_COL_SOUM_DESCR).ForeColor = COLOR_VERT_FORET
3  itmAvant.ListSubItems(I_COL_SOUM_DISTRIB).ForeColor = COLOR_VERT_FORET
itmAvant.ListSubItems(I_COL_SOUM_ESCOMPTE).ForeColor = COLOR_VERT_FORET
3  itmAvant.ListSubItems(I_COL_SOUM_MANUFACT).ForeColor = COLOR_VERT_FORET
itmAvant.ListSubItems(I_COL_SOUM_PRIX_LIST).ForeColor = COLOR_VERT_FORET
3  itmAvant.ListSubItems(I_COL_SOUM_PRIX_NET).ForeColor = COLOR_VERT_FORET
 itmAvant.ListSubItems(I_COL_SOUM_PROFIT).ForeColor = COLOR_VERT_FORET
40 itmAvant.ListSubItems(I_COL_SOUM_TOTAL).ForeColor = COLOR_VERT_FORET
...
4 itmAvant.ListSubItems(I_COL_SOUM_ESCOMPTE).Bold = True
4 itmAvant.ListSubItems(I_COL_SOUM_MANUFACT).Bold = True
4  itmAvant.ListSubItems(I_COL_SOUM_PRIX_LIST).Bold = True
4  itmAvant.ListSubItems(I_COL_SOUM_PRIX_NET).Bold = True
4  itmAvant.ListSubItems(I_COL_SOUM_PROFIT).Bold = True
4  itmAvant.ListSubItems(I_COL_SOUM_TOTAL).Bold = True

4  If itmAvant.SubItems(I_COL_SOUM_DATE_COMMANDE) <> "" Then
4  itmAvant.ListSubItems(I_COL_SOUM_DATE_COMMANDE).Bold = True
4  End If

4  itmAvant.ListSubItems(I_COL_SOUM_DATE_REQUISE).Bold = True

50 itmAvant.ListSubItems(I_COL_SOUM_NOM_COMMANDE).Bold = True
50 itmAvant.ListSubItems(I_COL_SOUM_NOM_COMMANDE).Bold = True
...
Oups:
 ...
 wOups "frmProjSoumMec", "AnnulerCommande", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "AjouterSuppressionCollection", Err, Err.number, Err.Description
End Sub
...
Private Sub EnregistrerSuppression()
 ...
 Call rstEmploye.Close
  ...
  If Not m_collNoItemSupp Is Nothing Then
...
rstBavard.Fields("Date") = m_collDateSupp(iCompteur)
 rstBavard.Fields("Heure") = m_collHeureSupp(iCompteur)
...
wOups "frmProjSoumMec", "EnregistrerSuppression", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "RemplirListViewSuppression", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "lvwBavard_LostFocus", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "cmdForfait_Click", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "cmdEffacerForfait_Click", Err, Err.number, Err.Description
End Sub
...
1 If lvwSoumission.ListItems(iCompteur).Selected = True Then
 ...
 m_arr_tyCopie(iIndex).sProfit = itmCopier.SubItems(I_COL_SOUM_PROFIT)
...
wOups "frmProjSoumMec", "CopierPiece", Err, Err.number, Err.Description
End Sub
...
wOups "frmProjSoumMec", "CollerPiece", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "Deselect", Err, Err.number, Err.Description
End Sub
...
Oups:
  ...
  wOups "frmProjSoumMec", "txtPrixSpecial_Change", Err, Err.number, Err.Description
End Sub
...
Oups:
 ...
 wOups "frmProjSoumMec", "txtPrixSpecial_LostFocus", Err, Err.number, Err.Description
End Sub
...
Private Function ValiderFormatMecanique(ByVal sNoProjSoum As String) As Boolean
 ...
 If UCase(Left$(sNoProjSoum, 1)) = "M" Then
 ValiderFormatMecanique = True
 Else
 Call MsgBox("Un numéro mécanique doit absolument commencé par 'M' !", vbOKOnly, "Erreur")

 ValiderFormatMecanique = False
 End If
...
Oups:
 ...
 wOups "FrmProjSoumMec", "ValiderFormatMecanique", Err, Err.number, Err.Description
End Function
...
Oups:
 ...
 wOups "FrmProjSoumMec", "ValiderFormatSoumission", Err, Err.number, Err.Description
End Function
...
Private Function ValiderFormatJobSansSoum(ByVal sNoProjet As String) As Boolean
 ...
 Else
 Call MsgBox("Un projet créé sans soumission ne doit pas être '" & Left$(sNoProjet, 3) & "' !", vbOKOnly, "Erreur")
...
Oups:
 ...
 wOups "FrmProjSoumMec", "ValiderFormatJobSansSoum", Err, Err.number, Err.Description
End Function
...
Oups:
 ...
 wOups "FrmProjSoumMec", "ValiderFormatJobAvecSoum", Err, Err.number, Err.Description
End Function
...
Oups:
 ...
 wOups "FrmProjSoumMec", "ValiderFormatJobExtra", Err, Err.number, Err.Description
End Function
...
10 Call rstProjCumulatif.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & sNoCumulatif & "'", g_connData, adOpenDynamic, adLockOptimistic)
...
If rstProjCumulatif.EOF Then
 ...
 Call rstProj.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & Left$(txtNoProjSoum.Text, 6) & "-01'", g_connData, adOpenForwardOnly, adLockReadOnly)
 ...
 Call rstSoum.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & Left$(rstProj.Fields("IDSoumission"), 6) & "-99'", g_connData, adOpenForwardOnly, adLockReadOnly)
...
1  Call rstProj.Close
 ...
 Call rstProj.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & txtNoProjSoum.Text & "'", g_connData, adOpenForwardOnly, adLockReadOnly)

 rstProjCumulatif.Fields("IDClient") = rstProj.Fields("IDClient")
 rstProjCumulatif.Fields("IDContact") = rstProj.Fields("IDContact")

 rstProjCumulatif.Fields("TauxMachinage") = rstProj.Fields("TauxMachinage")
 rstProjCumulatif.Fields("TauxCoupe") = rstProj.Fields("TauxCoupe")
 rstProjCumulatif.Fields("TauxSoudure") = rstProj.Fields("TauxSoudure")
 rstProjCumulatif.Fields("TauxAssemblage") = rstProj.Fields("TauxAssemblage")
 rstProjCumulatif.Fields("TauxPeinture") = rstProj.Fields("TauxPeinture")
...
rstProjCumulatif.Fields("Description") = "Cumulatif de " & Left$(txtNoProjSoum.Text, 6)

 Set rstEmploye = New ADODB.Recordset

Call rstEmploye.Open("SELECT * FROM Grbemployés WHERE loginname = '" & g_sUserID & "'", g_connData, adOpenForwardOnly, adLockReadOnly)

3 rstProjCumulatif.Fields("creer") = ConvertDate(Date)
...
4 Call rstProj.Open("SELECT * FROM GrbProjetMec WHERE LEFT(IDProjet, 6) = '" & Left$(txtNoProjSoum.Text, 6) & "' AND RIGHT(IDProjet, 2) <> '99'", g_connData, adOpenForwardOnly, adLockReadOnly)

4 If rstProj.RecordCount = 1 Then
4 rstProjCumulatif.Fields("manuel") = rstProj.Fields("manuel")
...
4 If Not IsNull(rstProj.Fields("manuel")) Then
4  dblNbreManuel = dblNbreManuel + CDbl(rstProj.Fields("manuel"))
4  End If
...
4  If Not IsNull(rstProj.Fields("total_manuel")) Then
4  dblTotalManuel = dblTotalManuel + CDbl(rstProj.Fields("total_manuel"))
4  End If

50 If Not IsNull(rstProj.Fields("MontantForfait")) Then
 ...
 rstProjCumulatif.Fields("manuel") = dblNbreManuel
...
5  Call g_connData.Execute("DELETE * FROM GrbProjet_Pieces WHERE IDProjet = '" & sNoCumulatif & "' AND Provenance = '" & Right$(txtNoProjSoum.Text, 2) & "'")

5  Call rstPieces.Open("SELECT * FROM GrbProjet_Pieces WHERE IDProjet = '" & txtNoProjSoum.Text & "' AND Provenance Is Null OR Provenance = '' ORDER BY NuméroLigne", g_connData, adOpenForwardOnly, adLockReadOnly)
5  Else
60 Call rstPieces.Open("SELECT * FROM GrbProjet_Pieces WHERE LEFT(IDProjet, 6) = '" & Left$(txtNoProjSoum.Text, 6) & "' AND RIGHT(IDProjet, 2) <> '99' AND Provenance Is Null OR Provenance = '' ORDER BY CInt(OrdreSection), NuméroLigne", g_connData, adOpenForwardOnly, adLockReadOnly)
60 End If
...
6  rstPiecesCumulatif.Fields("Prix_total") = rstPieces.Fields("Prix_total")
6  rstPiecesCumulatif.Fields("Profit_Argent") = rstPieces.Fields("Profit_Argent")
6  rstPiecesCumulatif.Fields("SousSection") = rstPieces.Fields("SousSection")
6  rstPiecesCumulatif.Fields("OrdreSection") = rstPieces.Fields("OrdreSection")
6  rstPiecesCumulatif.Fields("NuméroLigne") = rstPieces.Fields("NuméroLigne")
70 rstPiecesCumulatif.Fields("PrixOrigine") = rstPieces.Fields("PrixOrigine")
  ...
  Call rstPiecesCumulatif.Close
  Call rstPieces.Close

  Set rstProj = Nothing
   Set rstPieces = Nothing
   Set rstProjCumulatif = Nothing
7  Set rstPiecesCumulatif = Nothing

7  Call CalculerTotalRecordset(sNoCumulatif)

7  If bCumulatifExiste = False Then
7  If cmbOuvertFerme.ListIndex = I_CMB_OUVERT Then
7  Call RemplirComboProjSoum(txtNoProjSoum.Text)
7  End If
80 End If
...
Set rstSoum = New ADODB.Recordset
Set rstPieces = New ADODB.Recordset
1  Set rstSoumCumulatif = New ADODB.Recordset
Set rstPiecesCumulatif = New ADODB.Recordset

 Call rstSoumCumulatif.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & sNoCumulatif & "'", g_connData, adOpenDynamic, adLockOptimistic)

If rstSoumCumulatif.EOF Then
 bCumulatifExiste = False

 Call rstSoumCumulatif.AddNew

 rstSoumCumulatif.Fields("IDSoumission") = sNoCumulatif

1  Call rstSoum.Open("SELECT * FROM GrbSoumissionMec WHERE IDSoumission = '" & txtNoProjSoum.Text & "'", g_connData, adOpenForwardOnly, adLockReadOnly)

 rstSoumCumulatif.Fields("IDClient") = rstSoum.Fields("IDClient")
 rstSoumCumulatif.Fields("IDContact") = rstSoum.Fields("IDContact")

 rstSoumCumulatif.Fields("TauxMachinage") = rstSoum.Fields("TauxMachinage")
 rstSoumCumulatif.Fields("TauxCoupe") = rstSoum.Fields("TauxCoupe")
 rstSoumCumulatif.Fields("TauxSoudure") = rstSoum.Fields("TauxSoudure")
 rstSoumCumulatif.Fields("TauxAssemblage") = rstSoum.Fields("TauxAssemblage")
 rstSoumCumulatif.Fields("TauxPeinture") = rstSoum.Fields("TauxPeinture")
...
rstSoumCumulatif.Fields("TauxTransport") = rstSoum.Fields("TauxTransport")
 rstSoumCumulatif.Fields("TauxUniteMobile") = rstSoum.Fields("TauxUniteMobile")
...
4 Call rstSoum.Open("SELECT * FROM GrbSoumissionMec WHERE LEFT(IDSoumission, 6) = '" & Left$(txtNoProjSoum.Text, 6) & "' AND RIGHT(IDSoumission, 2) <> '99'", g_connData, adOpenForwardOnly, adLockReadOnly)

4 If rstSoum.RecordCount = 1 Then
4 rstSoumCumulatif.Fields("manuel") = rstSoum.Fields("manuel")

4 rstSoumCumulatif.Fields("TempsMachinage") = rstSoum.Fields("TempsMachinage")
4 rstSoumCumulatif.Fields("TempsCoupe") = rstSoum.Fields("TempsCoupe")
4  rstSoumCumulatif.Fields("TempsSoudure") = rstSoum.Fields("TempsSoudure")
4  rstSoumCumulatif.Fields("TempsAssemblage") = rstSoum.Fields("TempsAssemblage")
4  rstSoumCumulatif.Fields("TempsPeinture") = rstSoum.Fields("TempsPeinture")
4  rstSoumCumulatif.Fields("TempsTest") = rstSoum.Fields("TempsTest")
4  rstSoumCumulatif.Fields("TempsDessin") = rstSoum.Fields("TempsDessin")
4  rstSoumCumulatif.Fields("TempsFormation") = rstSoum.Fields("TempsFormation")
4  rstSoumCumulatif.Fields("TempsInstallation") = rstSoum.Fields("TempsInstallation")
4  rstSoumCumulatif.Fields("TempsGestion") = rstSoum.Fields("TempsGestion")
50 rstSoumCumulatif.Fields("TempsShipping") = rstSoum.Fields("TempsShipping")
...
5 rstSoumCumulatif.Fields("NbrePersonne") = rstSoum.Fields("NbrePersonne")
 ...
 Else
5  Do While Not rstSoum.EOF
5  If Not IsNull(rstSoum.Fields("manuel")) Then
5  dblNbreManuel = dblNbreManuel + CDbl(rstSoum.Fields("manuel"))
5  End If

5  If Not IsNull(rstSoum.Fields("TempsMachinage")) Then
5  dblTempsMachinage = dblTempsMachinage + CDbl(rstSoum.Fields("TempsMachinage"))
5  End If

5  If Not IsNull(rstSoum.Fields("TempsCoupe")) Then
60 dblTempsCoupe = dblTempsCoupe + CDbl(rstSoum.Fields("TempsCoupe"))
  End If

  If Not IsNull(rstSoum.Fields("TempsSoudure")) Then
  dblTempsSoudure = dblTempsSoudure + CDbl(rstSoum.Fields("TempsSoudure"))
  End If

  If Not IsNull(rstSoum.Fields("TempsAssemblage")) Then
  dblTempsAssemblage = dblTempsAssemblage + CDbl(rstSoum.Fields("TempsAssemblage"))
  End If

  If Not IsNull(rstSoum.Fields("TempsPeinture")) Then
  dblTempsPeinture = dblTempsPeinture + CDbl(rstSoum.Fields("TempsPeinture"))
  End If

  If Not IsNull(rstSoum.Fields("TempsTest")) Then
6  dblTempsTest = dblTempsTest + CDbl(rstSoum.Fields("TempsTest"))
6  End If

6  If Not IsNull(rstSoum.Fields("TempsDessin")) Then
6  dblTempsDessin = dblTempsDessin + CDbl(rstSoum.Fields("TempsDessin"))
6  End If

6  If Not IsNull(rstSoum.Fields("TempsFormation")) Then
6  dblTempsFormation = dblTempsFormation + CDbl(rstSoum.Fields("TempsFormation"))
6  End If

70 If Not IsNull(rstSoum.Fields("TempsInstallation")) Then
...
7  If Not IsNull(rstSoum.Fields("TotalHebergement")) Then
7  dblTotalHebergement = dblTotalHebergement + CDbl(rstSoum.Fields("TotalHebergement"))
7  End If

7  If Not IsNull(rstSoum.Fields("TotalRepas")) Then
7  dblTotalRepas = dblTotalRepas + CDbl(rstSoum.Fields("TotalRepas"))
80 End If
  ...
  End If
   ...
   rstSoumCumulatif.Fields("manuel") = dblNbreManuel

   rstSoumCumulatif.Fields("TempsMachinage") = dblTempsMachinage
8  rstSoumCumulatif.Fields("TempsCoupe") = dblTempsCoupe
8  rstSoumCumulatif.Fields("TempsSoudure") = dblTempsSoudure
8  rstSoumCumulatif.Fields("TempsAssemblage") = dblTempsAssemblage
8  rstSoumCumulatif.Fields("TempsPeinture") = dblTempsPeinture
90 rstSoumCumulatif.Fields("TempsTest") = dblTempsTest
  ...
  rstSoumCumulatif.Fields("TempsGestion") = dblTempsGestion
  rstSoumCumulatif.Fields("TempsShipping") = dblTempsShipping

  rstSoumCumulatif.Fields("TempsTransport") = dblTempsTransport
  rstSoumCumulatif.Fields("TempsUniteMobile") = dblTempsUniteMobile

  rstSoumCumulatif.Fields("TotalHebergement") = dblTotalHebergement
 ...
 If bCumulatifExiste = True Then
9  Call g_connData.Execute("DELETE * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & sNoCumulatif & "' AND Provenance = '" & Right$(txtNoProjSoum.Text, 2) & "'")

 Call rstPieces.Open("SELECT * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & txtNoProjSoum.Text & "' ORDER BY NuméroLigne", g_connData, adOpenForwardOnly, adLockReadOnly)
100 Else
...
1 rstPiecesCumulatif.Fields("Qté") = rstPieces.Fields("Qté")
 rstPiecesCumulatif.Fields("Desc_FR") = rstPieces.Fields("Desc_FR")
1 rstPiecesCumulatif.Fields("Desc_EN") = rstPieces.Fields("Desc_EN")
10  rstPiecesCumulatif.Fields("Manufact") = rstPieces.Fields("Manufact")
10  rstPiecesCumulatif.Fields("Prix_list") = rstPieces.Fields("Prix_list")
10  rstPiecesCumulatif.Fields("Escompte") = rstPieces.Fields("Escompte")
10  rstPiecesCumulatif.Fields("Prix_net") = rstPieces.Fields("Prix_net")
10  rstPiecesCumulatif.Fields("IDFRS") = rstPieces.Fields("IDFRS")
10  rstPiecesCumulatif.Fields("Prix_total") = rstPieces.Fields("Prix_total")
10  rstPiecesCumulatif.Fields("Profit_Argent") = rstPieces.Fields("Profit_Argent")
10  rstPiecesCumulatif.Fields("SousSection") = rstPieces.Fields("SousSection")
110 rstPiecesCumulatif.Fields("OrdreSection") = rstPieces.Fields("OrdreSection")
11 rstPiecesCumulatif.Fields("NuméroLigne") = rstPieces.Fields("NuméroLigne")
...
1 Call rstPieces.MoveNext
11 Loop

11 Call rstPiecesCumulatif.Close
11  Call rstPieces.Close

11  Set rstSoum = Nothing
1 Set rstPieces = Nothing
11  Set rstSoumCumulatif = Nothing
1 Set rstPiecesCumulatif = Nothing

11  Call CalculerTotalRecordset(sNoCumulatif)

1 Exit Sub

Oups:

11  wOups "FrmProjSoumElec", "AjouterSoumissionAuCumulatif", Err, Err.number, Err.Description
End Sub
...
Private Sub RecreerProjetCumulatif()
 ...
 Dim dblForfait As Double
  ...
  Call rstProj.Open("SELECT * FROM GrbProjetMec WHERE LEFT(IDProjet, 6) = '" & Left$(txtNoProjSoum.Text, 6) & "' AND RIGHT(IDProjet, 2) <> '99'", g_connData, adOpenForwardOnly, adLockReadOnly)
...
1 Call g_connData.Execute("DELETE * FROM GrbProjSoum WHERE IDProjSoum = '" & sNoCumulatif & "'")
 ...
 'Efface le projet
 Call g_connData.Execute("DELETE * FROM GrbProjetMec WHERE IDProjet = '" & sNoCumulatif & "'")

 bSupprimer = True
Else
 Call rstProjCumulatif.Open("SELECT * FROM GrbProjetMec WHERE IDProjet = '" & sNoCumulatif & "'", g_connData, adOpenDynamic, adLockOptimistic)

 If rstProj.RecordCount = 1 Then
 rstProjCumulatif.Fields("manuel") = rstProj.Fields("manuel")
...
Else
 ...
 If Not IsNull(rstProj.Fields("manuel")) Then
 dblNbreManuel = dblNbreManuel + CDbl(rstProj.Fields("manuel"))
 End If
...
4  wOups "FrmProjSoumElec", "AjouterProjetAuCumulatif", Err, Err.number, Err.Description
End Sub
...
Private Sub RecreerSoumissionCumulatif()
 ...
 Dim dblTempsSoudure As Double
  ...
  Dim dblTempsGestion As Double
  Dim dblTempsShipping As Double
10 Dim dblTempsTransport As Double
Dim dblTempsUniteMobile As Double
Dim dblTotalHebergement As Double
Dim dblTotalRepas As Double
Dim dblPrixEmballage As Double
...
1  Set rstPiecesCumulatif = New ADODB.Recordset
 
rstSoum.CursorLocation = adUseClient
 
 Call rstSoum.Open("SELECT * FROM GrbSoumissionMec WHERE LEFT(IDSoumission, 6) = '" & Left$(txtNoProjSoum.Text, 6) & "' AND RIGHT(IDSoumission, 2) <> '99'", g_connData, adOpenForwardOnly, adLockReadOnly)

If rstSoum.EOF Then
 Call g_connData.Execute("DELETE * FROM GrbProjSoum WHERE IDProjSoum = '" & sNoCumulatif & "'")

 Call g_connData.Execute("DELETE * FROM GrbSoumission_Pieces WHERE IDSoumission = '" & sNoCumulatif & "' AND Type = 'E'")
 
 'Efface la soumission
 Call g_connData.Execute("DELETE * FROM GrbSoumissionMec WHERE IDSoumission = '" & sNoCumulatif & "'")
...
1  bSupprimer = True
 ...
 rstSoumCumulatif.Fields("manuel") = rstSoum.Fields("manuel")
 
 rstSoumCumulatif.Fields("TempsMachinage") = rstSoum.Fields("TempsMachinage")
 rstSoumCumulatif.Fields("TempsCoupe") = rstSoum.Fields("TempsCoupe")
 rstSoumCumulatif.Fields("TempsSoudure") = rstSoum.Fields("TempsSoudure")
 rstSoumCumulatif.Fields("TempsAssemblage") = rstSoum.Fields("TempsAssemblage")
 rstSoumCumulatif.Fields("TempsPeinture") = rstSoum.Fields("TempsPeinture")
...
rstSoumCumulatif.Fields("TotalRepas") = rstSoum.Fields("TotalRepas")
 ...
 If Not IsNull(rstSoum.Fields("manuel")) Then
 dblNbreManuel = dblNbreManuel + CDbl(rstSoum.Fields("manuel"))
 End If
 
 If Not IsNull(rstSoum.Fields("TempsMachinage")) Then
 dblTempsMachinage = dblTempsMachinage + CDbl(rstSoum.Fields("TempsMachinage"))
 End If
 
 If Not IsNull(rstSoum.Fields("TempsCoupe")) Then
 dblTempsCoupe = dblTempsCoupe + CDbl(rstSoum.Fields("TempsCoupe"))
 End If
...
4 If Not IsNull(rstSoum.Fields("TempsPeinture")) Then
4 dblTempsPeinture = dblTempsPeinture + CDbl(rstSoum.Fields("TempsPeinture"))
4 End If
 
4 If Not IsNull(rstSoum.Fields("TempsTest")) Then
4 dblTempsTest = dblTempsTest + CDbl(rstSoum.Fields("TempsTest"))
4 End If
 
4 If Not IsNull(rstSoum.Fields("TempsDessin")) Then
4 dblTempsDessin = dblTempsDessin + CDbl(rstSoum.Fields("TempsDessin"))
4 End If
 
4 If Not IsNull(rstSoum.Fields("TempsFormation")) Then
4  dblTempsFormation = dblTempsFormation + CDbl(rstSoum.Fields("TempsFormation"))
4  End If
 
4  If Not IsNull(rstSoum.Fields("TempsInstallation")) Then
4  dblTempsInstallation = dblTempsInstallation + CDbl(rstSoum.Fields("TempsInstallation"))
4  End If
 
4  If Not IsNull(rstSoum.Fields("TempsGestion")) Then
4  dblTempsGestion = dblTempsGestion + CDbl(rstSoum.Fields("TempsGestion"))
4  End If

50 If Not IsNull(rstSoum.Fields("TempsShipping")) Then
 dblTempsShipping = dblTempsShipping + CDbl(rstSoum.Fields("TempsShipping"))
 End If
...
5  If Not IsNull(rstSoum.Fields("TotalRepas")) Then
5  dblTotalRepas = dblTotalRepas + CDbl(rstSoum.Fields("TotalRepas"))
5  End If
 
5  If Not IsNull(rstSoum.Fields("PrixEmballage")) Then
5  dblPrixEmballage = dblPrixEmballage + CDbl(rstSoum.Fields("PrixEmballage"))
5  End If
 
5  If Not IsNull(rstSoum.Fields("total_manuel")) Then
5  dblTotalManuel = dblTotalManuel + CDbl(rstSoum.Fields("total_manuel"))
60 End If
  ...
  rstSoumCumulatif.Fields("TempsMachinage") = dblTempsMachinage
  rstSoumCumulatif.Fields("TempsCoupe") = dblTempsCoupe
  rstSoumCumulatif.Fields("TempsSoudure") = dblTempsSoudure
6  rstSoumCumulatif.Fields("TempsAssemblage") = dblTempsAssemblage
6  rstSoumCumulatif.Fields("TempsPeinture") = dblTempsPeinture
6  rstSoumCumulatif.Fields("TempsTest") = dblTempsTest
6  rstSoumCumulatif.Fields("TempsDessin") = dblTempsDessin
6  rstSoumCumulatif.Fields("TempsFormation") = dblTempsFormation
6  rstSoumCumulatif.Fields("TempsInstallation") = dblTempsInstallation
6  rstSoumCumulatif.Fields("TempsGestion") = dblTempsGestion
6  rstSoumCumulatif.Fields("TempsShipping") = dblTempsShipping
 
70 rstSoumCumulatif.Fields("TempsTransport") = dblTempsTransport
  rstSoumCumulatif.Fields("TempsUniteMobile") = dblTempsUniteMobile
...
7  Call rstPieces.Open("SELECT * FROM GrbSoumission_Pieces WHERE LEFT(IDSoumission, 6) = '" & Left$(txtNoProjSoum.Text, 6) & "' AND RIGHT(IDSoumission, 2) <> '99' ORDER BY CInt(OrdreSection), NuméroLigne", g_connData, adOpenForwardOnly, adLockReadOnly)

7  Do While Not rstPieces.EOF
7  Call rstPiecesCumulatif.AddNew

7  rstPiecesCumulatif.Fields("IDSoumission") = sNoCumulatif
7  rstPiecesCumulatif.Fields("IDSection") = rstPieces.Fields("IDSection")
7  rstPiecesCumulatif.Fields("NumItem") = rstPieces.Fields("NumItem")
80 rstPiecesCumulatif.Fields("Qté") = rstPieces.Fields("Qté")
  rstPiecesCumulatif.Fields("Desc_FR") = rstPieces.Fields("Desc_FR")
  rstPiecesCumulatif.Fields("Desc_EN") = rstPieces.Fields("Desc_EN")
  rstPiecesCumulatif.Fields("Manufact") = rstPieces.Fields("Manufact")
  rstPiecesCumulatif.Fields("Prix_list") = rstPieces.Fields("Prix_list")
  ...
  rstPiecesCumulatif.Fields("OrdreSection") = rstPieces.Fields("OrdreSection")
   ...
   rstPiecesCumulatif.Fields("Type") = rstPieces.Fields("Type")
   rstPiecesCumulatif.Fields("Visible") = rstPieces.Fields("Visible")
8  rstPiecesCumulatif.Fields("Commentaire") = rstPieces.Fields("Commentaire")
8  rstPiecesCumulatif.Fields("Devise") = rstPieces.Fields("Devise")
8  rstPiecesCumulatif.Fields("Provenance") = Right(rstPieces.Fields("IDSoumission"), 2)

8  Call rstPiecesCumulatif.Update

90 Call rstPieces.MoveNext
90 Loop
  ...
  Call CalculerTotalRecordset(sNoCumulatif)
  End If
...
Oups:
 ...
 wOups "FrmProjSoumElec", "RecreerSoumissionCumulatif", Err, Err.number, Err.Description
End Sub
